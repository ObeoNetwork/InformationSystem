...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.EcranSecondaireForm;
...
/**
 * Implementation of <strong>Ecran Secondaire Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class EcranSecondaireAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(EcranSecondaireAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_LABELS = "labels"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		EcranSecondaireForm ecranSecondaireForm = (EcranSecondaireForm)form;
