...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.RadioButtonsForm;
...
/**
 * Implementation of <strong>Radio Buttons Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class RadioButtonsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(RadioButtonsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_SLIDE_BARS = "slideBars"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RadioButtonsForm radioButtonsForm = (RadioButtonsForm)form;
