...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.ToggleButtonsForm;
...
/**
 * Implementation of <strong>Toggle Buttons Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class ToggleButtonsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ToggleButtonsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_SIMPLE_BUTTONS = "simpleButtons"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ToggleButtonsForm toggleButtonsForm = (ToggleButtonsForm)form;
