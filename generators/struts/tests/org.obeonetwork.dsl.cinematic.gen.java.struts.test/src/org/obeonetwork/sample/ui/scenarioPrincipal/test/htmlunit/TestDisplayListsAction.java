...
/**
 * HtmlUnit testing for <strong>Display Lists Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestDisplayListsAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestDisplayListsAction(String testName) {
		super(testName);
