...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.CircuitStartForm;
...
/**
 * Implementation of <strong>Circuit Start Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class CircuitStartAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(CircuitStartAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_CIRCUIT_RETURN = "circuitReturn"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CircuitStartForm circuitStartForm = (CircuitStartForm)form;
