...
/**
 * HtmlUnit testing for <strong>Circuit Start Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestCircuitStartAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestCircuitStartAction(String testName) {
		super(testName);
