...
/**
 * HtmlUnit testing for <strong>Radio Buttons Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestRadioButtonsAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestRadioButtonsAction(String testName) {
		super(testName);
