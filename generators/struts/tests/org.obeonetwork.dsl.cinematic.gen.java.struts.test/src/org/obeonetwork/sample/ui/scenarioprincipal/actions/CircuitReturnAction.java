...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.CircuitReturnForm;
...
/**
 * Implementation of <strong>Circuit Return Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class CircuitReturnAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(CircuitReturnAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CircuitReturnForm circuitReturnForm = (CircuitReturnForm)form;
