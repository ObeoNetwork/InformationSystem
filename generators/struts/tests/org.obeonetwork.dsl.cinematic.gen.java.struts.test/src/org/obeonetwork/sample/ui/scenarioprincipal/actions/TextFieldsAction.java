...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.TextFieldsForm;
...
/**
 * Implementation of <strong>TextFields Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class TextFieldsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(TextFieldsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_COMBO_BOXES = "comboBoxes"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		TextFieldsForm textFieldsForm = (TextFieldsForm)form;
