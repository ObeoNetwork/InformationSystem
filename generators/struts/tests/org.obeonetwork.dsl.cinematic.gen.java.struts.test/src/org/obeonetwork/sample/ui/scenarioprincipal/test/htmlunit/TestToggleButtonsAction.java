...
/**
 * HtmlUnit testing for <strong>Toggle Buttons Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestToggleButtonsAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestToggleButtonsAction(String testName) {
		super(testName);
