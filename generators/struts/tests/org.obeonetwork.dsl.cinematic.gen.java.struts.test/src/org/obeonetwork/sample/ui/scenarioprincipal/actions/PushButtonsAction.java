...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.PushButtonsForm;
...
/**
 * Implementation of <strong>Push Buttons Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class PushButtonsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(PushButtonsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_TOGGLE_BUTTONS = "toggleButtons"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		PushButtonsForm pushButtonsForm = (PushButtonsForm)form;
