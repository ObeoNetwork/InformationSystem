...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.ProgressBarsForm;
...
/**
 * Implementation of <strong>Progress Bars Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class ProgressBarsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ProgressBarsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_TEXT_AREAS = "textAreas"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ProgressBarsForm progressBarsForm = (ProgressBarsForm)form;
