...
/**
 * HtmlUnit testing for <strong>Simple Buttons Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestSimpleButtonsAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestSimpleButtonsAction(String testName) {
		super(testName);
