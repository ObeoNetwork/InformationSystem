...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.Many2Form;
...
/**
 * Implementation of <strong>Many 2 Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class Many2Action extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(Many2Action.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Many2Form many2Form = (Many2Form)form;
