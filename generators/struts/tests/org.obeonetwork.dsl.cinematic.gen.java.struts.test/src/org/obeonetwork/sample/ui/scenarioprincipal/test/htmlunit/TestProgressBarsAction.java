...
/**
 * HtmlUnit testing for <strong>Progress Bars Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestProgressBarsAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestProgressBarsAction(String testName) {
		super(testName);
