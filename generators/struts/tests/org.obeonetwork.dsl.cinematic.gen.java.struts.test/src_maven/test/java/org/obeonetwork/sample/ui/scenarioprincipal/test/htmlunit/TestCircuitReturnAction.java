...
/**
 * HtmlUnit testing for <strong>Circuit Return Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestCircuitReturnAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestCircuitReturnAction(String testName) {
		super(testName);
