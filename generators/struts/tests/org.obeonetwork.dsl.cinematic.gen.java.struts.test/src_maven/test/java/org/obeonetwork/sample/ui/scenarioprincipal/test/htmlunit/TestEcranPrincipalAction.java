...
/**
 * HtmlUnit testing for <strong>Ecran Principal Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestEcranPrincipalAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestEcranPrincipalAction(String testName) {
		super(testName);
