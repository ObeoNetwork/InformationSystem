...
/**
 * HtmlUnit testing for <strong>Ecran Secondaire Form</strong>
 * Scenario : Scenario Principal
 *
 */
public class TestEcranSecondaireAction extends TestCase {
	 ...
	 * Constructor
	 */
	public TestEcranSecondaireAction(String testName) {
		super(testName);
