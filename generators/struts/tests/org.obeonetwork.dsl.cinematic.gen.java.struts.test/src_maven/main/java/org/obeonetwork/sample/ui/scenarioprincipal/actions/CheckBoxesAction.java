...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.CheckBoxesForm;
...
/**
 * Implementation of <strong>Check Boxes Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class CheckBoxesAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(CheckBoxesAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_RADIO_BUTTONS = "radioButtons"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CheckBoxesForm checkBoxesForm = (CheckBoxesForm)form;
