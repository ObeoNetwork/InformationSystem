...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.ManyToOneForm;
...
/**
 * Implementation of <strong>Many To One Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class ManyToOneAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ManyToOneAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ManyToOneForm manyToOneForm = (ManyToOneForm)form;
