...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.SimpleButtonsForm;
...
/**
 * Implementation of <strong>Simple Buttons Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class SimpleButtonsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(SimpleButtonsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_DISPLAY_LISTS = "displayLists"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SimpleButtonsForm simpleButtonsForm = (SimpleButtonsForm)form;
