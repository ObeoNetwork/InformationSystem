...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.DisplayListsForm;
...
/**
 * Implementation of <strong>Display Lists Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class DisplayListsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(DisplayListsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_CANVAS = "canvas"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		DisplayListsForm displayListsForm = (DisplayListsForm)form;
