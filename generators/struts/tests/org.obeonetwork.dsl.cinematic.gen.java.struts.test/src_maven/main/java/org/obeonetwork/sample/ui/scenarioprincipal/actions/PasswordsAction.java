...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.PasswordsForm;
...
/**
 * Implementation of <strong>Passwords Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class PasswordsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(PasswordsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_CHECK_BOXES = "checkBoxes"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		PasswordsForm passwordsForm = (PasswordsForm)form;
