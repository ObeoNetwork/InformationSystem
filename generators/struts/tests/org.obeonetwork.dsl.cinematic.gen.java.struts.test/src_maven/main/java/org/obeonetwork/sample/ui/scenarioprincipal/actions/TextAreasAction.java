...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.TextAreasForm;
...
/**
 * Implementation of <strong>Text Areas Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class TextAreasAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(TextAreasAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_ACTIONS = "actions"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		TextAreasForm textAreasForm = (TextAreasForm)form;
