...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.LabelsForm;
...
/**
 * Implementation of <strong>Labels Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class LabelsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(LabelsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_TEXTFIELDS = "textFields"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		LabelsForm labelsForm = (LabelsForm)form;
