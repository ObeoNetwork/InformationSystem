...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.ComboBoxesForm;
...
/**
 * Implementation of <strong>Combo Boxes Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class ComboBoxesAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ComboBoxesAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_PASSWORDS = "passwords"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ComboBoxesForm comboBoxesForm = (ComboBoxesForm)form;
