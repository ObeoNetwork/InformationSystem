...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.CanvasForm;
...
/**
 * Implementation of <strong>Canvas Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class CanvasAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(CanvasAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_LINKS = "links"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CanvasForm canvasForm = (CanvasForm)form;
