...
import org.obeonetwork.sample.ui.scenarioprincipal.forms.SlideBarsForm;
...
/**
 * Implementation of <strong>Slide Bars Action</strong>
 * Scenario : Scenario Principal
 *
 */
public class SlideBarsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(SlideBarsAction.class);

    /**
     * Forward codes.
     */
	public final static String PAGE_SELF = "self"; //$NON-NLS-1$
	public final static String PAGE_PUSH_BUTTONS = "pushButtons"; //$NON-NLS-1$
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SlideBarsForm slideBarsForm = (SlideBarsForm)form;
