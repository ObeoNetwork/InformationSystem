...
<fieldset>
	...
	<table>
		...
		<tr>
			<td><label for="displayList1"><bean:message key="Ecran1.displayList1"/></label> :</td>
		...
		<tr>
			<td>
				<html:link action="/scenariodefaultname/ecran1?event=unspecified">
					<bean:message key="Ecran1.link1"/>
				</html:link>
			</td>
		</tr>
		<tr>
...
<fieldset>
	...
	<table>
		<tr>
			<td>
				<html:submit property="action1" onclick="bCancel=false;Ecran1Form.event.value = 'action1';">
				<bean:message key="Ecran1.action1"/>
				</html:submit>
			</td>
		</tr>
	</table>
