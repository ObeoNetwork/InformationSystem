...
import org.obeonetwork.dsl.cinematic.gen.java.struts.architecture.tests.ui.scenariodefaultname.forms.Ecran3Form;
...
/**
 * Implementation of <strong>Ecran3 Action</strong>
 * Scenario : ScenarioDefaultName
 *
 */
public class Ecran3Action extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(Ecran3Action.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Ecran3Form ecran3Form = (Ecran3Form)form;
