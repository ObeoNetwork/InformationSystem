...
import org.obeonetwork.dsl.soa.gen.java.spring.main.ServiceMain;


public class SpringLauncher extends NetworkGenerationLauncher {

	private AbstractAcceleoGenerator launcher;
	
	@Override
	protected String getLaunchID() {
		return AcceleoLaunchingUtil.computeLaunchConfigID("org.obeonetwork.dsl.soa.gen.java.spring", 
				"org.obeonetwork.dsl.soa.gen.java.spring.main.ServiceMain", 
	...
	public AbstractAcceleoGenerator instanciateLauncher(URI modelURI,
		...
		launcher = new ServiceMain(modelURI, folder, new ArrayList<String>());
		return launcher;
	}
