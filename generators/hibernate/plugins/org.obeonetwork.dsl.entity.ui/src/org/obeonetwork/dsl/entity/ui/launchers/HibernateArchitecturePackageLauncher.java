...
import org.obeonetwork.dsl.entity.gen.java.hibernate.main.HibernateArchitecturePackage;

import org.eclipse.acceleo.engine.utils.AcceleoLaunchingUtil;

public class HibernateArchitecturePackageLauncher extends NetworkGenerationLauncher {
	...
	protected String getLaunchID() {
		return AcceleoLaunchingUtil.computeLaunchConfigID("org.obeonetwork.dsl.entity.gen.java.hibernate", 
				"org.obeonetwork.dsl.entity.gen.java.hibernate.main.HibernateArchitecturePackage", 
	...
	public AbstractAcceleoGenerator instanciateLauncher(URI modelURI,
		...
		launcher = new HibernateArchitecturePackage(modelURI, folder, new ArrayList<String>());
		return launcher;
	}
