...
import org.obeonetwork.dsl.entity.gen.java.hibernate.main.HibernateArchitectureEntity;

import org.eclipse.acceleo.engine.utils.AcceleoLaunchingUtil;

public class HibernateArchitectureEntityLauncher extends NetworkGenerationLauncher {
	...
	protected String getLaunchID() {
		return AcceleoLaunchingUtil.computeLaunchConfigID("org.obeonetwork.dsl.entity.gen.java.hibernate", 
				"org.obeonetwork.dsl.entity.gen.java.hibernate.main.HibernateArchitectureEntity", 
	...
	public AbstractAcceleoGenerator instanciateLauncher(URI modelURI,
		...
		launcher = new HibernateArchitectureEntity(modelURI, folder, new ArrayList<String>());
		return launcher;
	}
