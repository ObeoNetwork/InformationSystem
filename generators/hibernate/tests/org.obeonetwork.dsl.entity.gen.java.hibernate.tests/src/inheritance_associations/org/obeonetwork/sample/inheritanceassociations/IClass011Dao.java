...
/**
 * This class provides the data access layer to the Class_01_1 entity class.<br/>
 * This is the interface which represent the contrat of the DAO access.
 */
public interface IClass011Dao {
	 ...
	 * @param class011 Element to update. 
	 ...
	 * @param class011 Element which will be delete. 
	 * @throws DaoException If a Dao problem occurs.
	 */
