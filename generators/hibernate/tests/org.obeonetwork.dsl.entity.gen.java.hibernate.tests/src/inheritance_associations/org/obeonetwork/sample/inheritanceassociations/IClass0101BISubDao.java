...
/**
 * This class provides the data access layer to the Class_01_01_BI_Sub entity class.<br/>
 * This is the interface which represent the contrat of the DAO access.
 */
public interface IClass0101BISubDao {
	 ...
	 * @param class0101BISub Element to update. 
	 ...
	 * @param class0101BISub Element which will be delete. 
	 	 * @throws DaoException If a Dao problem occurs.
	 */
