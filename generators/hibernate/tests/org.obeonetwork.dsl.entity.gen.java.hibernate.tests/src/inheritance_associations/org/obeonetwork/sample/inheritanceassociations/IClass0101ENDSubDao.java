...
/**
 * This class provides the data access layer to the Class_01_01_END_Sub entity class.<br/>
 * This is the interface which represent the contrat of the DAO access.
 */
public interface IClass0101ENDSubDao {
	 ...
	 * @param class0101ENDSub Element to update. 
	 ...
	 * @param class0101ENDSub Element which will be delete. 
	 * @throws DaoException If a Dao problem occurs.
	 */
