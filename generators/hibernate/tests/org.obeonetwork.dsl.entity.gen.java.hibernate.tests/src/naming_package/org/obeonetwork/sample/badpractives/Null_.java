...
/**
 *  */
public class Null_ implements Serializable {
     ...
     * null_ and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Null_)) {
			return false;
		}
		
		final Null_ castedOther = (Null_) other;
