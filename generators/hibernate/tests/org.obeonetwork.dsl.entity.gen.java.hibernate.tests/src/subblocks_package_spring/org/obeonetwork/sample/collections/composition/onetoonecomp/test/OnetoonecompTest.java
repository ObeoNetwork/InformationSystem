 ...
 */
public class OnetoonecompTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IOnetoonecompDao onetoonecompDao = (IOnetoonecompDao)getApplicationContext().getBean("OnetoonecompDAO");
