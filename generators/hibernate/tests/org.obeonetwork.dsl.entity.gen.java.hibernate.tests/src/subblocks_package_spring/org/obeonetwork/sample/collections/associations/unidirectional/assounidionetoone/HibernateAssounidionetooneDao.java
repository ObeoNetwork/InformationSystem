...
/**
 * Implementation of DAO interface IAssounidionetooneDao based on the hibernate
 * persistence framework.
 * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IAssounidionetooneDao
 */
public class HibernateAssounidionetooneDao extends HibernateDaoSupport implements IAssounidionetooneDao {

	/**
     * The logger of this class.
     */
	private final static Log LOG = LogFactory.getLog(HibernateAssounidionetooneDao.class);

	/**
	 * Create a new element
	 * @param a Element to create.
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IADao.createA
     */
	 ...
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IADao.updateA
     */
	 ...
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IADao.deleteA
   	 */
	 ...
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IADao.findAllAs
     */
	 ...
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IADao.findAById
     */
	 ...
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IBDao.createB
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IBDao.updateB
     */
	 ...
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IBDao.deleteB
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IBDao.findAllBs
     */
	 ...
	 * @return The entity found. 
	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.collections.associations.unidirectional.assounidionetoone.IBDao.findBById
     */
