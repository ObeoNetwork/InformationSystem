 ...
 */
public class TablepersubclassTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private ITablepersubclassDao tablepersubclassDao = (ITablepersubclassDao)getApplicationContext().getBean("TablepersubclassDAO");
