 ...
 */
public class AssobidimanytooneTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}
	
	private IAssobidimanytooneDao assobidimanytooneDao = (IAssobidimanytooneDao)getApplicationContext().getBean("AssobidimanytooneDAO");
