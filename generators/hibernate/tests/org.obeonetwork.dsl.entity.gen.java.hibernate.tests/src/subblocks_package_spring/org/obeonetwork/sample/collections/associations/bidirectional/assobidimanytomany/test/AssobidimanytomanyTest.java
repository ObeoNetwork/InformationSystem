 ...
 */
public class AssobidimanytomanyTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IAssobidimanytomanyDao assobidimanytomanyDao = (IAssobidimanytomanyDao)getApplicationContext().getBean("AssobidimanytomanyDAO");
