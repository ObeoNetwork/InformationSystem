 ...
 */
public class AssounidimanytomanyTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IAssounidimanytomanyDao assounidimanytomanyDao = (IAssounidimanytomanyDao)getApplicationContext().getBean("AssounidimanytomanyDAO");
