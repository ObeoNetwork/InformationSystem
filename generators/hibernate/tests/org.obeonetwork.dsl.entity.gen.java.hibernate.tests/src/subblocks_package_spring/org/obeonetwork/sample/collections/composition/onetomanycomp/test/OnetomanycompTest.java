 ...
 */
public class OnetomanycompTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IOnetomanycompDao onetomanycompDao = (IOnetomanycompDao)getApplicationContext().getBean("OnetomanycompDAO");
