 ...
 */
public class AssobidionetooneTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IAssobidionetooneDao assobidionetooneDao = (IAssobidionetooneDao)getApplicationContext().getBean("AssobidionetooneDAO");
