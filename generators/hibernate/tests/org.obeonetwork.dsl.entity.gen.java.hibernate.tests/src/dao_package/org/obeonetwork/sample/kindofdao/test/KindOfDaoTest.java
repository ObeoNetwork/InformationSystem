 ...
 */
public class KindOfDaoTest extends TestCase {

	/**
	 * The DAO for class kind of dao.
	 */
	private IKindOfDaoDao kindOfDaoDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		kindOfDaoDao = SampleDaoFactory.getKindOfDaoDao();
