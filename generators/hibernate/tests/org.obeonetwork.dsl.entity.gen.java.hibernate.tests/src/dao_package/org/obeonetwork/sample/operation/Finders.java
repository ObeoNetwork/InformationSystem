 ...
 * 
 */
public class Finders implements Serializable {
     ...
     * Finders and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Finders)) {
			return false;
		}
		
		final Finders castedOther = (Finders) other;
