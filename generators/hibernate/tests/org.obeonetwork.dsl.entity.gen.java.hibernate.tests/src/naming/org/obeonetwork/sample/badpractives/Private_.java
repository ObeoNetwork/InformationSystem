...
/**
 *  */
public class Private_ implements Serializable {
     ...
     * private_ and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Private_)) {
			return false;
		}
		
		final Private_ castedOther = (Private_) other;
