...
public class ClassManyManyBI implements Serializable {
	 ...
	 * @param target2. 
	 */
	public ClassManyManyBI(Boolean fakeAttr, Collection<ClassManyManyBIEND> target2) {
		this();
	 ...
	 * @param fakeAttr
	 */
	public void setFakeAttr(final Boolean fakeAttr) {
		this.fakeAttr = fakeAttr;
	}
