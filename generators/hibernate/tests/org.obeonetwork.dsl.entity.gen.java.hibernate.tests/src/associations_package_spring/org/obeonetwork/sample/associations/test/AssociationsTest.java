 ...
 */
public class AssociationsTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IAssociationsDao associationsDao = (IAssociationsDao)getApplicationContext().getBean("AssociationsDAO");
