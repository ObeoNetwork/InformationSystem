...
public class ClassManyManyBIEND implements Serializable {
	 ...
	 * @param source2. 
	 */
	public ClassManyManyBIEND(Double fakeAttr, Collection<ClassManyManyBI> source2) {
		this();
	 ...
	 * @param fakeAttr
	 */
	public void setFakeAttr(final Double fakeAttr) {
		this.fakeAttr = fakeAttr;
	}
