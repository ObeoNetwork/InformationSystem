 ...
 * 
 */
public class BadName implements Serializable {
     ...
     * BadName and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof BadName)) {
			return false;
		}
		
		final BadName castedOther = (BadName) other;
