 ...
 */
public class Package_Test extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}

	private IPackage_Dao package_Dao = (IPackage_Dao)getApplicationContext().getBean("PackageDAO");
