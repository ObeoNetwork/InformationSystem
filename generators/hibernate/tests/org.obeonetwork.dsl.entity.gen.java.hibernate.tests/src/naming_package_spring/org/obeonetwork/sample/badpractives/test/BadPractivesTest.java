 ...
 */
public class BadPractivesTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}
	
	private IBadPractivesDao badPractivesDao = (IBadPractivesDao)getApplicationContext().getBean("BadPractivesDAO");
