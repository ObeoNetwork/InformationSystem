...
/**
 *  */
public class Interface_ implements Serializable {
     ...
     * Interface_ and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Interface_)) {
			return false;
		}
		
		final Interface_ castedOther = (Interface_) other;
