 ...
 * 
 */
public class Class101 implements Serializable {
	 ...
	 * @param target. 
	 */
	public Class101(String fakeAttr, Class101END target) {
	 ...
	 * @param target
	 */
	public void setTarget(final Class101END target) {
		this.target = target;
	}
     ...
     * Class101 and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class101)) {
			return false;
		}
		
		final Class101 castedOther = (Class101) other;
