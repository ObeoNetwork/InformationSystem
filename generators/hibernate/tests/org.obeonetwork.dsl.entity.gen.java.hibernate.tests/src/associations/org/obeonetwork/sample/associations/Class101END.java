...
/**
 *  */
public class Class101END implements Serializable {
	 ...
	 * @param fakeAttr. 
	 */
	public Class101END(Integer fakeAttr) {
     ...
     * Class101END and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class101END)) {
			return false;
		}
		
		final Class101END castedOther = (Class101END) other;
