 ...
 * 
 */
public class Class011END implements Serializable {
	 ...
	 * @param fakeAttr. 
	 */
	public Class011END(Integer fakeAttr) {
     ...
     * Class011END and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class011END)) {
			return false;
		}
		
		final Class011END castedOther = (Class011END) other;
