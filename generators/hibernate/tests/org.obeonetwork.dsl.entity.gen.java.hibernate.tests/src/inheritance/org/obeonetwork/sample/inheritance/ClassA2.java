 ...
 * 
 */
public class ClassA2 extends ClassA1 implements Serializable {
     ...
     * ClassA2 and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof ClassA2)) {
			return false;
		}
		
		final ClassA2 castedOther = (ClassA2) other;
