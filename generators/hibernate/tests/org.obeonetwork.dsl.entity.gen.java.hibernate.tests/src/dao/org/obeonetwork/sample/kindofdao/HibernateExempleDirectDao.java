...
/**
 * Implementation of DAO interface IExempleDirectDao based on the hibernate
 * persistence framework.
 * @see org.obeonetwork.sample.kindofdao.IExempleDirectDao
 */
public class HibernateExempleDirectDao implements IExempleDirectDao {

	/**
     * The logger of this class.
     */
	private final static Log LOG = LogFactory.getLog(HibernateExempleDirectDao.class);
     ...
     */
	public void createExempleDirect(final ExempleDirect exempleDirect) throws DaoException {
