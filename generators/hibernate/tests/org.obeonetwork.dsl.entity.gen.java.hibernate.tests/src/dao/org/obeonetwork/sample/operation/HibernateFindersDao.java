...
/**
 * Implementation of DAO interface IFindersDao based on the hibernate
 * persistence framework.
 * @see org.obeonetwork.sample.operation.IFindersDao
 */
public class HibernateFindersDao implements IFindersDao {

	/**
     * The logger of this class.
     */
	private final static Log LOG = LogFactory.getLog(HibernateFindersDao.class);
     ...
     */
	public void createFinders(final Finders finders) throws DaoException {
