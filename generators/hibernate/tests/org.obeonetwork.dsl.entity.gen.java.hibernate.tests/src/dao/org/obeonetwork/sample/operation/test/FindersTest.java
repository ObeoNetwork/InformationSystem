...
/**
 * Test class for Finders.
 */
public class FindersTest extends TestCase {
	
	/**
	 * The DAO for class Finders.
	 */
	private IFindersDao findersDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		findersDao = SampleDaoFactory.getOperationFindersDao();
	...
	public final void testCreateFinders() throws DaoException {
	    ...
	    findersDao.createFinders(finders);
	
	    // Verify result
	    boolean found = false;
	    for (Finders currentFinders : findersDao.findAllFinderss()) {
	...
	public final void testUpdateFinders() throws DaoException {
	    ...
	    // Execute the tested code
	    findersDao.updateFinders(finders);
	...
	public final void testDeleteFinders() throws DaoException {
	    ...
	    // Execute the tested code
	    findersDao.deleteFinders(finders);
	...
	public final void testFindAllFinderss() throws DaoException {
	    ...
	    int before = findersDao.findAllFinderss().size();
	    Assert.assertTrue("FindAll must return at least 0", before >= 0);
	    
	    // Add two elements
	    Finders finders1 = getFindersExample();
	    findersDao.createFinders(finders1);
	            
	    Finders finders2 = getFindersExample();
	    findersDao.createFinders(finders2);
	
	    // Verify result
	    int after = findersDao.findAllFinderss().size();
	    Assert.assertEquals(
