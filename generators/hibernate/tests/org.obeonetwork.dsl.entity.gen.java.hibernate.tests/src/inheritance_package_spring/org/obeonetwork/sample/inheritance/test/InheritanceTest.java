 ...
 */
public class InheritanceTest extends AbstractTransactionalSpringContextTests {
	protected final String[] getConfigLocations(){
	    return new String[]{"/conf/spring/tests/applicationContext.xml"};
	}
	
	private IInheritanceDao inheritanceDao = (IInheritanceDao)getApplicationContext().getBean("InheritanceDAO");
