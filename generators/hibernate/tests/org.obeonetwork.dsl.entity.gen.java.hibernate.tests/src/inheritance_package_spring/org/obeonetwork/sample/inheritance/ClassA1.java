...
/**
 *  */
public class ClassA1 implements Serializable {
	 ...
	 * @param a1
	 */
	public void setA1(final Float a1) {
		this.a1 = a1;
	}
     ...
     * ClassA1 and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof ClassA1)) {
			return false;
		}
		
		final ClassA1 castedOther = (ClassA1) other;
