...
/**
 *  */
public class Class0101 implements Serializable {
	 ...
	 * @param target. 
	 */
	public Class0101(String fakeAttr, Class0101END target) {
	 ...
	 * @param target
	 */
	public void setTarget(final Class0101END target) {
		this.target = target;
	}
     ...
     * Class0101 and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class0101)) {
			return false;
		}
		
		final Class0101 castedOther = (Class0101) other;
