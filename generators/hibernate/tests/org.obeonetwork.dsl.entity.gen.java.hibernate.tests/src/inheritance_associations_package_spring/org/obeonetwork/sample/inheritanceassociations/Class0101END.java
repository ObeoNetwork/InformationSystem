...
/**
 *  */
public class Class0101END implements Serializable {
	 ...
	 * @param fakeAttr. 
	 */
	public Class0101END(String fakeAttr) {
     ...
     * Class0101END and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class0101END)) {
			return false;
		}
		
		final Class0101END castedOther = (Class0101END) other;
