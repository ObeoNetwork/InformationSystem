...
public class ClassManyManyEndSub extends ClassManyManyEnd implements Serializable {
     ...
     * ClassManyManyEndSub and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof ClassManyManyEndSub)) {
			return false;
		}
		
		final ClassManyManyEndSub castedOther = (ClassManyManyEndSub) other;
