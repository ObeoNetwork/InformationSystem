 ...
 */
public class TableperhierarchyTest extends TestCase {

	/**
	 * The DAO for class table_per_hierarchy.
	 */
	private ITableperhierarchyDao tableperhierarchyDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		tableperhierarchyDao = SampleDaoFactory.getTableperhierarchyDao();
