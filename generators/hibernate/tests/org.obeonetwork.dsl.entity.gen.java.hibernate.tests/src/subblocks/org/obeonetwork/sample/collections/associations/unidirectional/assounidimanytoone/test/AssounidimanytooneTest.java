 ...
 */
public class AssounidimanytooneTest extends TestCase {

	/**
	 * The DAO for class asso_unidi_many_to_one.
	 */
	private IAssounidimanytooneDao assounidimanytooneDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		assounidimanytooneDao = SampleDaoFactory.getAssounidimanytooneDao();
