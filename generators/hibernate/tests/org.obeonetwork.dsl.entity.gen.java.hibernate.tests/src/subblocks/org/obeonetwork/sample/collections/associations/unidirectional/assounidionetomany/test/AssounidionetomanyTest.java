 ...
 */
public class AssounidionetomanyTest extends TestCase {

	/**
	 * The DAO for class asso_unidi_one_to_many.
	 */
	private IAssounidionetomanyDao assounidionetomanyDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		assounidionetomanyDao = SampleDaoFactory.getAssounidionetomanyDao();
