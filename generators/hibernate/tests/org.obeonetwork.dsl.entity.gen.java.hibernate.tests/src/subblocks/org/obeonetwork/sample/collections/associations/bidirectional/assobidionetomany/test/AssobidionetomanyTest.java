 ...
 */
public class AssobidionetomanyTest extends TestCase {

	/**
	 * The DAO for class asso_bidi_one_to_many.
	 */
	private IAssobidionetomanyDao assobidionetomanyDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		assobidionetomanyDao = SampleDaoFactory.getAssobidionetomanyDao();
