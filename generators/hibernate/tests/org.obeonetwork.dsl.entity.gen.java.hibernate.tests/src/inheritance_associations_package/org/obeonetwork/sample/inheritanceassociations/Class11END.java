...
/**
 *  */
public class Class11END implements Serializable {
	 ...
	 * @param fakeAttr. 
	 */
	public Class11END(String fakeAttr) {
     ...
     * Class11END and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class11END)) {
			return false;
		}
		
		final Class11END castedOther = (Class11END) other;
