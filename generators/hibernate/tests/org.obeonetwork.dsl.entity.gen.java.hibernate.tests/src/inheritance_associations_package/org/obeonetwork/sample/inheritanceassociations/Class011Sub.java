...
/**
 *  */
public class Class011Sub extends Class011 implements Serializable {
     ...
     * Class011Sub and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class011Sub)) {
			return false;
		}
		
		final Class011Sub castedOther = (Class011Sub) other;
