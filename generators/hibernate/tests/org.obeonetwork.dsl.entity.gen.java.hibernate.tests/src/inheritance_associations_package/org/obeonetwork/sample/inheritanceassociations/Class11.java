...
/**
 *  */
public class Class11 implements Serializable {
	 ...
	 * @param target. 
	 */
	public Class11(String fakeAttr, Class11END target) {
	 ...
	 * @param target
	 */
	public void setTarget(final Class11END target) {
		this.target = target;
	}
     ...
     * Class11 and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class11)) {
			return false;
		}
		
		final Class11 castedOther = (Class11) other;
