...
/**
 *  */
public class Class101Sub extends Class101 implements Serializable {
     ...
     * Class101Sub and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof Class101Sub)) {
			return false;
		}
		
		final Class101Sub castedOther = (Class101Sub) other;
