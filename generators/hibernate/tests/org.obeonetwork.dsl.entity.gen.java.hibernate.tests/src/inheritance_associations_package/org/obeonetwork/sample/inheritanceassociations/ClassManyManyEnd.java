...
/**
 *  */
public class ClassManyManyEnd implements Serializable {
	 ...
	 * @param fakeAttr. 
	 */
	public ClassManyManyEnd(String fakeAttr) {
     ...
     * ClassManyManyEnd and the given object has the same PK as this
	...
	public boolean equals(final Object other) {
		...
		if (!(other instanceof ClassManyManyEnd)) {
			return false;
		}
		
		final ClassManyManyEnd castedOther = (ClassManyManyEnd) other;
