 ...
 */
public class InheritanceassociationsTest extends TestCase {

	/**
	 * The DAO for class inheritance_associations.
	 */
	private IInheritanceassociationsDao inheritanceassociationsDao;
	...
	protected void setUp() throws Exception {
	    super.setUp();
		inheritanceassociationsDao = SampleDaoFactory.getInheritanceassociationsDao();
