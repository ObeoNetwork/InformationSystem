 ...
 */
public class Dsl.entity.gen.java.dao.testsConnectionUtils {
	...
	private static Dsl.entity.gen.java.dao.testsConnectionUtils instance;
	 ...
	 * @throws DaoException 
	 */
	public static Dsl.entity.gen.java.dao.testsConnectionUtils getInstance() throws DaoException {
		if (instance == null) {
			synchronized (initializationLock) {
				if (initializationLock.equals(Boolean.TRUE)) {
					instance = new Dsl.entity.gen.java.dao.testsConnectionUtils();
	 ...
	 * @throws DaoException 
	 */
	private Dsl.entity.gen.java.dao.testsConnectionUtils() throws DaoException {
		initConnectionJDBC();
	}
