...
import org.obeonetwork.dsl.entity.gen.java.dao.tests.block1.Entity1;

// End of user code for import

/**
 * This class provides the data access layer to the Entity 1 entity class.<br/>
 * This is the interface which represent the contrat of the DAO access.
 */
public interface IEntity1Dao {

	/**
	 * Create a new element.
	 * @param entity1 Element to create.
	 ...
	 * @param entity1 Element to update. 
	 ...
	 * @param entity1 Element which will be delete. 
	 * @throws DaoException If a Dao problem occurs.
	 */
	 ...
	 * @throws DaoException If a Dao problem occurs.
	 */
	public Collection<Entity1> findAllEntity1s() throws DaoException;
