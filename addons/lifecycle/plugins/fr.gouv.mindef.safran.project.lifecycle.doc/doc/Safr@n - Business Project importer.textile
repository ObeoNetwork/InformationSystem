...
h1. Safr@n - Business Project importer

h2. Principe

Dans le cadre de Safr@n, les équipes MOA et MOE travaillent sur des projets différents et des modèles différents.
...
L'assistant se nomme _Import business project_ et est disponible dans la catégorie _Safr@n_
