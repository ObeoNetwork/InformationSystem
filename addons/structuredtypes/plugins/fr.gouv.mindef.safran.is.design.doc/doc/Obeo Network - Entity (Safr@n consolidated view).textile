...
* _Target Schema_: permet de définir le schéma de destination dans le cadre d'une relation NN. Un "x" dans la ligne d'une référence (issue de relation NN) indique que la table de jointure sera créée dans le même schéma que la référence.
