...
h1. Obeo Network - Graal Methodology (IS-Designer consolidated view)

Le point de vue _Graal Methodology (IS-Designer consolidated view)_ fournit une table permettant de faciliter la saisie d'informations sur le stockage physique des classes participantes Graal.
Les informations sont stockées sous la forme d'annotations.


h2. Création d'une table _Domain Classes Annotations_
 
Pour pouvoir créer une table _Domain Classes Annotations_ il faut activer le point de vue _Graal Methodology (IS-Designer consolidated view)_ sur le projet via le menu contextuel _Viewpoints Selection_ sur le projet ou sur le fichier _aird_.
