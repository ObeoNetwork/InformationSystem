...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Update Table Comment Change</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.database.dbevolution.impl.UpdateTableCommentChangeImpl#getNewTable <em>New Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateTableCommentChangeImpl extends TableChangeImpl implements UpdateTableCommentChange {
	/**
	 ...
	 * @generated
	 */
	protected UpdateTableCommentChangeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DbevolutionPackage.Literals.UPDATE_TABLE_COMMENT_CHANGE;
	}
		...
		if (newTable != null && ((EObject)newTable).eIsProxy()) {
			...
			if (newTable != oldNewTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DbevolutionPackage.UPDATE_TABLE_COMMENT_CHANGE__NEW_TABLE, oldNewTable, newTable));
			}
		}
		return newTable;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DbevolutionPackage.UPDATE_TABLE_COMMENT_CHANGE__NEW_TABLE:
