...
package org.obeonetwork.dsl.database.sqlgen.ide.ui.handlers;
...
import org.obeonetwork.dsl.database.sqlgen.ide.ui.Activator;
import org.obeonetwork.dsl.database.sqlgen.ide.ui.DatabaseGenGeneratorEclipse;
 ...
 * @generated
 */
public class DatabaseGenGeneratorHandler extends AbstractHandler {
		...
		final IRunnableWithProgress generateRunnable = new IRunnableWithProgress() {
			...
			public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
				...
				for (Object selected : selectedList) {
					...
					final DatabaseGenGeneratorEclipse generator;
					try {
						if (selected instanceof Comparison) {
							generator = new DatabaseGenGeneratorEclipse((Comparison) selected);
							generator.generate(childMonitor);
						} else if (selected instanceof IFile) {
							generator = new DatabaseGenGeneratorEclipse((IFile) selected);
							generator.generate(childMonitor);
						}
					} finally {
						childMonitor.done();
