...
/* Date de création :  07/12/2011 09:41:37                      */
/*==============================================================*/


drop public synonym RF_ACTI;

drop public synonym RF_ACTIVITE;

drop synonym RF_ACVT;

drop synonym RF_AFFAERO;

drop synonym RF_AFFECT;

drop synonym RF_AFFSJCT;

drop synonym RF_ANGE;

drop public synonym RF_ANT;

drop synonym RF_APE;

drop synonym RF_ARE;

drop synonym RF_ARME;

drop synonym RF_ARMEE;

drop synonym RF_AVANC;

drop public synonym RF_AXE1;

drop synonym RF_BASE;

drop public synonym RF_BDD;

drop synonym RF_BENAMO;

drop synonym RF_BOP;

drop public synonym RF_BOP_CH;

drop synonym RF_CA;

drop synonym RF_CAL;

drop synonym RF_CATDEP;

drop synonym RF_CATORIDRO;

drop public synonym RF_CBUDD;

drop public synonym RF_CCOU;

drop synonym RF_CDMB;

drop synonym RF_CDSTAT;

drop public synonym RF_CIMO;

drop synonym RF_CLAUTIL;

drop synonym RF_CMD;

drop synonym RF_CNOP;

drop synonym RF_CODMIN;

drop synonym RF_CODNIV;

drop synonym RF_COEFFENT;

drop synonym RF_COMIMP;

drop synonym RF_COMM;

drop synonym RF_COMMCP;

drop synonym RF_CONTRAT_TYP;

drop synonym RF_CORCTORD;

drop synonym RF_CORCTORDSTAT;

drop synonym RF_CORGRD;

drop synonym RF_CORPS;

drop synonym RF_CP;

drop synonym RF_CPCE;

drop public synonym RF_CPCE_NG;

drop public synonym RF_CPER;

drop public synonym RF_CPFTD;

drop public synonym RF_CPMTD;

drop synonym RF_CPT;

drop synonym RF_CPTCLAUTIL;

drop synonym RF_CPTCOM;

drop synonym RF_CPTIND;

drop synonym RF_CPYR;

drop synonym RF_CTACHAT;

drop synonym RF_CTBOP;

drop synonym RF_CTENG;

drop synonym RF_CTGRD;

drop synonym RF_CTLOP;

drop synonym RF_CTOB;

drop synonym RF_CTORD;

drop synonym RF_CTPED;

drop synonym RF_CTSTAT;

drop synonym RF_CTSTORCOR;

drop synonym RF_CTUTIL;

drop public synonym RF_DACTD;

drop synonym RF_DEPT;

drop synonym RF_DEVI;

drop synonym RF_DEVI_NG;

drop synonym RF_DEVPAY;

drop public synonym RF_DFOND;

drop synonym RF_DIPHDEF;

drop synonym RF_DIPTTA;

drop synonym RF_DOM;

drop synonym RF_DOMFONC;

drop synonym RF_DOMTTA;

drop synonym RF_DPSA;

drop synonym RF_ECHELON;

drop synonym RF_ENGCENGJ;

drop public synonym RF_EOTP;

drop synonym RF_ETAN;

drop synonym RF_ETATENT;

drop synonym RF_ETATOPE;

drop synonym RF_FCTCPT;

drop synonym RF_FCTN;

drop synonym RF_FCTRPR;

drop synonym RF_FCTSITE;

drop synonym RF_FCTTTA;

drop public synonym RF_FIMO;

drop synonym RF_FJE;

drop public synonym RF_FOND;

drop synonym RF_FORM;

drop synonym RF_FORMPRI;

drop public synonym RF_GACH;

drop public synonym RF_GCC;

drop synonym RF_GCC_NG;

drop public synonym RF_GCD;

drop synonym RF_GES;

drop public synonym RF_GMDS;

drop synonym RF_GRD;

drop synonym RF_GRDCMP;

drop synonym RF_GRDECH;

drop public synonym RF_GRIM;

drop synonym RF_HOMOLDIP;

drop synonym RF_IMM;

drop synonym RF_IMMCLAUTIL;

drop synonym RF_IMMEUBLE;

drop synonym RF_IMMIND;

drop public synonym RF_IMPE;

drop synonym RF_IMPE_NG;

drop public synonym RF_IMPG;

drop synonym RF_IMPG_NG;

drop synonym RF_INDM;

drop synonym RF_LCLCATUTIL;

drop synonym RF_LCLCLAUTIL;

drop synonym RF_LIGMER;

drop public synonym RF_LOCI;

drop public synonym RF_LOCM;

drop synonym RF_MACCES;

drop synonym RF_MACCOR;

drop synonym RF_MACGRD;

drop synonym RF_MAJ;

drop synonym RF_MDRG;

drop synonym RF_MDVI;

drop synonym RF_MINAFF;

drop synonym RF_MOA;

drop public synonym RF_MPMT;

drop synonym RF_MSORT;

drop synonym RF_MVTMVT;

drop synonym RF_NAT;

drop public synonym RF_NATD;

drop synonym RF_NATDECPRO;

drop synonym RF_NATDEP;

drop synonym RF_NATDRO;

drop synonym RF_NATIMM;

drop synonym RF_NATTXT;

drop synonym RF_NATVOI;

drop synonym RF_NBI;

drop synonym RF_NIVRESP;

drop synonym RF_NIVSUPP;

drop synonym RF_NOMENCPROD;

drop synonym RF_NRCTGRD;

drop synonym RF_NTTR;

drop synonym RF_NTTR_STGPE;

drop public synonym RF_OACH;

drop synonym RF_OBI;

drop synonym RF_OBI_NG;

drop synonym RF_OBJTXT;

drop synonym RF_OCC;

drop synonym RF_ORDRE;

drop synonym RF_ORDS;

drop synonym RF_ORDS_NG;

drop synonym RF_ORGANISME;

drop synonym RF_ORGANISMEARMEE;

drop synonym RF_ORGEN;

drop synonym RF_ORGRAT;

drop synonym RF_ORIDRO;

drop synonym RF_ORIGINE;

drop synonym RF_ORISNUP;

drop synonym RF_PARAG;

drop synonym RF_PAYS;

drop public synonym RF_PAYS_NG;

drop synonym RF_PHASE;

drop synonym RF_POSSTAT;

drop synonym RF_POSTPS;

drop synonym RF_PROD;

drop synonym RF_PROG;

drop public synonym RF_PROJ;

drop synonym RF_PROPRICPT;

drop synonym RF_RATFIS;

drop synonym RF_REG;

drop synonym RF_REGDPT;

drop synonym RF_REGECO;

drop synonym RF_REGION;

drop synonym RF_REGSTAT;

drop synonym RF_RTORG2;

drop synonym RF_SB;

drop synonym RF_SCTPAIE;

drop synonym RF_SCTUTIL;

drop synonym RF_SE;

drop public synonym RF_SEEX;

drop synonym RF_SEGPAT;

drop synonym RF_SFCT;

drop synonym RF_SFCTCLAUTIL;

drop synonym RF_SFCTCPT;

drop synonym RF_SGC;

drop synonym RF_SITMAR;

drop synonym RF_SOBI;

drop synonym RF_STATRA;

drop synonym RF_STATUA;

drop synonym RF_STATUT;

drop public synonym RF_STE_CHORUS;

drop synonym RF_STE_CHORUS2;

drop synonym RF_STRC;

drop synonym RF_TACCES;

drop synonym RF_TACHAT;

drop synonym RF_TACHEFCT;

drop synonym RF_TACHENAT;

drop synonym RF_TAFF;

drop synonym RF_TAMO;

drop synonym RF_TBENECH;

drop synonym RF_TCOMPO;

drop synonym RF_TCONS;

drop synonym RF_TCPT;

drop synonym RF_TDEL;

drop synonym RF_TDOC;

drop synonym RF_TDOCTOPEDOM;

drop synonym RF_TDOM;

drop synonym RF_TDUREE;

drop synonym RF_TENGC;

drop synonym RF_TETAD;

drop synonym RF_TETAO;

drop synonym RF_TF;

drop synonym RF_TFICHIER;

drop public synonym RF_TFON;

drop public synonym RF_TIMP;

drop synonym RF_TIMPN;

drop synonym RF_TINDIC;

drop synonym RF_TINDMAJ;

drop synonym RF_TINTF;

drop synonym RF_TINTV;

drop synonym RF_TITR;

drop synonym RF_TLIG;

drop synonym RF_TLOC;

drop synonym RF_TMAJOPE;

drop synonym RF_TMAN;

drop synonym RF_TMAR;

drop synonym RF_TMEMO;

drop synonym RF_TMNT;

drop synonym RF_TMVT;

drop synonym RF_TNIV;

drop public synonym RF_TOPE;

drop synonym RF_TOPEDOM;

drop synonym RF_TOPLIQ;

drop synonym RF_TOPV;

drop synonym RF_TORG;

drop synonym RF_TOUV;

drop synonym RF_TPAIDIR;

drop synonym RF_TPERS;

drop public synonym RF_TPIE;

drop synonym RF_TPOP;

drop synonym RF_TPOS;

drop synonym RF_TPRE;

drop synonym RF_TPRO;

drop synonym RF_TPROTECT;

drop synonym RF_TPSHIS;

drop synonym RF_TPSTRAV;

drop synonym RF_TPYR;

drop synonym RF_TRAN;

drop synonym RF_TREG;

drop synonym RF_TSAUP;

drop synonym RF_TSAUPP;

drop synonym RF_TSNUP;

drop synonym RF_TSOULTE;

drop synonym RF_TSTAT;

drop synonym RF_TSUB;

drop synonym RF_TSUP;

drop synonym RF_TTACHE;

drop synonym RF_TTF;

drop public synonym RF_TTIE;

drop synonym RF_TTRAN;

drop synonym RF_TVA;

drop public synonym RF_TVA_NG;

drop public synonym RF_UO;

drop synonym RF_UTILCL;

drop public synonym RF_ZD;

drop synonym RF_ZFCT;

drop synonym RF_ZONE;

drop synonym RF_ZONGRD;

drop synonym RF_ZONSIT;

alter table RF_ACTIVITE
   drop constraint RF_ACTIVITE_FK1_1;

alter table RF_ACTIVITE
   drop constraint RF_ACTIVITE_FK1_2;

alter table RF_ANT
   drop constraint RF_ANT_FK1_1;

alter table RF_ARE
   drop constraint RF_ARE_FK1_1;

alter table RF_ARME
   drop constraint RF_ARME_FK1_1;

alter table RF_BDD
   drop constraint RF_BDD_FK1_1;

alter table RF_BDD
   drop constraint RF_BDD_FK1_2;

alter table RF_BOP
   drop constraint RF_BOP_FK2_1;

alter table RF_CA
   drop constraint RF_CA_FK1_1;

alter table RF_CA
   drop constraint RF_CA_FK1_2;

alter table RF_CA
   drop constraint RF_CA_FK1_3;

alter table RF_CCOU
   drop constraint RF_CCOUD_FK1_1;

alter table RF_CCOU
   drop constraint RF_CCOUD_FK1_2;

alter table RF_CCOU
   drop constraint RF_CCOU_FK1_3;

alter table RF_CDSTAT
   drop constraint RF_CDSTAT_FK1_1;

alter table RF_CDSTAT
   drop constraint RF_CDSTAT_FK1_2;

alter table RF_CDSTAT
   drop constraint RF_CDSTAT_FK1_3;

alter table RF_CDSTAT
   drop constraint RF_CDSTAT_FK1_4;

alter table RF_CFIN
   drop constraint RF_CFIN_FK1_1;

alter table RF_CFIN
   drop constraint RF_CFIN_FK1_2;

alter table RF_COEFFENT
   drop constraint RF_COEFFENT_FK1_1;

alter table RF_COMIMP
   drop constraint RF_COMIMP_FK1_1;

alter table RF_COMM
   drop constraint RF_COMM_FK1_1;

alter table RF_COMMCP
   drop constraint RF_COMMCP_FK1_1;

alter table RF_COMMCP
   drop constraint RF_COMMCP_FK1_2;

alter table RF_CORGRD
   drop constraint RF_CORGRD_FK1_1;

alter table RF_CORGRD
   drop constraint RF_CORGRD_FK1_2;

alter table RF_CORPS
   drop constraint RF_CORPS_FK1_1;

alter table RF_CPT
   drop constraint RF_CPT_FK1_1;

alter table RF_CPT
   drop constraint RF_CPT_FK1_3;

alter table RF_CPTCOM
   drop constraint RF_CPTCOM_FK1_1;

alter table RF_CPYR
   drop constraint RF_CPYR_FK1_1;

alter table RF_CTGRD
   drop constraint RF_CTGRD_FK1_1;

alter table RF_CTSTORCOR
   drop constraint RF_CTSTORCOR_FK1_1;

alter table RF_CTSTORCOR
   drop constraint RF_CTSTORCOR_FK1_2;

alter table RF_CTSTORCOR
   drop constraint RF_CTSTORCOR_FK1_3;

alter table RF_CTSTORCOR
   drop constraint RF_CTSTORCOR_FK1_4;

alter table RF_CTUTIL
   drop constraint RF_CTUTIL_FK1_1;

alter table RF_DEPT
   drop constraint RF_DEPT_FK1_1;

alter table RF_DEPT
   drop constraint RF_DEPT_FK1_2;

alter table RF_DEPT
   drop constraint RF_DEPT_FK1_3;

alter table RF_DEPT
   drop constraint RF_DEPT_FK1_4;

alter table RF_DEPT
   drop constraint RF_DEPT_FK1_5;

alter table RF_DEPT
   drop constraint RF_DEPT_FK1_6;

alter table RF_DEVPAY
   drop constraint RF_DEVPAY_FK1_1;

alter table RF_DEVPAY
   drop constraint RF_DEVPAY_FK1_2;

alter table RF_DIPHDEF
   drop constraint RF_DIPHDEF_FK1_1;

alter table RF_DIPTTA
   drop constraint RF_DIPTTA_FK1_1;

alter table RF_DIVI
   drop constraint RF_DIVI_FK1_1;

alter table RF_DIVI
   drop constraint RF_DIVI_FK1_2;

alter table RF_DOMFONC
   drop constraint RF_DOMFONC_FK1_1;

alter table RF_ENGCENGJ
   drop constraint RF_ENGCENGJ_FK1_1;

alter table RF_ENGCENGJ
   drop constraint RF_ENGCENGJ_FK1_2;

alter table RF_FCTRPR
   drop constraint RF_FCTRPR_FK1_1;

alter table RF_FCTRPR
   drop constraint RF_FCTRPR_FK1_2;

alter table RF_FCTRPR
   drop constraint RF_FCTRPR_FK1_3;

alter table RF_FCTSITE
   drop constraint RF_FCTSITE_FK1_1;

alter table RF_FCTTTA
   drop constraint RF_FCTTTA_FK1_1;

alter table RF_FCTTTA
   drop constraint RF_FCTTTA_FK1_2;

alter table RF_FCTTTA
   drop constraint RF_FCTTTA_FK1_3;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_2;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_1;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_4;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_7;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_3;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_5;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_6;

alter table RF_FIMO
   drop constraint RF_FIMO_FK1_8;

alter table RF_FORM
   drop constraint RF_FORM_FK1_1;

alter table RF_GCD
   drop constraint RF_GCD_FK1_1;

alter table RF_GRD
   drop constraint RF_GRD_FK1_1;

alter table RF_GRDECH
   drop constraint RF_GRDECH_FK1_1;

alter table RF_GRDECH
   drop constraint RF_GRDECH_FK1_2;

alter table RF_GRIM
   drop constraint RF_GRIM_FK1_1;

alter table RF_IMM
   drop constraint RF_IMM_FK1_1;

alter table RF_IMM
   drop constraint RF_IMM_FK1_2;

alter table RF_IMM
   drop constraint FK_RF_IMM_RF_IMM_FK_RF_IMMIN;

alter table RF_IMM
   drop constraint FK_RF_IMM_RF_IMM_FK_RF_ORGAN;

alter table RF_IMMEUBLE
   drop constraint RF_IMMEUBLE_FK1_1;

alter table RF_IMMEUBLE
   drop constraint RF_IMMEUBLE_FK1_2;

alter table RF_IMMEUBLE
   drop constraint RF_IMMEUBLE_FK1_3;

alter table RF_IMMEUBLE
   drop constraint RF_IMMEUBLE_FK1_4;

alter table RF_IMPE
   drop constraint RF_IMPE_FK2_1;

alter table RF_IMPE_NG
   drop constraint RF_IMPE_NG_FK1_1;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_1;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_2;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_3;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_4;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_5;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_6;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_7;

alter table RF_IMPG
   drop constraint RF_IMPG_FK1_8;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_1;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_2;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_3;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_4;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_5;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_6;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_7;

alter table RF_IMPG_NG
   drop constraint RF_IMPG_NG_FK1_8;

alter table RF_LCLCLAUTIL
   drop constraint RF_LCLCLAUTIL_FK1_1;

alter table RF_LIGMER
   drop constraint RF_LIGMER_FK1_1;

alter table RF_MACCES
   drop constraint RF_MACCES_FK1_1;

alter table RF_MACCOR
   drop constraint RF_MACCOR_FK1_1;

alter table RF_MACCOR
   drop constraint RF_MACCOR_FK1_2;

alter table RF_MACGRD
   drop constraint RF_MACGRD_FK1_1;

alter table RF_MACGRD
   drop constraint RF_MACGRD_FK1_2;

alter table RF_MAJ
   drop constraint RF_MAJ_FK1_1;

alter table RF_MAJ
   drop constraint RF_MAJ_FK1_2;

alter table RF_MVTMVT
   drop constraint RF_MVTMVT_FK1_1;

alter table RF_MVTMVT
   drop constraint RF_MVTMVT_FK1_2;

alter table RF_NOMENCPROD
   drop constraint RF_NOMENCPROD_FK1_1;

alter table RF_NRCTGRD
   drop constraint RF_NRCTGRD_FK1_1;

alter table RF_NRCTGRD
   drop constraint RF_NRCTGRD_FK1_2;

alter table RF_NTTR
   drop constraint RF_NTTR_FK1_1;

alter table RF_NTTR
   drop constraint RF_NTTR_FK1_2;

alter table RF_NTTR_STGPE
   drop constraint RF_NTTR_STGPE_FK1_1;

alter table RF_OBI
   drop constraint RF_OBI_FK1_2;

alter table RF_OBI
   drop constraint RF_OBI_FK1_3;

alter table RF_OBI
   drop constraint RF_OBI_FK2_1;

alter table RF_OBI_NG
   drop constraint RF_OBI_NG_FK1_1;

alter table RF_OBI_NG
   drop constraint RF_OBI_NG_FK1_2;

alter table RF_OBI_NG
   drop constraint RF_OBI_NG_FK1_3;

alter table RF_ORDS
   drop constraint RF_ORDS_FK1_1;

alter table RF_ORDS
   drop constraint RF_ORDS_FK1_2;

alter table RF_ORGANISME
   drop constraint RF_ORGANISME_FK1_1;

alter table RF_ORGANISME
   drop constraint RF_ORGANISME_FK1_2;

alter table RF_ORGANISME
   drop constraint RF_ORGANISME_FK1_3;

alter table RF_ORGANISMEARMEE
   drop constraint RF_ORGANISMEARMEE_FK1_1;

alter table RF_ORGANISMEARMEE
   drop constraint RF_ORGANISMEARMEE_FK1_2;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK1_1;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK1_2;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK1_3;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK1_4;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK1_6;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK1_7;

alter table RF_ORGEN
   drop constraint RF_ORGEN_FK2_5;

alter table RF_ORIDRO
   drop constraint RF_ORIDRO_FK1_1;

alter table RF_PARAG
   drop constraint RF_PARAG_FK1_1;

alter table RF_POSSTAT
   drop constraint RF_POSSTAT_FK1_1;

alter table RF_POSTPS
   drop constraint RF_POSTPS_FK1_1;

alter table RF_POSTPS
   drop constraint RF_POSTPS_FK1_2;

alter table RF_PROD
   drop constraint RF_PROD_FK1_1;

alter table RF_PROD
   drop constraint RF_PROD_FK1_2;

alter table RF_PROPRICPT
   drop constraint RF_PROPRICPT_FK1_1;

alter table RF_RATFIS
   drop constraint RF_RATFIS_FK1_1;

alter table RF_REG
   drop constraint RF_REG_FK1_1;

alter table RF_REGDPT
   drop constraint RF_REGDPT_FK1_1;

alter table RF_REGDPT
   drop constraint RF_REGDPT_FK1_2;

alter table RF_REGECO
   drop constraint RF_REGECO_FK1_1;

alter table RF_REGION
   drop constraint RF_REGION_FK1_1;

alter table RF_REGSTAT
   drop constraint RF_REGSTAT_FK1_1;

alter table RF_RTORG
   drop constraint RF_RTORG_FK1_1;

alter table RF_RTORG
   drop constraint RF_RTORG_FK1_2;

alter table RF_RTPAYS
   drop constraint RF_RTPAYS_FK1_1;

alter table RF_RT_OPSE
   drop constraint RF_RT_OPSE_FK1_1;

alter table RF_RT_PARM_DCG
   drop constraint RF_RT_PARM_DCG_FK1_1;

alter table RF_RT_PARM_DG
   drop constraint RF_RT_PARM_DG_FK1_1;

alter table RF_RT_PARM_DG
   drop constraint RF_RT_PARM_DG_FK1_2;

alter table RF_RT_PARM_EG
   drop constraint RF_RT_PARM_EG_FK1_1;

alter table RF_RT_PARM_EG
   drop constraint RF_RT_PARM_EG_FK1_2;

alter table RF_SB
   drop constraint RF_SB_FK1_1;

alter table RF_SB
   drop constraint RF_SB_FK1_2;

alter table RF_SCTUTIL
   drop constraint RF_SCTUTIL_FK1_1;

alter table RF_SE
   drop constraint RF_SE_FK1_1;

alter table RF_SE
   drop constraint RF_SE_FK1_2;

alter table RF_SFCT
   drop constraint RF_SFCT_FK1_1;

alter table RF_SFCTCLAUTIL
   drop constraint RF_SFCTCLAUTIL_FK1_1;

alter table RF_SFCTCLAUTIL
   drop constraint RF_SFCTCLAUTIL_FK1_2;

alter table RF_SFCTCPT
   drop constraint RF_SFCTCPT_FK1_1;

alter table RF_SOBI
   drop constraint RF_SOBI_FK3_1;

alter table RF_STATRA
   drop constraint RF_STATRA_FK1_1;

alter table RF_STATRA
   drop constraint RF_STATRA_FK1_2;

alter table RF_STATUT
   drop constraint RF_STATUT_FK1_1;

alter table RF_STRC
   drop constraint RF_STRC_FK1_1;

alter table RF_STRC
   drop constraint RF_STRC_FK1_2;

alter table RF_STRC
   drop constraint RF_STRC_FK1_3;

alter table RF_TACHAT
   drop constraint RF_TACHAT_FK1_1;

alter table RF_TDEL
   drop constraint RF_TDEL_FK1_1;

alter table RF_TDOCTOPEDOM
   drop constraint RF_TDOCTOPEDOM_FK1_1;

alter table RF_TDOCTOPEDOM
   drop constraint RF_TDOCTOPEDOM_FK1_2;

alter table RF_TF
   drop constraint RF_TF_FK1_1;

alter table RF_TF
   drop constraint RF_TF_FK1_2;

alter table RF_TFON
   drop constraint RF_TFON_FK1_1;

alter table RF_TMAN
   drop constraint RF_TMAN_FK1_1;

alter table RF_TMVT
   drop constraint RF_TMVT_FK1_1;

alter table RF_TMVT
   drop constraint RF_TMVT_FK1_2;

alter table RF_TMVT
   drop constraint RF_TMVT_FK1_3;

alter table RF_TOUV
   drop constraint RF_TOUV_FK1_1;

alter table RF_TOUV
   drop constraint RF_TOUV_FK1_2;

alter table RF_TPOP
   drop constraint RF_TPOP_FK1_1;

alter table RF_TPRE
   drop constraint RF_TPRE_FK1_1;

alter table RF_TPSTRAV
   drop constraint RF_TPSTRAV_FK1_1;

alter table RF_TVA
   drop constraint RF_TVA_FK1_1;

alter table RF_TVA_NG
   drop constraint RF_TVA_NG_FK1_1;

alter table RF_UO
   drop constraint RF_UO_FK1_3;

alter table RF_UO
   drop constraint RF_UO_FK1_4;

alter table RF_UO
   drop constraint RF_UO_FK1_5;

alter table RF_ZONGRD
   drop constraint RF_ZONGRD_FK1_1;

alter table RF_ZONGRD
   drop constraint RF_ZONGRD_FK1_2;

alter table RF_ACTI
   drop unique (RF_ACTI_AREA, RF_ACTI_REFPRG) cascade;

alter table RF_ACTI
   drop primary key cascade;

drop table RF_ACTI cascade constraints;

drop index RF_ACTIVITE_FK1_2;

drop index RF_ACTIVITE_FK1_1;

alter table RF_ACTIVITE
   drop primary key cascade;

drop table RF_ACTIVITE cascade constraints;

alter table RF_ACVT
   drop primary key cascade;

drop table RF_ACVT cascade constraints;

drop index RF_AFFAERO_UN2_1;

alter table RF_AFFAERO
   drop primary key cascade;

drop table RF_AFFAERO cascade constraints;

drop index RF_AFFECT_UN1_1;

alter table RF_AFFECT
   drop primary key cascade;

drop table RF_AFFECT cascade constraints;

alter table RF_AFFSJCT
   drop primary key cascade;

drop table RF_AFFSJCT cascade constraints;

alter table RF_ANGE
   drop primary key cascade;

drop table RF_ANGE cascade constraints;

alter table RF_ANT
   drop primary key cascade;

drop table RF_ANT cascade constraints;

alter table RF_APE
   drop primary key cascade;

drop table RF_APE cascade constraints;

drop index RF_ARE_FK1_1;

drop index RF_ARE_UN1_1;

alter table RF_ARE
   drop primary key cascade;

drop table RF_ARE cascade constraints;

drop index RF_ARME_UN1_1;

drop index RF_ARME_FK1_1;

alter table RF_ARME
   drop primary key cascade;

drop table RF_ARME cascade constraints;

drop index RF_ARMEE_UN1_1;

alter table RF_ARMEE
   drop primary key cascade;

drop table RF_ARMEE cascade constraints;

drop index RF_AVANC_UN1_1;

alter table RF_AVANC
   drop primary key cascade;

drop table RF_AVANC cascade constraints;

alter table RF_AXE1
   drop unique (RF_AXE1_MIN1) cascade;

alter table RF_AXE1
   drop primary key cascade;

drop table RF_AXE1 cascade constraints;

drop index RF_BASE_UN1_1;

alter table RF_BASE
   drop primary key cascade;

drop table RF_BASE cascade constraints;

alter table RF_BDD
   drop primary key cascade;

drop table RF_BDD cascade constraints;

drop index RF_BENAMO_UN1_1;

alter table RF_BENAMO
   drop primary key cascade;

drop table RF_BENAMO cascade constraints;

drop index RF_BOP_UN3_1;

drop index RF_BOP_FK2_1;

alter table RF_BOP
   drop primary key cascade;

drop table RF_BOP cascade constraints;

alter table RF_BOP_CH
   drop unique (RF_PROG_ID, RF_BOP_COD) cascade;

alter table RF_BOP_CH
   drop primary key cascade;

drop table RF_BOP_CH cascade constraints;

drop index RF_CA_FK1_3;

drop index RF_CA_FK1_2;

drop index RF_CA_FK1_1;

alter table RF_CA
   drop primary key cascade;

drop table RF_CA cascade constraints;

drop index RF_CAL_PK1_1;

alter table RF_CAL
   drop primary key cascade;

drop table RF_CAL cascade constraints;

drop index RF_CATDEP_UN1_1;

alter table RF_CATDEP
   drop primary key cascade;

drop table RF_CATDEP cascade constraints;

alter table RF_CATOPE
   drop primary key cascade;

drop table RF_CATOPE cascade constraints;

alter table RF_CATORIDRO
   drop primary key cascade;

drop table RF_CATORIDRO cascade constraints;

alter table RF_CBUD
   drop unique (RF_CBUD_CMMT_ITEM, RF_CBUD_FM_AREA, RF_CBUD_DATETO) cascade;

alter table RF_CBUD
   drop primary key cascade;

drop table RF_CBUD cascade constraints;

drop index RF_CCOU_FK1_3;

drop index RF_CCOU_FK1_2;

drop index RF_CCOU_FK1_1;

alter table RF_CCOU
   drop unique (RF_CCOU_CO_AREA, RF_CCOU_COSTCENTER, RF_CCOU_DATETO) cascade;

alter table RF_CCOU
   drop primary key cascade;

drop table RF_CCOU cascade constraints;

alter table RF_CDMB
   drop primary key cascade;

drop table RF_CDMB cascade constraints;

drop index RF_CDSTAT_FK1_4;

drop index RF_CDSTAT_FK1_2;

drop index RF_CDSTAT_FK1_3;

drop index RF_CDSTAT_FK1_1;

alter table RF_CDSTAT
   drop primary key cascade;

drop table RF_CDSTAT cascade constraints;

drop index RF_CFIN_FK1_2;

drop index RF_CFIN_FK1_1;

alter table RF_CFIN
   drop unique (RF_CFIN_FM_AREA, RF_CFIN_CENTREFI, RF_CFIN_DATETO) cascade;

alter table RF_CFIN
   drop primary key cascade;

drop table RF_CFIN cascade constraints;

alter table RF_CIMO
   drop unique (RF_CIMO_EASSETCTG) cascade;

alter table RF_CIMO
   drop primary key cascade;

drop table RF_CIMO cascade constraints;

drop index RF_CLAUTIL_UN1_1;

alter table RF_CLAUTIL
   drop primary key cascade;

drop table RF_CLAUTIL cascade constraints;

alter table RF_CLINV
   drop primary key cascade;

drop table RF_CLINV cascade constraints;

alter table RF_CMD
   drop primary key cascade;

drop table RF_CMD cascade constraints;

drop index RF_CNOP_UN1_1;

alter table RF_CNOP
   drop primary key cascade;

drop table RF_CNOP cascade constraints;

alter table RF_CODMIN
   drop primary key cascade;

drop table RF_CODMIN cascade constraints;

alter table RF_CODNIV
   drop primary key cascade;

drop table RF_CODNIV cascade constraints;

alter table RF_COEFFENT
   drop primary key cascade;

drop table RF_COEFFENT cascade constraints;

drop index RF_COMIMP_FK1_2;

drop index RF_COMIMP_UN2_1;

drop index RF_COMIMP_FK1_1;

alter table RF_COMIMP
   drop primary key cascade;

drop table RF_COMIMP cascade constraints;

drop index RF_COMM_UN2_1;

drop index RF_COMM_FK1_2;

drop index RF_COMM_FK1_1;

alter table RF_COMM
   drop primary key cascade;

drop table RF_COMM cascade constraints;

drop index RF_COMMCP_UN2_1;

drop index RF_COMMCP_FK1_2;

drop index RF_COMMCP_FK1_1;

alter table RF_COMMCP
   drop primary key cascade;

drop table RF_COMMCP cascade constraints;

drop index RF_CORGRD_UN2_1;

drop index RF_CORGRD_FK1_2;

drop index RF_CORGRD_FK1_1;

alter table RF_CORGRD
   drop primary key cascade;

drop table RF_CORGRD cascade constraints;

drop index RF_CORPS_FK1_1;

drop index RF_CORPS_UN1_1;

alter table RF_CORPS
   drop primary key cascade;

drop table RF_CORPS cascade constraints;

drop index RF_CP_UN1_1;

alter table RF_CP
   drop primary key cascade;

drop table RF_CP cascade constraints;

drop index RF_CPCE_UN1_1;

alter table RF_CPCE
   drop primary key cascade;

drop table RF_CPCE cascade constraints;

alter table RF_CPCE_NG
   drop unique (RF_CPCE_CHRT_ACCTS, RF_CPCE_GL_ACCOUNT) cascade;

alter table RF_CPCE_NG
   drop primary key cascade;

drop table RF_CPCE_NG cascade constraints;

alter table RF_CPER
   drop unique (RF_CPER_CPER) cascade;

alter table RF_CPER
   drop primary key cascade;

drop table RF_CPER cascade constraints;

alter table RF_CPFT
   drop unique (RF_CPFT_CO_AREA, RF_CPFT_PROFIT_CTR, RF_CPFT_DATETO) cascade;

alter table RF_CPFT
   drop primary key cascade;

drop table RF_CPFT cascade constraints;

alter table RF_CPMTD
   drop unique (RF_CPMTD_ERL_CONDP) cascade;

alter table RF_CPMTD
   drop primary key cascade;

drop table RF_CPMTD cascade constraints;

drop index RF_CPT_UN2_1;

drop index RF_CPT_FK1_3;

drop index RF_CPT_FK1_2;

drop index RF_CPT_FK1_1;

alter table RF_CPT
   drop primary key cascade;

drop table RF_CPT cascade constraints;

drop index RF_CPTCLAUTIL_UN1_1;

alter table RF_CPTCLAUTIL
   drop primary key cascade;

drop table RF_CPTCLAUTIL cascade constraints;

drop index RF_CPTCOM_FK1_1;

alter table RF_CPTCOM
   drop primary key cascade;

drop table RF_CPTCOM cascade constraints;

drop index RF_CPTIND_UN1_1;

alter table RF_CPTIND
   drop primary key cascade;

drop table RF_CPTIND cascade constraints;

drop index RF_CPYR_UN2_1;

alter table RF_CPYR
   drop primary key cascade;

drop table RF_CPYR cascade constraints;

alter table RF_CTACHAT
   drop primary key cascade;

drop table RF_CTACHAT cascade constraints;

drop index RF_CTBOP_UN1_1;

alter table RF_CTBOP
   drop primary key cascade;

drop table RF_CTBOP cascade constraints;

alter table RF_CTENG
   drop primary key cascade;

drop table RF_CTENG cascade constraints;

drop index RF_CTGRD_FK1_1;

alter table RF_CTGRD
   drop primary key cascade;

drop table RF_CTGRD cascade constraints;

drop index RF_CTLOP_UN1_1;

alter table RF_CTLOP
   drop primary key cascade;

drop table RF_CTLOP cascade constraints;

alter table RF_CTOB
   drop primary key cascade;

drop table RF_CTOB cascade constraints;

drop index RF_CTSTORCOR_UN4_1;

drop index RF_CTSTORCOR_FK1_4;

drop index RF_CTSTORCOR_FK1_3;

drop index RF_CTSTORCOR_FK1_2;

drop index RF_CTSTORCOR_FK1_1;

alter table RF_CTSTORCOR
   drop primary key cascade;

drop table RF_CTSTORCOR cascade constraints;

drop index RF_CTUTIL_FK1_1;

alter table RF_CTUTIL
   drop primary key cascade;

drop table RF_CTUTIL cascade constraints;

alter table RF_DACT
   drop unique (RF_DACT_AREA) cascade;

alter table RF_DACT
   drop primary key cascade;

drop table RF_DACT cascade constraints;

drop index RF_DEPT_UN1_1;

drop index RF_DEPT_FK1_6;

drop index RF_DEPT_FK1_5;

drop index RF_DEPT_FK1_4;

drop index RF_DEPT_FK1_3;

drop index RF_DEPT_FK1_2;

drop index RF_DEPT_FK1_1;

alter table RF_DEPT
   drop primary key cascade;

drop table RF_DEPT cascade constraints;

alter table RF_DEVI
   drop primary key cascade;

drop table RF_DEVI cascade constraints;

alter table RF_DEVI_NG
   drop unique (RF_DEVI_CURR1) cascade;

alter table RF_DEVI_NG
   drop primary key cascade;

drop table RF_DEVI_NG cascade constraints;

drop index RF_DEVPAY_FK1_1;

drop index RF_DEVPAY_FK1_2;

alter table RF_DEVPAY
   drop primary key cascade;

drop table RF_DEVPAY cascade constraints;

alter table RF_DFON
   drop unique (RF_DFON_FUNC_AREA) cascade;

alter table RF_DFON
   drop primary key cascade;

drop table RF_DFON cascade constraints;

drop index RF_DIPHDEF_UN1_1;

drop index RF_DIPHDEF_FK1_1;

alter table RF_DIPHDEF
   drop primary key cascade;

drop table RF_DIPHDEF cascade constraints;

drop index RF_DIPTTA_UN1_1;

drop index RF_DIPTTA_FK1_1;

alter table RF_DIPTTA
   drop primary key cascade;

drop table RF_DIPTTA cascade constraints;

alter table RF_DIVI
   drop unique (RF_DIVI_PLAN) cascade;

alter table RF_DIVI
   drop primary key cascade;

drop table RF_DIVI cascade constraints;

drop index RF_DOM_UN1_1;

alter table RF_DOM
   drop primary key cascade;

drop table RF_DOM cascade constraints;

drop index RF_DOMFONC_FK1_1;

alter table RF_DOMFONC
   drop primary key cascade;

drop table RF_DOMFONC cascade constraints;

drop index RF_DOMTTA_UN2_1;

alter table RF_DOMTTA
   drop primary key cascade;

drop table RF_DOMTTA cascade constraints;

drop index RF_DPSA_UN1_1;

alter table RF_DPSA
   drop primary key cascade;

drop table RF_DPSA cascade constraints;

alter table RF_ECDV
   drop primary key cascade;

drop table RF_ECDV cascade constraints;

drop index RF_ECHELON_UN1_1;

alter table RF_ECHELON
   drop primary key cascade;

drop table RF_ECHELON cascade constraints;

alter table RF_EIDV
   drop primary key cascade;

drop table RF_EIDV cascade constraints;

drop index RF_ENGCENGJ_FK1_1;

drop index RF_ENGCENGJ_FK1_2;

alter table RF_ENGCENGJ
   drop primary key cascade;

drop table RF_ENGCENGJ cascade constraints;

alter table RF_EOTP
   drop unique (RF_EOTP_EWBSELEMNT) cascade;

alter table RF_EOTP
   drop primary key cascade;

drop table RF_EOTP cascade constraints;

alter table RF_ETAN
   drop primary key cascade;

drop table RF_ETAN cascade constraints;

drop index RF_ETATENT_UN1_1;

alter table RF_ETATENT
   drop primary key cascade;

drop table RF_ETATENT cascade constraints;

alter table RF_ETATOPE
   drop primary key cascade;

drop table RF_ETATOPE cascade constraints;

drop index RF_FCTCPT_PK1_1;

alter table RF_FCTCPT
   drop primary key cascade;

drop table RF_FCTCPT cascade constraints;

alter table RF_FCTN
   drop primary key cascade;

drop table RF_FCTN cascade constraints;

drop index RF_FCTRPR_FK1_1;

drop index RF_FCTRPR_FK1_2;

drop index RF_FCTRPR_FK1_3;

drop index RF_FCTRPR_PK3_1;

alter table RF_FCTRPR
   drop primary key cascade;

drop table RF_FCTRPR cascade constraints;

drop index RF_FCTSITE_FK1_1;

drop index RF_FCTSITE_PK1_1;

alter table RF_FCTSITE
   drop primary key cascade;

drop table RF_FCTSITE cascade constraints;

drop index RF_FCTTTA_FK1_3;

drop index RF_FCTTTA_UN1_1;

drop index RF_FCTTTA_FK1_2;

drop index RF_FCTTTA_FK1_1;

alter table RF_FCTTTA
   drop primary key cascade;

drop table RF_FCTTTA cascade constraints;

drop index RF_FIMO_FK1_8;

drop index RF_FIMO_FK1_7;

drop index RF_FIMO_FK1_6;

drop index RF_FIMO_FK1_5;

drop index RF_FIMO_FK1_4;

drop index RF_FIMO_FK1_3;

drop index RF_FIMO_FK1_2;

drop index RF_FIMO_FK1_1;

alter table RF_FIMO
   drop unique (RF_FIMO_EASSET, RF_FIMO_ASSET_MAIN, RF_FIMO_DATETO, RF_STE_CHORUS_ID) cascade;

alter table RF_FIMO
   drop primary key cascade;

drop table RF_FIMO cascade constraints;

alter table RF_FJE
   drop primary key cascade;

drop table RF_FJE cascade constraints;

alter table RF_FOND
   drop unique (RF_FOND_FUND, RF_FOND_AREA, RF_FOND_DATETO) cascade;

alter table RF_FOND
   drop primary key cascade;

drop table RF_FOND cascade constraints;

drop index RF_FORM_FK1_1;

alter table RF_FORM
   drop primary key cascade;

drop table RF_FORM cascade constraints;

alter table RF_FORMPRI
   drop primary key cascade;

drop table RF_FORMPRI cascade constraints;

alter table RF_GACH
   drop unique (RF_GACH_PUR_GROUP) cascade;

alter table RF_GACH
   drop primary key cascade;

drop table RF_GACH cascade constraints;

alter table RF_GCC
   drop primary key cascade;

drop table RF_GCC cascade constraints;

drop index RF_GCC_NG_UN1_1;

alter table RF_GCC_NG
   drop primary key cascade;

drop table RF_GCC_NG cascade constraints;

drop index RF_GCD_FK1_1;

alter table RF_GCD
   drop primary key cascade;

drop table RF_GCD cascade constraints;

drop index RF_GES_UN1_1;

alter table RF_GES
   drop primary key cascade;

drop table RF_GES cascade constraints;

alter table RF_GMDS
   drop unique (RF_GMDS_MATL_GROUP) cascade;

alter table RF_GMDS
   drop primary key cascade;

drop table RF_GMDS cascade constraints;

drop index RF_GRD_FK1_1;

alter table RF_GRD
   drop primary key cascade;

drop table RF_GRD cascade constraints;

drop index RF_GRDCMP_UN1_1;

alter table RF_GRDCMP
   drop primary key cascade;

drop table RF_GRDCMP cascade constraints;

drop index RF_GRDECH_UN2_1;

drop index RF_GRDECH_FK1_2;

drop index RF_GRDECH_FK1_1;

alter table RF_GRDECH
   drop primary key cascade;

drop table RF_GRDECH cascade constraints;

drop index RF_GRIM_FK1_1;

alter table RF_GRIM
   drop primary key cascade;

drop table RF_GRIM cascade constraints;

drop index RF_HOMOLDIP_UN1_1;

alter table RF_HOMOLDIP
   drop primary key cascade;

drop table RF_HOMOLDIP cascade constraints;

drop index RF_IMM_FK1_2;

drop index RF_IMM_FK1_1;

alter table RF_IMM
   drop primary key cascade;

drop table RF_IMM cascade constraints;

drop index RF_IMMCALUTIL_UN1_1;

alter table RF_IMMCLAUTIL
   drop primary key cascade;

drop table RF_IMMCLAUTIL cascade constraints;

drop index RF_IMMEUBLE_UN1_1;

drop index RF_IMMEUBLE_FK1_5;

drop index RF_IMMEUBLE_FK1_4;

drop index RF_IMMEUBLE_FK1_3;

drop index RF_IMMEUBLE_FK1_2;

drop index RF_IMMEUBLE_FK1_1;
...
drop index RF_IMMIND_UN1_1;

alter table RF_IMMIND
   drop primary key cascade;

drop table RF_IMMIND cascade constraints;

drop index RF_IMPE_FK2_1;

alter table RF_IMPE
   drop primary key cascade;

drop table RF_IMPE cascade constraints;

drop index RF_IMPE_NG_UN1_1;

alter table RF_IMPE_NG
   drop primary key cascade;

drop table RF_IMPE_NG cascade constraints;

drop index RF_IMPG_FK1_7;

drop index RF_IMPG_FK1_2;

drop index RF_IMPG_FK1_6;

drop index RF_IMPG_FK1_3;

drop index RF_IMPG_FK1_5;

drop index RF_IMPG_FK1_8;

drop index RF_IMPG_FK1_4;

drop index RF_IMPG_FK1_1;

alter table RF_IMPG
   drop primary key cascade;

drop table RF_IMPG cascade constraints;

drop index RF_IMPG_NG_UN2_1;

drop index RF_IMPG_NG_FK1_7;

drop index RF_IMPG_NG_FK1_2;

drop index RF_IMPG_NG_FK1_6;

drop index RF_IMPG_NG_FK1_5;

drop index RF_IMPG_NG_FK1_8;

drop index RF_IMPG_NG_FK1_4;

drop index RF_IMPG_NG_FK1_1;

alter table RF_IMPG_NG
   drop primary key cascade;

drop table RF_IMPG_NG cascade constraints;

alter table RF_INDM
   drop primary key cascade;

drop table RF_INDM cascade constraints;

drop index RF_LCLCATUTIL_UN1_1;

alter table RF_LCLCATUTIL
   drop primary key cascade;

drop table RF_LCLCATUTIL cascade constraints;

drop index RF_LCLCLAUTIL_UN2_1;

drop index RF_LCLCLAUTIL_FK1_1;
...
drop index RF_LIGMER_FK1_1;

alter table RF_LIGMER
   drop primary key cascade;

drop table RF_LIGMER cascade constraints;

alter table RF_LOCI
   drop unique (RF_LOCI_LOCINT) cascade;

alter table RF_LOCI
   drop primary key cascade;

drop table RF_LOCI cascade constraints;

alter table RF_LOCM
   drop unique (RF_LOCM_LOCMIN) cascade;

alter table RF_LOCM
   drop primary key cascade;

drop table RF_LOCM cascade constraints;

drop index RF_MACCES_UN2_1;

drop index RF_MACCES_FK1_1;

alter table RF_MACCES
   drop primary key cascade;

drop table RF_MACCES cascade constraints;

drop index RF_MACCOR_UN2_1;

drop index RF_MACCOR_FK1_2;

drop index RF_MACCOR_FK1_1;

alter table RF_MACCOR
   drop primary key cascade;

drop table RF_MACCOR cascade constraints;

drop index RF_MACGRD_UN2_1;

drop index RF_MACGRD_FK2_1;

drop index RF_MACGRD_FK1_1;

alter table RF_MACGRD
   drop primary key cascade;

drop table RF_MACGRD cascade constraints;

drop index RF_MAJ_UN1_1;

drop index RF_MAJ_FK1_2;

drop index RF_MAJ_FK1_1;

alter table RF_MAJ
   drop primary key cascade;

drop table RF_MAJ cascade constraints;

alter table RF_MDRG
   drop primary key cascade;

drop table RF_MDRG cascade constraints;

drop index RF_MDVI_UN1_1;

alter table RF_MDVI
   drop primary key cascade;

drop table RF_MDVI cascade constraints;

drop index RF_MINAFF_UN1_1;

alter table RF_MINAFF
   drop primary key cascade;

drop table RF_MINAFF cascade constraints;

drop index RF_MOA_UN1_1;

alter table RF_MOA
   drop primary key cascade;

drop table RF_MOA cascade constraints;

alter table RF_MPMT
   drop unique (RF_MPMT_MET, RF_MPMT_COUNTRY) cascade;

alter table RF_MPMT
   drop primary key cascade;

drop table RF_MPMT cascade constraints;

drop index RF_MSORT_UN1_1;

alter table RF_MSORT
   drop primary key cascade;

drop table RF_MSORT cascade constraints;

drop index RF_MVTMVT_FK1_1;

drop index RF_MVTMVT_FK1_2;

alter table RF_MVTMVT
   drop primary key cascade;

drop table RF_MVTMVT cascade constraints;

drop index RF_NAT_UN1_1;

alter table RF_NAT
   drop primary key cascade;

drop table RF_NAT cascade constraints;

alter table RF_NATD
   drop unique (RF_NATD_NATMIN) cascade;

alter table RF_NATD
   drop primary key cascade;

drop table RF_NATD cascade constraints;

drop index RF_NATDECPRO_UN1_1;

alter table RF_NATDECPRO
   drop primary key cascade;

drop table RF_NATDECPRO cascade constraints;

drop index RF_NATDEP_UN1_1;

alter table RF_NATDEP
   drop primary key cascade;

drop table RF_NATDEP cascade constraints;

drop index RF_NATDRO_UN1_1;

alter table RF_NATDRO
   drop primary key cascade;

drop table RF_NATDRO cascade constraints;

drop index RF_NATIMM_UN1_1;

alter table RF_NATIMM
   drop primary key cascade;

drop table RF_NATIMM cascade constraints;

drop index RF_NATTXT_UN1_1;

alter table RF_NATTXT
   drop primary key cascade;

drop table RF_NATTXT cascade constraints;

drop index RF_NATVOI_UN1_1;

alter table RF_NATVOI
   drop primary key cascade;

drop table RF_NATVOI cascade constraints;

drop index RF_NBI_UN1_1;

alter table RF_NBI
   drop primary key cascade;

drop table RF_NBI cascade constraints;

drop index RF_NIVRESP_UN1_1;

alter table RF_NIVRESP
   drop primary key cascade;

drop table RF_NIVRESP cascade constraints;

drop index RF_NIVSUPP_UN1_1;

alter table RF_NIVSUPP
   drop primary key cascade;

drop table RF_NIVSUPP cascade constraints;

drop index RF_NOMENCPROD_FK1_1;

alter table RF_NOMENCPROD
   drop primary key cascade;

drop table RF_NOMENCPROD cascade constraints;

drop index RF_NRCTGRD_UN2_1;

drop index RF_NRCTGRD_FK1_2;

drop index RF_NRCTGRD_FK1_1;

alter table RF_NRCTGRD
   drop primary key cascade;

drop table RF_NRCTGRD cascade constraints;

drop index RF_NTTR_FK1_2;

drop index RF_NTTR_FK1_1;

alter table RF_NTTR
   drop primary key cascade;

drop table RF_NTTR cascade constraints;

drop index RF_NTTR_STGPE_UN2_1;

drop index RF_NTTR_STGPE_FK1_1;

alter table RF_NTTR_STGPE
   drop primary key cascade;

drop table RF_NTTR_STGPE cascade constraints;

alter table RF_NUMOSIRIS
   drop primary key cascade;

drop table RF_NUMOSIRIS cascade constraints;

alter table RF_OACH
   drop unique (RF_OACH_ORG) cascade;

alter table RF_OACH
   drop primary key cascade;

drop table RF_OACH cascade constraints;

drop index RF_OBI_FK1_3;

drop index RF_OBI_FK1_2;

drop index RF_OBI_FK2_1;

alter table RF_OBI
   drop primary key cascade;

drop table RF_OBI cascade constraints;

drop index RF_OBI_NG_FK1_1;

drop index RF_OBI_NG_UN2_1;

drop index RF_OBI_NG_FK1_3;

drop index RF_OBI_NG_FK1_2;

alter table RF_OBI_NG
   drop primary key cascade;

drop table RF_OBI_NG cascade constraints;

drop index RF_OBJTXT_UN1_1;

alter table RF_OBJTXT
   drop primary key cascade;

drop table RF_OBJTXT cascade constraints;

drop index RF_OCC_UN1_1;

alter table RF_OCC
   drop primary key cascade;

drop table RF_OCC cascade constraints;

alter table RF_OPEPLIMAT
   drop primary key cascade;

drop table RF_OPEPLIMAT cascade constraints;

drop index RF_ORDRE_UN1_1;

alter table RF_ORDRE
   drop primary key cascade;

drop table RF_ORDRE cascade constraints;

drop index RF_ORDS_FK1_1;

drop index RF_ORDS_FK1_2;

alter table RF_ORDS
   drop primary key cascade;

drop table RF_ORDS cascade constraints;

drop index RF_ORDS_NG_UN4_1;

alter table RF_ORDS_NG
   drop primary key cascade;

drop table RF_ORDS_NG cascade constraints;

drop index RF_ORGANISME_UN2_1;

drop index RF_ORGANISME_FK1_3;

drop index RF_ORGANISME_FK1_2;

drop index RF_ORGANISME_FK1_1;

alter table RF_ORGANISME
   drop primary key cascade;

drop table RF_ORGANISME cascade constraints;

drop index RF_ORGANISMEARMEE_UN1_1;

drop index RF_ORGANISMEARMEE_FK1_2;

drop index RF_ORGANISMEARMEE_FK1_1;

alter table RF_ORGANISMEARMEE
   drop primary key cascade;

drop table RF_ORGANISMEARMEE cascade constraints;

drop index RF_ORGEN_FK1_7;

drop index RF_ORGEN_FK1_6;

drop index RF_ORGEN_FK2_5;

drop index RF_ORGEN_FK1_3;

drop index RF_ORGEN_FK1_2;

drop index RF_ORGEN_FK1_1;

drop index RF_ORGEN_FK1_4;

alter table RF_ORGEN
   drop primary key cascade;

drop table RF_ORGEN cascade constraints;

alter table RF_ORGRAT
   drop primary key cascade;

drop table RF_ORGRAT cascade constraints;

drop index RF_ORIDRO_FK1_1;

alter table RF_ORIDRO
   drop primary key cascade;

drop table RF_ORIDRO cascade constraints;

drop index RF_ORIGINE_UN1_1;

alter table RF_ORIGINE
   drop primary key cascade;

drop table RF_ORIGINE cascade constraints;

drop index RF_ORISNUP_UN1_1;

alter table RF_ORISNUP
   drop primary key cascade;

drop table RF_ORISNUP cascade constraints;

drop index RF_PARAG_FK1_1;

alter table RF_PARAG
   drop primary key cascade;

drop table RF_PARAG cascade constraints;

alter table RF_PAYS
   drop primary key cascade;

drop table RF_PAYS cascade constraints;

alter table RF_PAYS_NG
   drop unique (RF_PAYS_COUNTRY) cascade;

alter table RF_PAYS_NG
   drop primary key cascade;

drop table RF_PAYS_NG cascade constraints;

drop index RF_PHASE_UN1_1;

alter table RF_PHASE
   drop primary key cascade;

drop table RF_PHASE cascade constraints;

drop index RF_POSSTAT_FK1_1;

drop index RF_POSSTAT_UN2_1;

alter table RF_POSSTAT
   drop primary key cascade;

drop table RF_POSSTAT cascade constraints;

drop index RF_POSTPS_UN2_1;

drop index RF_POSTPS_FK1_2;

drop index RF_POSTPS_FK1_1;

alter table RF_POSTPS
   drop primary key cascade;

drop table RF_POSTPS cascade constraints;

drop index RF_PROD_FK1_2;

drop index RF_PROD_FK1_1;

alter table RF_PROD
   drop primary key cascade;

drop table RF_PROD cascade constraints;

alter table RF_PROG
   drop primary key cascade;

drop table RF_PROG cascade constraints;

alter table RF_PROJ
   drop unique (RF_PROJ_ANAMIN) cascade;

alter table RF_PROJ
   drop primary key cascade;

drop table RF_PROJ cascade constraints;

drop index RF_PROPRICPT_PK1_1;

drop index RF_PROPRICPT_FK1_1;

alter table RF_PROPRICPT
   drop primary key cascade;

drop table RF_PROPRICPT cascade constraints;

drop index RF_RATFIS_UN2_1;

drop index RF_RATFIS_FK1_1;

alter table RF_RATFIS
   drop primary key cascade;

drop table RF_RATFIS cascade constraints;

alter table RF_REFCAPA
   drop primary key cascade;

drop table RF_REFCAPA cascade constraints;

drop index RF_REG_UN2_1;

drop index RF_REG_FK1_1;

alter table RF_REG
   drop primary key cascade;

drop table RF_REG cascade constraints;

drop index RF_REGDPT_UN2_1;

drop index RF_REGDPT_FK1_1;

drop index RF_REGDPT_FK2_2;

alter table RF_REGDPT
   drop primary key cascade;

drop table RF_REGDPT cascade constraints;

drop index RF_REGECO_UN1_1;

alter table RF_REGECO
   drop primary key cascade;

drop table RF_REGECO cascade constraints;

drop index RF_REGION_FK1_1;

alter table RF_REGION
   drop unique (RF_REGION_COD, RF_PAYS_ID) cascade;

alter table RF_REGION
   drop primary key cascade;

drop table RF_REGION cascade constraints;

drop index RF_REGSTAT_UN1_1;

drop index RF_REGSTAT_FK1_1;

alter table RF_REGSTAT
   drop primary key cascade;

drop table RF_REGSTAT cascade constraints;

drop index RF_RTORG_FK1_2;

drop index RF_RTORG_FK1_1;

alter table RF_RTORG2
   drop primary key cascade;

drop table RF_RTORG2 cascade constraints;

drop index RF_SB_FK1_1;

drop index RF_SB_FK1_2;

alter table RF_SB
   drop primary key cascade;

drop table RF_SB cascade constraints;

alter table RF_SCTPAIE
   drop primary key cascade;

drop table RF_SCTPAIE cascade constraints;

drop index RF_SCTUTIL_UN2_1;

drop index RF_SCTUTIL_FK1_1;

alter table RF_SCTUTIL
   drop primary key cascade;

drop table RF_SCTUTIL cascade constraints;

drop index RF_SE_FK1_2;

drop index RF_SE_FK1_1;

alter table RF_SE
   drop primary key cascade;

drop table RF_SE cascade constraints;

alter table RF_SEEX
   drop unique (RF_SEEX_CO_AREA, RF_SEEX_COSTCENTER, RF_SEEX_DATETO) cascade;

alter table RF_SEEX
   drop primary key cascade;

drop table RF_SEEX cascade constraints;

drop index RF_SEGPAT_UN1_1;

alter table RF_SEGPAT
   drop primary key cascade;

drop table RF_SEGPAT cascade constraints;

drop index RF_SFCT_UN2_1;

drop index RF_SFCT_FK1_1;

alter table RF_SFCT
   drop primary key cascade;

drop table RF_SFCT cascade constraints;

drop index RF_SFCTCLAUTIL_FK1_1;

drop index RF_SFCTCLAUTIL_FK1_2;

drop index RF_SFCTCLAUTIL_PK1_1;

alter table RF_SFCTCLAUTIL
   drop primary key cascade;

drop table RF_SFCTCLAUTIL cascade constraints;

drop index RF_SFCTCPT_FK1_1;

drop index RF_SFCTCPT_PK1_1;

alter table RF_SFCTCPT
   drop primary key cascade;

drop table RF_SFCTCPT cascade constraints;

alter table RF_SGC
   drop primary key cascade;

drop table RF_SGC cascade constraints;

drop index RF_SITMAR_UN1_1;

alter table RF_SITMAR
   drop primary key cascade;

drop table RF_SITMAR cascade constraints;

drop index RF_SOBI_FK3_1;

drop index RF_SOBI_PK4_1;

alter table RF_SOBI
   drop primary key cascade;

drop table RF_SOBI cascade constraints;

drop index RF_STATRA_FK1_1;

drop index RF_STATRA_FK1_2;

alter table RF_STATRA
   drop primary key cascade;

drop table RF_STATRA cascade constraints;

drop index RF_STATUA_UN1_1;

alter table RF_STATUA
   drop primary key cascade;

drop table RF_STATUA cascade constraints;

drop index RF_STATUT_UN1_1;

drop index RF_STATUT_FK1_1;

alter table RF_STATUT
   drop primary key cascade;

drop table RF_STATUT cascade constraints;

alter table RF_STE_CHORUS
   drop primary key cascade;

drop table RF_STE_CHORUS cascade constraints;

drop index RF_STRC_FK1_3;

drop index RF_STRC_FK1_2;

drop index RF_STRC_FK1_1;

alter table RF_STRC
   drop primary key cascade;

drop table RF_STRC cascade constraints;

drop index RF_TACCES_UN1_1;

alter table RF_TACCES
   drop primary key cascade;

drop table RF_TACCES cascade constraints;

drop index RF_TACHAT_FK1_1;

alter table RF_TACHAT
   drop primary key cascade;

drop table RF_TACHAT cascade constraints;

drop index RF_TACHEFCT_UN1_1;

alter table RF_TACHEFCT
   drop primary key cascade;

drop table RF_TACHEFCT cascade constraints;

drop index RF_TACHENAT_UN1_1;

alter table RF_TACHENAT
   drop primary key cascade;

drop table RF_TACHENAT cascade constraints;

drop index RF_TAFF_UN1_1;

alter table RF_TAFF
   drop primary key cascade;

drop table RF_TAFF cascade constraints;

drop index RF_TAMO_UN1_1;

alter table RF_TAMO
   drop primary key cascade;

drop table RF_TAMO cascade constraints;

drop index RF_TBENECH_UN1_1;

alter table RF_TBENECH
   drop primary key cascade;

drop table RF_TBENECH cascade constraints;

drop index RF_TCOMPO_UN1_1;

alter table RF_TCOMPO
   drop primary key cascade;

drop table RF_TCOMPO cascade constraints;

drop index RF_TCONS_UN1_1;

alter table RF_TCONS
   drop primary key cascade;

drop table RF_TCONS cascade constraints;

drop index RF_TCPT_UN1_1;

alter table RF_TCPT
   drop primary key cascade;

drop table RF_TCPT cascade constraints;

drop index RF_TDEL_FK1_1;

alter table RF_TDEL
   drop primary key cascade;

drop table RF_TDEL cascade constraints;

alter table RF_TDOC
   drop primary key cascade;

drop table RF_TDOC cascade constraints;

drop index RF_TDOCTOPEDOM_UN2_1;

drop index RF_TDOCTOPEDOM_FK1_2;

drop index RF_TDOCTOPEDOM_FK1_1;

alter table RF_TDOCTOPEDOM
   drop primary key cascade;

drop table RF_TDOCTOPEDOM cascade constraints;

drop index RF_TDOM_UN1_1;

alter table RF_TDOM
   drop primary key cascade;

drop table RF_TDOM cascade constraints;

drop index RF_TDUREE_UN1_1;

alter table RF_TDUREE
   drop primary key cascade;

drop table RF_TDUREE cascade constraints;

alter table RF_TENGC
   drop primary key cascade;

drop table RF_TENGC cascade constraints;

alter table RF_TETAD
   drop primary key cascade;

drop table RF_TETAD cascade constraints;

alter table RF_TETAO
   drop primary key cascade;

drop table RF_TETAO cascade constraints;

drop index RF_TF_FK1_2;

drop index RF_TF_FK1_1;

alter table RF_TF
   drop primary key cascade;

drop table RF_TF cascade constraints;

alter table RF_TFICHIER
   drop primary key cascade;

drop table RF_TFICHIER cascade constraints;

drop index RF_TFON_FK1_1;

alter table RF_TFON
   drop unique (RF_TFON_AREA, RF_TFON_TRFONC, RF_TFON_DATETO) cascade;

alter table RF_TFON
   drop primary key cascade;

drop table RF_TFON cascade constraints;

alter table RF_TIMP
   drop unique (RF_TIMP_TIMP) cascade;

alter table RF_TIMP
   drop primary key cascade;

drop table RF_TIMP cascade constraints;

alter table RF_TIMPN
   drop primary key cascade;

drop table RF_TIMPN cascade constraints;

alter table RF_TINDIC
   drop primary key cascade;

drop table RF_TINDIC cascade constraints;

alter table RF_TINDMAJ
   drop primary key cascade;

drop table RF_TINDMAJ cascade constraints;

alter table RF_TINTF
   drop primary key cascade;

drop table RF_TINTF cascade constraints;

alter table RF_TINTV
   drop primary key cascade;

drop table RF_TINTV cascade constraints;

alter table RF_TITR
   drop primary key cascade;

drop table RF_TITR cascade constraints;

alter table RF_TLIG
   drop primary key cascade;

drop table RF_TLIG cascade constraints;

drop index RF_TLOC_UN1_1;

alter table RF_TLOC
   drop primary key cascade;

drop table RF_TLOC cascade constraints;

alter table RF_TMAJOPE
   drop primary key cascade;

drop table RF_TMAJOPE cascade constraints;

drop index RF_TMAN_FK1_1;

alter table RF_TMAN
   drop primary key cascade;

drop table RF_TMAN cascade constraints;

alter table RF_TMAR
   drop primary key cascade;

drop table RF_TMAR cascade constraints;

alter table RF_TMEMO
   drop primary key cascade;

drop table RF_TMEMO cascade constraints;

drop index RF_TMNT_UN1_1;

alter table RF_TMNT
   drop primary key cascade;

drop table RF_TMNT cascade constraints;

drop index RF_TMVT_FK1_3;

drop index RF_TMVT_FK1_1;

drop index RF_TMVT_FK1_2;

alter table RF_TMVT
   drop primary key cascade;

drop table RF_TMVT cascade constraints;

drop index RF_TNIV_UN1_1;

alter table RF_TNIV
   drop primary key cascade;

drop table RF_TNIV cascade constraints;

alter table RF_TOPE
   drop unique (RF_TOPE_TYPE) cascade;

alter table RF_TOPE
   drop primary key cascade;

drop table RF_TOPE cascade constraints;

drop index RF_TOPEDOM_UN1_1;

alter table RF_TOPEDOM
   drop primary key cascade;

drop table RF_TOPEDOM cascade constraints;

alter table RF_TOPLIQ
   drop primary key cascade;

drop table RF_TOPLIQ cascade constraints;

alter table RF_TOPV
   drop primary key cascade;

drop table RF_TOPV cascade constraints;

alter table RF_TORG
   drop primary key cascade;

drop table RF_TORG cascade constraints;

drop index RF_TOUV_FK1_2;

drop index RF_TOUV_UN2_1;

drop index RF_TOUV_FK1_1;

alter table RF_TOUV
   drop primary key cascade;

drop table RF_TOUV cascade constraints;

alter table RF_TPAIDIR
   drop primary key cascade;

drop table RF_TPAIDIR cascade constraints;

drop index RF_TPERS_UN1_1;

alter table RF_TPERS
   drop primary key cascade;

drop table RF_TPERS cascade constraints;

alter table RF_TPIE
   drop unique (RF_TPIE_TYPE) cascade;

alter table RF_TPIE
   drop primary key cascade;

drop table RF_TPIE cascade constraints;

drop index RF_TPOP_UN2_1;

drop index RF_TPOP_FK1_1;

alter table RF_TPOP
   drop primary key cascade;

drop table RF_TPOP cascade constraints;

drop index RF_TPOS_UN1_1;

alter table RF_TPOS
   drop primary key cascade;

drop table RF_TPOS cascade constraints;

drop index RF_TPRE_FK1_1;

alter table RF_TPRE
   drop primary key cascade;

drop table RF_TPRE cascade constraints;

drop index RF_TPRO_UN1_1;

alter table RF_TPRO
   drop primary key cascade;

drop table RF_TPRO cascade constraints;

drop index RF_TPROTECT_UN1_1;

alter table RF_TPROTECT
   drop primary key cascade;

drop table RF_TPROTECT cascade constraints;

drop index RF_TPSHIS_UN1_1;

alter table RF_TPSHIS
   drop primary key cascade;

drop table RF_TPSHIS cascade constraints;

drop index RF_TPSTRAV_FK1_1;

alter table RF_TPSTRAV
   drop primary key cascade;

drop table RF_TPSTRAV cascade constraints;

alter table RF_TPYR
   drop primary key cascade;

drop table RF_TPYR cascade constraints;

alter table RF_TRAN
   drop primary key cascade;

drop table RF_TRAN cascade constraints;

alter table RF_TREG
   drop primary key cascade;

drop table RF_TREG cascade constraints;

drop index RF_TSAUP_UN1_1;

alter table RF_TSAUP
   drop primary key cascade;

drop table RF_TSAUP cascade constraints;

drop index RF_TSAUPP_UN1_1;

alter table RF_TSAUPP
   drop primary key cascade;

drop table RF_TSAUPP cascade constraints;

drop index RF_TSNUP_UN1_1;

alter table RF_TSNUP
   drop primary key cascade;

drop table RF_TSNUP cascade constraints;

drop index RF_TSOULTE_UN1_1;

alter table RF_TSOULTE
   drop primary key cascade;

drop table RF_TSOULTE cascade constraints;

alter table RF_TSTAT
   drop primary key cascade;

drop table RF_TSTAT cascade constraints;

alter table RF_TSUB
   drop primary key cascade;

drop table RF_TSUB cascade constraints;

drop index RF_TSUP_UN1_1;

alter table RF_TSUP
   drop primary key cascade;

drop table RF_TSUP cascade constraints;

drop index RF_TTACHE_UN2_1;

alter table RF_TTACHE
   drop primary key cascade;

drop table RF_TTACHE cascade constraints;

alter table RF_TTF
   drop primary key cascade;

drop table RF_TTF cascade constraints;

alter table RF_TTIE
   drop unique (RF_TTIE_TYPE) cascade;

alter table RF_TTIE
   drop primary key cascade;

drop table RF_TTIE cascade constraints;

alter table RF_TTRAN
   drop primary key cascade;

drop table RF_TTRAN cascade constraints;

drop index RF_TVA_FK1_1;

alter table RF_TVA
   drop primary key cascade;

drop table RF_TVA cascade constraints;

drop index RF_TVA_NG_FK1_1;

alter table RF_TVA_NG
   drop unique (RF_TVA_ETAXCODE, RF_TVA_ERLTYPCND, RF_PAYS_ID) cascade;

alter table RF_TVA_NG
   drop primary key cascade;

drop table RF_TVA_NG cascade constraints;

alter table RF_TYPOLOINFRA
   drop primary key cascade;

drop table RF_TYPOLOINFRA cascade constraints;

alter table RF_UFONC
   drop primary key cascade;

drop table RF_UFONC cascade constraints;

drop index RF_UO_FK1_3;

drop index RF_UO_FK1_5;

drop index RF_UO_FK1_4;

alter table RF_UO
   drop primary key cascade;

drop table RF_UO cascade constraints;

drop index RF_UTILCL_UN2_1;

alter table RF_UTILCL
   drop primary key cascade;

drop table RF_UTILCL cascade constraints;

alter table RF_ZD
   drop primary key cascade;

drop table RF_ZD cascade constraints;

drop index RF_ZFCT_UN1_1;

alter table RF_ZFCT
   drop primary key cascade;

drop table RF_ZFCT cascade constraints;

alter table RF_ZONE
   drop primary key cascade;

drop table RF_ZONE cascade constraints;

drop index RF_ZONGRD_FK1_2;

drop index RF_ZONGRD_FK1_1;

drop index RF_ZONGRD_PK2_1;

alter table RF_ZONGRD
   drop primary key cascade;

drop table RF_ZONGRD cascade constraints;

drop index RF_ZONSIT_UN1_1;

alter table RF_ZONSIT
   drop primary key cascade;

drop table RF_ZONSIT cascade constraints;
...
grant REFERENCES on RF_ACTI to IC_ETOILE;

grant REFERENCES on RF_ACTI to IC_FINAL;

grant SELECT on RF_ACTI to REF_SEL_A_UTI;
...
grant REFERENCES on RF_ACTIVITE to IC_ETOILE;

grant REFERENCES on RF_ACTIVITE to IC_FINAL;

grant SELECT on RF_ACTIVITE to REF_SEL_A_UTI;
...
grant REFERENCES on RF_ACVT to IC_ETOILE;

grant REFERENCES on RF_ACVT to IC_FINAL;
...
grant REFERENCES on RF_AFFAERO to IC_ETOILE;

grant REFERENCES on RF_AFFAERO to IC_FINAL;
...
grant REFERENCES on RF_AFFECT to IC_ETOILE;

grant REFERENCES on RF_AFFECT to IC_FINAL;
...
grant REFERENCES on RF_AFFSJCT to IC_ETOILE;

grant REFERENCES on RF_AFFSJCT to IC_FINAL;
...
grant REFERENCES on RF_ANGE to IC_ETOILE;

grant REFERENCES on RF_ANGE to IC_FINAL;
...
grant REFERENCES on RF_APE to IC_ETOILE;

grant REFERENCES on RF_APE to IC_FINAL;
...
grant REFERENCES on RF_ARE to IC_ETOILE;

grant REFERENCES on RF_ARE to IC_FINAL;
...
grant REFERENCES on RF_ARME to IC_ETOILE;

grant REFERENCES on RF_ARME to IC_FINAL;
...
grant REFERENCES on RF_ARMEE to IC_ETOILE;

grant REFERENCES on RF_ARMEE to IC_FINAL;
...
grant REFERENCES on RF_AVANC to IC_ETOILE;

grant REFERENCES on RF_AVANC to IC_FINAL;
...
grant REFERENCES on RF_AXE1 to IC_ETOILE;

grant REFERENCES on RF_AXE1 to IC_FINAL;
...
grant REFERENCES on RF_BASE to IC_ETOILE;

grant REFERENCES on RF_BASE to IC_FINAL;
...
grant REFERENCES on RF_BDD to IC_ETOILE;

grant REFERENCES on RF_BDD to IC_FINAL;
...
grant REFERENCES on RF_BENAMO to IC_ETOILE;

grant REFERENCES on RF_BENAMO to IC_FINAL;
...
grant REFERENCES on RF_BOP to IC_ETOILE;

grant REFERENCES on RF_BOP to IC_FINAL;
...
grant REFERENCES on RF_BOP_CH to IC_ETOILE;

grant REFERENCES on RF_BOP_CH to IC_FINAL;
...
grant REFERENCES on RF_CA to IC_ETOILE;

grant REFERENCES on RF_CA to IC_FINAL;
...
grant REFERENCES on RF_CAL to IC_ETOILE;

grant REFERENCES on RF_CAL to IC_FINAL;
...
grant REFERENCES on RF_CATDEP to IC_ETOILE;

grant REFERENCES on RF_CATDEP to IC_FINAL;
...
grant REFERENCES on RF_CATORIDRO to IC_ETOILE;

grant REFERENCES on RF_CATORIDRO to IC_FINAL;
...
grant REFERENCES on RF_CBUD to IC_ETOILE;

grant REFERENCES on RF_CBUD to IC_FINAL;
...
grant REFERENCES on RF_CCOU to IC_ETOILE;

grant REFERENCES on RF_CCOU to IC_FINAL;
...
grant REFERENCES on RF_CDMB to IC_ETOILE;

grant REFERENCES on RF_CDMB to IC_FINAL;
...
grant REFERENCES on RF_CDSTAT to IC_ETOILE;

grant REFERENCES on RF_CDSTAT to IC_FINAL;
...
grant REFERENCES on RF_CFIN to IC_ETOILE;

grant REFERENCES on RF_CFIN to IC_FINAL;
...
grant REFERENCES on RF_CIMO to IC_ETOILE;

grant REFERENCES on RF_CIMO to IC_FINAL;
...
grant REFERENCES on RF_CLAUTIL to IC_ETOILE;

grant REFERENCES on RF_CLAUTIL to IC_FINAL;
...
grant REFERENCES on RF_CMD to IC_ETOILE;

grant REFERENCES on RF_CMD to IC_FINAL;
...
grant REFERENCES on RF_CNOP to IC_ETOILE;

grant REFERENCES on RF_CNOP to IC_FINAL;
...
grant REFERENCES on RF_CODMIN to IC_ETOILE;

grant REFERENCES on RF_CODMIN to IC_FINAL;
...
grant REFERENCES on RF_CODNIV to IC_ETOILE;

grant REFERENCES on RF_CODNIV to IC_FINAL;
...
grant REFERENCES on RF_COEFFENT to IC_ETOILE;

grant REFERENCES on RF_COEFFENT to IC_FINAL;
...
grant REFERENCES on RF_COMIMP to IC_ETOILE;

grant REFERENCES on RF_COMIMP to IC_FINAL;
...
grant REFERENCES on RF_COMM to IC_ETOILE;

grant REFERENCES on RF_COMM to IC_FINAL;
...
grant REFERENCES on RF_COMMCP to IC_ETOILE;

grant REFERENCES on RF_COMMCP to IC_FINAL;
...
grant REFERENCES on RF_CORGRD to IC_ETOILE;

grant REFERENCES on RF_CORGRD to IC_FINAL;
...
grant REFERENCES on RF_CORPS to IC_ETOILE;

grant REFERENCES on RF_CORPS to IC_FINAL;
...
grant REFERENCES on RF_CP to IC_ETOILE;

grant REFERENCES on RF_CP to IC_FINAL;
...
grant REFERENCES on RF_CPCE to IC_ETOILE;

grant REFERENCES on RF_CPCE to IC_FINAL;
...
grant REFERENCES on RF_CPCE_NG to IC_ETOILE;

grant REFERENCES on RF_CPCE_NG to IC_FINAL;
...
grant REFERENCES on RF_CPER to IC_ETOILE;

grant REFERENCES on RF_CPER to IC_FINAL;
...
grant REFERENCES on RF_CPFT to IC_ETOILE;

grant REFERENCES on RF_CPFT to IC_FINAL;
...
grant REFERENCES on RF_CPMTD to IC_ETOILE;

grant REFERENCES on RF_CPMTD to IC_FINAL;
...
grant REFERENCES on RF_CPT to IC_ETOILE;

grant REFERENCES on RF_CPT to IC_FINAL;
...
grant REFERENCES on RF_CPTCLAUTIL to IC_ETOILE;

grant REFERENCES on RF_CPTCLAUTIL to IC_FINAL;
...
grant REFERENCES on RF_CPTCOM to IC_ETOILE;

grant REFERENCES on RF_CPTCOM to IC_FINAL;
...
grant REFERENCES on RF_CPTIND to IC_ETOILE;

grant REFERENCES on RF_CPTIND to IC_FINAL;
...
grant REFERENCES on RF_CPYR to IC_ETOILE;

grant REFERENCES on RF_CPYR to IC_FINAL;
...
grant REFERENCES on RF_CTACHAT to IC_ETOILE;

grant REFERENCES on RF_CTACHAT to IC_FINAL;
...
grant REFERENCES on RF_CTBOP to IC_ETOILE;

grant REFERENCES on RF_CTBOP to IC_FINAL;
...
grant REFERENCES on RF_CTENG to IC_ETOILE;

grant REFERENCES on RF_CTENG to IC_FINAL;
...
grant REFERENCES on RF_CTGRD to IC_ETOILE;

grant REFERENCES on RF_CTGRD to IC_FINAL;
...
grant REFERENCES on RF_CTLOP to IC_ETOILE;

grant REFERENCES on RF_CTLOP to IC_FINAL;
...
grant REFERENCES on RF_CTOB to IC_ETOILE;

grant REFERENCES on RF_CTOB to IC_FINAL;
...
grant REFERENCES on RF_CTSTORCOR to IC_ETOILE;

grant REFERENCES on RF_CTSTORCOR to IC_FINAL;
...
grant REFERENCES on RF_CTUTIL to IC_ETOILE;

grant REFERENCES on RF_CTUTIL to IC_FINAL;
...
grant REFERENCES on RF_DACT to IC_ETOILE;

grant REFERENCES on RF_DACT to IC_FINAL;
...
grant REFERENCES on RF_DEPT to IC_ETOILE;

grant REFERENCES on RF_DEPT to IC_FINAL;
...
grant REFERENCES on RF_DEVI to IC_ETOILE;

grant REFERENCES on RF_DEVI to IC_FINAL;
...
grant REFERENCES on RF_DEVI_NG to IC_ETOILE;

grant REFERENCES on RF_DEVI_NG to IC_FINAL;
...
grant REFERENCES on RF_DEVPAY to IC_ETOILE;

grant REFERENCES on RF_DEVPAY to IC_FINAL;
...
grant REFERENCES on RF_DFON to IC_ETOILE;

grant REFERENCES on RF_DFON to IC_FINAL;
...
grant REFERENCES on RF_DIPHDEF to IC_ETOILE;

grant REFERENCES on RF_DIPHDEF to IC_FINAL;
...
grant REFERENCES on RF_DIPTTA to IC_ETOILE;

grant REFERENCES on RF_DIPTTA to IC_FINAL;
...
grant REFERENCES,SELECT on RF_DIVI to IC_ETOILE;

grant REFERENCES,SELECT on RF_DIVI to IC_FINAL;
...
grant REFERENCES on RF_DOM to IC_ETOILE;

grant REFERENCES on RF_DOM to IC_FINAL;
...
grant REFERENCES on RF_DOMFONC to IC_ETOILE;

grant REFERENCES on RF_DOMFONC to IC_FINAL;
...
grant REFERENCES on RF_DOMTTA to IC_ETOILE;

grant REFERENCES on RF_DOMTTA to IC_FINAL;
...
grant REFERENCES on RF_DPSA to IC_ETOILE;

grant REFERENCES on RF_DPSA to IC_FINAL;
...
grant REFERENCES on RF_ECHELON to IC_ETOILE;

grant REFERENCES on RF_ECHELON to IC_FINAL;
...
grant REFERENCES on RF_ENGCENGJ to IC_ETOILE;

grant REFERENCES on RF_ENGCENGJ to IC_FINAL;
...
grant REFERENCES on RF_EOTP to IC_ETOILE;

grant REFERENCES on RF_EOTP to IC_FINAL;
...
grant REFERENCES on RF_ETAN to IC_ETOILE;

grant REFERENCES on RF_ETAN to IC_FINAL;
...
grant REFERENCES on RF_ETATENT to IC_ETOILE;

grant REFERENCES on RF_ETATENT to IC_FINAL;
...
grant REFERENCES on RF_ETATOPE to IC_ETOILE;

grant REFERENCES on RF_ETATOPE to IC_FINAL;
...
grant REFERENCES on RF_FCTCPT to IC_ETOILE;

grant REFERENCES on RF_FCTCPT to IC_FINAL;
...
grant REFERENCES on RF_FCTN to IC_ETOILE;

grant REFERENCES on RF_FCTN to IC_FINAL;
...
grant REFERENCES on RF_FCTRPR to IC_ETOILE;

grant REFERENCES on RF_FCTRPR to IC_FINAL;
...
grant REFERENCES on RF_FCTSITE to IC_ETOILE;

grant REFERENCES on RF_FCTSITE to IC_FINAL;
...
grant REFERENCES on RF_FCTTTA to IC_ETOILE;

grant REFERENCES on RF_FCTTTA to IC_FINAL;
...
grant REFERENCES on RF_FIMO to IC_ETOILE;

grant REFERENCES on RF_FIMO to IC_FINAL;
...
grant REFERENCES on RF_FJE to IC_ETOILE;

grant REFERENCES on RF_FJE to IC_FINAL;
...
grant REFERENCES on RF_FOND to IC_ETOILE;

grant REFERENCES on RF_FOND to IC_FINAL;
...
grant REFERENCES on RF_FORM to IC_ETOILE;

grant REFERENCES on RF_FORM to IC_FINAL;
...
grant REFERENCES on RF_FORMPRI to IC_ETOILE;

grant REFERENCES on RF_FORMPRI to IC_FINAL;
...
grant REFERENCES on RF_GACH to IC_ETOILE;

grant REFERENCES on RF_GACH to IC_FINAL;
...
grant REFERENCES on RF_GCC to IC_ETOILE;

grant REFERENCES on RF_GCC to IC_FINAL;
...
grant REFERENCES on RF_GCC_NG to IC_ETOILE;

grant REFERENCES on RF_GCC_NG to IC_FINAL;
...
grant REFERENCES on RF_GCD to IC_ETOILE;

grant REFERENCES on RF_GCD to IC_FINAL;
...
grant REFERENCES on RF_GES to IC_ETOILE;

grant REFERENCES on RF_GES to IC_FINAL;
...
grant REFERENCES on RF_GMDS to IC_ETOILE;

grant REFERENCES on RF_GMDS to IC_FINAL;
...
grant REFERENCES on RF_GRD to IC_ETOILE;

grant REFERENCES on RF_GRD to IC_FINAL;
...
grant REFERENCES on RF_GRDCMP to IC_ETOILE;

grant REFERENCES on RF_GRDCMP to IC_FINAL;
...
grant REFERENCES on RF_GRDECH to IC_ETOILE;

grant REFERENCES on RF_GRDECH to IC_FINAL;
...
grant REFERENCES on RF_GRIM to IC_ETOILE;

grant REFERENCES on RF_GRIM to IC_FINAL;
...
grant REFERENCES on RF_HOMOLDIP to IC_ETOILE;

grant REFERENCES on RF_HOMOLDIP to IC_FINAL;
...
grant REFERENCES on RF_IMM to IC_ETOILE;

grant REFERENCES on RF_IMM to IC_FINAL;
...
grant REFERENCES on RF_IMMCLAUTIL to IC_ETOILE;

grant REFERENCES on RF_IMMCLAUTIL to IC_FINAL;
...
grant REFERENCES on RF_IMMEUBLE to IC_ETOILE;

grant REFERENCES on RF_IMMEUBLE to IC_FINAL;
...
grant REFERENCES on RF_IMMIND to IC_ETOILE;

grant REFERENCES on RF_IMMIND to IC_FINAL;
...
grant REFERENCES on RF_IMPE to IC_ETOILE;

grant REFERENCES on RF_IMPE to IC_FINAL;
...
grant REFERENCES on RF_IMPE_NG to IC_ETOILE;

grant REFERENCES on RF_IMPE_NG to IC_FINAL;
...
grant REFERENCES on RF_IMPG to IC_ETOILE;

grant REFERENCES on RF_IMPG to IC_FINAL;
...
grant REFERENCES on RF_IMPG_NG to IC_ETOILE;

grant REFERENCES on RF_IMPG_NG to IC_FINAL;
...
grant REFERENCES on RF_INDM to IC_ETOILE;

grant REFERENCES on RF_INDM to IC_FINAL;
...
grant REFERENCES on RF_LCLCATUTIL to IC_ETOILE;

grant REFERENCES on RF_LCLCATUTIL to IC_FINAL;
...
grant REFERENCES on RF_LCLCLAUTIL to IC_ETOILE;

grant REFERENCES on RF_LCLCLAUTIL to IC_FINAL;
...
grant REFERENCES on RF_LIGMER to IC_ETOILE;

grant REFERENCES on RF_LIGMER to IC_FINAL;
...
grant REFERENCES on RF_LOCI to IC_ETOILE;

grant REFERENCES on RF_LOCI to IC_FINAL;
...
grant REFERENCES on RF_LOCM to IC_ETOILE;

grant REFERENCES on RF_LOCM to IC_FINAL;
...
grant REFERENCES on RF_MACCES to IC_ETOILE;

grant REFERENCES on RF_MACCES to IC_FINAL;
...
grant REFERENCES on RF_MACCOR to IC_ETOILE;

grant REFERENCES on RF_MACCOR to IC_FINAL;
...
grant REFERENCES on RF_MACGRD to IC_ETOILE;

grant REFERENCES on RF_MACGRD to IC_FINAL;
...
grant REFERENCES on RF_MAJ to IC_ETOILE;

grant REFERENCES on RF_MAJ to IC_FINAL;
...
grant REFERENCES on RF_MDRG to IC_ETOILE;

grant REFERENCES on RF_MDRG to IC_FINAL;
...
grant REFERENCES on RF_MDVI to IC_ETOILE;

grant REFERENCES on RF_MDVI to IC_FINAL;
...
grant REFERENCES on RF_MINAFF to IC_ETOILE;

grant REFERENCES on RF_MINAFF to IC_FINAL;
...
grant REFERENCES on RF_MOA to IC_ETOILE;

grant REFERENCES on RF_MOA to IC_FINAL;
...
grant REFERENCES on RF_MPMT to IC_ETOILE;

grant REFERENCES on RF_MPMT to IC_FINAL;
...
grant REFERENCES on RF_MSORT to IC_ETOILE;

grant REFERENCES on RF_MSORT to IC_FINAL;
...
grant REFERENCES on RF_MVTMVT to IC_ETOILE;

grant REFERENCES on RF_MVTMVT to IC_FINAL;
...
grant REFERENCES on RF_NAT to IC_ETOILE;

grant REFERENCES on RF_NAT to IC_FINAL;
...
grant REFERENCES on RF_NATD to IC_ETOILE;

grant REFERENCES on RF_NATD to IC_FINAL;
...
grant REFERENCES on RF_NATDECPRO to IC_ETOILE;

grant REFERENCES on RF_NATDECPRO to IC_FINAL;
...
grant REFERENCES on RF_NATDEP to IC_ETOILE;

grant REFERENCES on RF_NATDEP to IC_FINAL;
...
grant REFERENCES on RF_NATDRO to IC_ETOILE;

grant REFERENCES on RF_NATDRO to IC_FINAL;
...
grant REFERENCES on RF_NATIMM to IC_ETOILE;

grant REFERENCES on RF_NATIMM to IC_FINAL;
...
grant REFERENCES on RF_NATTXT to IC_ETOILE;

grant REFERENCES on RF_NATTXT to IC_FINAL;
...
grant REFERENCES on RF_NATVOI to IC_ETOILE;

grant REFERENCES on RF_NATVOI to IC_FINAL;
...
grant REFERENCES on RF_NBI to IC_ETOILE;

grant REFERENCES on RF_NBI to IC_FINAL;
...
grant REFERENCES on RF_NIVRESP to IC_ETOILE;

grant REFERENCES on RF_NIVRESP to IC_FINAL;
...
grant REFERENCES on RF_NIVSUPP to IC_ETOILE;

grant REFERENCES on RF_NIVSUPP to IC_FINAL;
...
grant REFERENCES on RF_NOMENCPROD to IC_ETOILE;

grant REFERENCES on RF_NOMENCPROD to IC_FINAL;
...
grant REFERENCES on RF_NRCTGRD to IC_ETOILE;

grant REFERENCES on RF_NRCTGRD to IC_FINAL;
...
grant REFERENCES on RF_NTTR to IC_ETOILE;

grant REFERENCES on RF_NTTR to IC_FINAL;
...
grant REFERENCES on RF_NTTR_STGPE to IC_ETOILE;

grant REFERENCES on RF_NTTR_STGPE to IC_FINAL;
...
grant REFERENCES on RF_OACH to IC_ETOILE;

grant REFERENCES on RF_OACH to IC_FINAL;
...
grant REFERENCES on RF_OBI to IC_ETOILE;

grant REFERENCES on RF_OBI to IC_FINAL;
...
grant REFERENCES on RF_OBI_NG to IC_ETOILE;

grant REFERENCES on RF_OBI_NG to IC_FINAL;
...
grant REFERENCES on RF_OBJTXT to IC_ETOILE;

grant REFERENCES on RF_OBJTXT to IC_FINAL;
...
grant REFERENCES on RF_OCC to IC_ETOILE;

grant REFERENCES on RF_OCC to IC_FINAL;
...
grant REFERENCES on RF_ORDRE to IC_ETOILE;

grant REFERENCES on RF_ORDRE to IC_FINAL;
...
grant REFERENCES on RF_ORDS to IC_ETOILE;

grant REFERENCES on RF_ORDS to IC_FINAL;
...
grant REFERENCES on RF_ORDS_NG to IC_ETOILE;

grant REFERENCES on RF_ORDS_NG to IC_FINAL;
...
grant REFERENCES on RF_ORGANISME to IC_ETOILE;

grant REFERENCES on RF_ORGANISME to IC_FINAL;
...
grant REFERENCES on RF_ORGANISMEARMEE to IC_ETOILE;

grant REFERENCES on RF_ORGANISMEARMEE to IC_FINAL;
...
grant REFERENCES on RF_ORGEN to IC_ETOILE;

grant REFERENCES on RF_ORGEN to IC_FINAL;
...
grant REFERENCES on RF_ORGRAT to IC_ETOILE;

grant REFERENCES on RF_ORGRAT to IC_FINAL;
...
grant REFERENCES on RF_ORIDRO to IC_ETOILE;

grant REFERENCES on RF_ORIDRO to IC_FINAL;
...
grant REFERENCES on RF_ORIGINE to IC_ETOILE;

grant REFERENCES on RF_ORIGINE to IC_FINAL;
...
grant REFERENCES on RF_ORISNUP to IC_ETOILE;

grant REFERENCES on RF_ORISNUP to IC_FINAL;
...
grant REFERENCES on RF_PARAG to IC_ETOILE;

grant REFERENCES on RF_PARAG to IC_FINAL;
...
grant REFERENCES on RF_PAYS to IC_ETOILE;

grant REFERENCES on RF_PAYS to IC_FINAL;
...
grant REFERENCES on RF_PAYS_NG to IC_ETOILE;

grant REFERENCES on RF_PAYS_NG to IC_FINAL;
...
grant REFERENCES on RF_PHASE to IC_ETOILE;

grant REFERENCES on RF_PHASE to IC_FINAL;
...
grant REFERENCES on RF_POSSTAT to IC_ETOILE;

grant REFERENCES on RF_POSSTAT to IC_FINAL;
...
grant REFERENCES on RF_POSTPS to IC_ETOILE;

grant REFERENCES on RF_POSTPS to IC_FINAL;
...
grant REFERENCES on RF_PROD to IC_ETOILE;

grant REFERENCES on RF_PROD to IC_FINAL;
...
grant REFERENCES on RF_PROG to IC_ETOILE;

grant REFERENCES on RF_PROG to IC_FINAL;
...
grant REFERENCES on RF_PROJ to IC_ETOILE;

grant REFERENCES on RF_PROJ to IC_FINAL;
...
grant REFERENCES on RF_PROPRICPT to IC_ETOILE;

grant REFERENCES on RF_PROPRICPT to IC_FINAL;
...
grant REFERENCES on RF_RATFIS to IC_ETOILE;

grant REFERENCES on RF_RATFIS to IC_FINAL;
...
grant REFERENCES on RF_REG to IC_ETOILE;

grant REFERENCES on RF_REG to IC_FINAL;
...
grant REFERENCES on RF_REGDPT to IC_ETOILE;

grant REFERENCES on RF_REGDPT to IC_FINAL;
...
grant REFERENCES on RF_REGECO to IC_ETOILE;

grant REFERENCES on RF_REGECO to IC_FINAL;
...
grant REFERENCES on RF_REGION to IC_ETOILE;

grant REFERENCES on RF_REGION to IC_FINAL;
...
grant REFERENCES on RF_REGSTAT to IC_ETOILE;

grant REFERENCES on RF_REGSTAT to IC_FINAL;
...
grant REFERENCES on RF_RTORG2 to IC_ETOILE;

grant REFERENCES on RF_RTORG2 to IC_FINAL;
...
grant REFERENCES on RF_SB to IC_ETOILE;

grant REFERENCES on RF_SB to IC_FINAL;
...
grant REFERENCES on RF_SCTPAIE to IC_ETOILE;

grant REFERENCES on RF_SCTPAIE to IC_FINAL;
...
grant REFERENCES on RF_SCTUTIL to IC_ETOILE;

grant REFERENCES on RF_SCTUTIL to IC_FINAL;
...
grant REFERENCES on RF_SE to IC_ETOILE;

grant REFERENCES on RF_SE to IC_FINAL;
...
grant REFERENCES on RF_SEEX to IC_ETOILE;

grant REFERENCES on RF_SEEX to IC_FINAL;
...
grant REFERENCES on RF_SEGPAT to IC_ETOILE;

grant REFERENCES on RF_SEGPAT to IC_FINAL;
...
grant REFERENCES on RF_SFCT to IC_ETOILE;

grant REFERENCES on RF_SFCT to IC_FINAL;
...
grant REFERENCES on RF_SFCTCLAUTIL to IC_ETOILE;

grant REFERENCES on RF_SFCTCLAUTIL to IC_FINAL;
...
grant REFERENCES on RF_SFCTCPT to IC_ETOILE;

grant REFERENCES on RF_SFCTCPT to IC_FINAL;
...
grant REFERENCES on RF_SGC to IC_ETOILE;

grant REFERENCES on RF_SGC to IC_FINAL;
...
grant REFERENCES on RF_SITMAR to IC_ETOILE;

grant REFERENCES on RF_SITMAR to IC_FINAL;
...
grant REFERENCES on RF_SOBI to IC_ETOILE;

grant REFERENCES on RF_SOBI to IC_FINAL;
...
grant REFERENCES on RF_STATRA to IC_ETOILE;

grant REFERENCES on RF_STATRA to IC_FINAL;
...
grant REFERENCES on RF_STATUA to IC_ETOILE;

grant REFERENCES on RF_STATUA to IC_FINAL;
...
grant REFERENCES on RF_STATUT to IC_ETOILE;

grant REFERENCES on RF_STATUT to IC_FINAL;
...
grant REFERENCES on RF_STE_CHORUS to IC_ETOILE;

grant REFERENCES on RF_STE_CHORUS to IC_FINAL;
...
grant REFERENCES on RF_STRC to IC_ETOILE;

grant REFERENCES on RF_STRC to IC_FINAL;
...
grant REFERENCES on RF_TACCES to IC_ETOILE;

grant REFERENCES on RF_TACCES to IC_FINAL;
...
grant REFERENCES on RF_TACHAT to IC_ETOILE;

grant REFERENCES on RF_TACHAT to IC_FINAL;
...
grant REFERENCES on RF_TACHEFCT to IC_ETOILE;

grant REFERENCES on RF_TACHEFCT to IC_FINAL;
...
grant REFERENCES on RF_TACHENAT to IC_ETOILE;

grant REFERENCES on RF_TACHENAT to IC_FINAL;
...
grant REFERENCES on RF_TAFF to IC_ETOILE;

grant REFERENCES on RF_TAFF to IC_FINAL;
...
grant REFERENCES on RF_TAMO to IC_ETOILE;

grant REFERENCES on RF_TAMO to IC_FINAL;
...
grant REFERENCES on RF_TBENECH to IC_ETOILE;

grant REFERENCES on RF_TBENECH to IC_FINAL;
...
grant REFERENCES on RF_TCOMPO to IC_ETOILE;

grant REFERENCES on RF_TCOMPO to IC_FINAL;
...
grant REFERENCES on RF_TCONS to IC_ETOILE;

grant REFERENCES on RF_TCONS to IC_FINAL;
...
grant REFERENCES on RF_TCPT to IC_ETOILE;

grant REFERENCES on RF_TCPT to IC_FINAL;
...
grant REFERENCES on RF_TDEL to IC_ETOILE;

grant REFERENCES on RF_TDEL to IC_FINAL;
...
grant REFERENCES on RF_TDOC to IC_ETOILE;

grant REFERENCES on RF_TDOC to IC_FINAL;
...
grant REFERENCES on RF_TDOCTOPEDOM to IC_ETOILE;

grant REFERENCES on RF_TDOCTOPEDOM to IC_FINAL;
...
grant REFERENCES on RF_TDOM to IC_ETOILE;

grant REFERENCES on RF_TDOM to IC_FINAL;
...
grant REFERENCES on RF_TDUREE to IC_ETOILE;

grant REFERENCES on RF_TDUREE to IC_FINAL;
...
grant REFERENCES on RF_TENGC to IC_ETOILE;

grant REFERENCES on RF_TENGC to IC_FINAL;
...
grant REFERENCES on RF_TETAD to IC_ETOILE;

grant REFERENCES on RF_TETAD to IC_FINAL;
...
grant REFERENCES on RF_TETAO to IC_ETOILE;

grant REFERENCES on RF_TETAO to IC_FINAL;
...
grant REFERENCES on RF_TF to IC_ETOILE;

grant REFERENCES on RF_TF to IC_FINAL;
...
grant REFERENCES on RF_TFICHIER to IC_ETOILE;

grant REFERENCES on RF_TFICHIER to IC_FINAL;
...
grant REFERENCES on RF_TFON to IC_ETOILE;

grant REFERENCES on RF_TFON to IC_FINAL;
...
grant REFERENCES on RF_TIMP to IC_ETOILE;

grant REFERENCES on RF_TIMP to IC_FINAL;
...
grant REFERENCES on RF_TIMPN to IC_ETOILE;

grant REFERENCES on RF_TIMPN to IC_FINAL;
...
grant REFERENCES on RF_TINDIC to IC_ETOILE;

grant REFERENCES on RF_TINDIC to IC_FINAL;
...
grant REFERENCES on RF_TINDMAJ to IC_ETOILE;

grant REFERENCES on RF_TINDMAJ to IC_FINAL;
...
grant REFERENCES on RF_TINTF to IC_ETOILE;

grant REFERENCES on RF_TINTF to IC_FINAL;
...
grant REFERENCES on RF_TINTV to IC_ETOILE;

grant REFERENCES on RF_TINTV to IC_FINAL;
...
grant REFERENCES on RF_TITR to IC_ETOILE;

grant REFERENCES on RF_TITR to IC_FINAL;
...
grant REFERENCES on RF_TLIG to IC_ETOILE;

grant REFERENCES on RF_TLIG to IC_FINAL;
...
grant REFERENCES on RF_TLOC to IC_ETOILE;

grant REFERENCES on RF_TLOC to IC_FINAL;
...
grant REFERENCES on RF_TMAJOPE to IC_ETOILE;

grant REFERENCES on RF_TMAJOPE to IC_FINAL;
...
grant REFERENCES on RF_TMAN to IC_ETOILE;

grant REFERENCES on RF_TMAN to IC_FINAL;
...
grant REFERENCES on RF_TMAR to IC_ETOILE;

grant REFERENCES on RF_TMAR to IC_FINAL;
...
grant REFERENCES on RF_TMEMO to IC_ETOILE;

grant REFERENCES on RF_TMEMO to IC_FINAL;
...
grant REFERENCES on RF_TMNT to IC_ETOILE;

grant REFERENCES on RF_TMNT to IC_FINAL;
...
grant REFERENCES on RF_TMVT to IC_ETOILE;

grant REFERENCES on RF_TMVT to IC_FINAL;
...
grant REFERENCES on RF_TNIV to IC_ETOILE;

grant REFERENCES on RF_TNIV to IC_FINAL;
...
grant REFERENCES on RF_TOPE to IC_ETOILE;

grant REFERENCES on RF_TOPE to IC_FINAL;
...
grant REFERENCES on RF_TOPEDOM to IC_ETOILE;

grant REFERENCES on RF_TOPEDOM to IC_FINAL;
...
grant REFERENCES on RF_TOPLIQ to IC_ETOILE;

grant REFERENCES on RF_TOPLIQ to IC_FINAL;
...
grant REFERENCES on RF_TOPV to IC_ETOILE;

grant REFERENCES on RF_TOPV to IC_FINAL;
...
grant REFERENCES on RF_TORG to IC_ETOILE;

grant REFERENCES on RF_TORG to IC_FINAL;
...
grant REFERENCES on RF_TOUV to IC_ETOILE;

grant REFERENCES on RF_TOUV to IC_FINAL;
...
grant REFERENCES on RF_TPAIDIR to IC_ETOILE;

grant REFERENCES on RF_TPAIDIR to IC_FINAL;
...
grant REFERENCES on RF_TPERS to IC_ETOILE;

grant REFERENCES on RF_TPERS to IC_FINAL;
...
grant REFERENCES on RF_TPIE to IC_ETOILE;

grant REFERENCES on RF_TPIE to IC_FINAL;
...
grant REFERENCES on RF_TPOP to IC_ETOILE;

grant REFERENCES on RF_TPOP to IC_FINAL;
...
grant REFERENCES on RF_TPOS to IC_ETOILE;

grant REFERENCES on RF_TPOS to IC_FINAL;
...
grant REFERENCES on RF_TPRE to IC_ETOILE;

grant REFERENCES on RF_TPRE to IC_FINAL;
...
grant REFERENCES on RF_TPRO to IC_ETOILE;

grant REFERENCES on RF_TPRO to IC_FINAL;
...
grant REFERENCES on RF_TPROTECT to IC_ETOILE;

grant REFERENCES on RF_TPROTECT to IC_FINAL;
...
grant REFERENCES on RF_TPSHIS to IC_ETOILE;

grant REFERENCES on RF_TPSHIS to IC_FINAL;
...
grant REFERENCES on RF_TPSTRAV to IC_ETOILE;

grant REFERENCES on RF_TPSTRAV to IC_FINAL;
...
grant REFERENCES on RF_TPYR to IC_ETOILE;

grant REFERENCES on RF_TPYR to IC_FINAL;
...
grant REFERENCES on RF_TRAN to IC_ETOILE;

grant REFERENCES on RF_TRAN to IC_FINAL;
...
grant REFERENCES on RF_TREG to IC_ETOILE;

grant REFERENCES on RF_TREG to IC_FINAL;
...
grant REFERENCES on RF_TSAUP to IC_ETOILE;

grant REFERENCES on RF_TSAUP to IC_FINAL;
...
grant REFERENCES on RF_TSAUPP to IC_ETOILE;

grant REFERENCES on RF_TSAUPP to IC_FINAL;
...
grant REFERENCES on RF_TSNUP to IC_ETOILE;

grant REFERENCES on RF_TSNUP to IC_FINAL;
...
grant REFERENCES on RF_TSOULTE to IC_ETOILE;

grant REFERENCES on RF_TSOULTE to IC_FINAL;
...
grant REFERENCES on RF_TSTAT to IC_ETOILE;

grant REFERENCES on RF_TSTAT to IC_FINAL;
...
grant REFERENCES on RF_TSUB to IC_ETOILE;

grant REFERENCES on RF_TSUB to IC_FINAL;
...
grant REFERENCES on RF_TSUP to IC_ETOILE;

grant REFERENCES on RF_TSUP to IC_FINAL;
...
grant REFERENCES on RF_TTACHE to IC_ETOILE;

grant REFERENCES on RF_TTACHE to IC_FINAL;
...
grant REFERENCES on RF_TTF to IC_ETOILE;

grant REFERENCES on RF_TTF to IC_FINAL;
...
grant REFERENCES on RF_TTIE to IC_ETOILE;

grant REFERENCES on RF_TTIE to IC_FINAL;
...
grant REFERENCES on RF_TTRAN to IC_ETOILE;

grant REFERENCES on RF_TTRAN to IC_FINAL;
...
grant REFERENCES on RF_TVA to IC_ETOILE;

grant REFERENCES on RF_TVA to IC_FINAL;
...
grant REFERENCES on RF_TVA_NG to IC_ETOILE;

grant REFERENCES on RF_TVA_NG to IC_FINAL;
...
grant REFERENCES on RF_UO to IC_ETOILE;

grant REFERENCES on RF_UO to IC_FINAL;
...
grant REFERENCES on RF_UTILCL to IC_ETOILE;

grant REFERENCES on RF_UTILCL to IC_FINAL;
...
grant REFERENCES on RF_ZD to IC_ETOILE;

grant REFERENCES on RF_ZD to IC_FINAL;
...
grant REFERENCES on RF_ZFCT to IC_ETOILE;

grant REFERENCES on RF_ZFCT to IC_FINAL;
...
grant REFERENCES on RF_ZONE to IC_ETOILE;

grant REFERENCES on RF_ZONE to IC_FINAL;
...
grant REFERENCES on RF_ZONGRD to IC_ETOILE;

grant REFERENCES on RF_ZONGRD to IC_FINAL;
...
grant REFERENCES on RF_ZONSIT to IC_ETOILE;

grant REFERENCES on RF_ZONSIT to IC_FINAL;
...
/* Synonyme : RF_ACVT                                           */
/*==============================================================*/
create or replace synonym RF_ACVT for RF_ACVT;

/*==============================================================*/
/* Synonyme : RF_AFFAERO                                        */
/*==============================================================*/
create or replace synonym RF_AFFAERO for RF_AFFAERO;

/*==============================================================*/
/* Synonyme : RF_AFFECT                                         */
/*==============================================================*/
create or replace synonym RF_AFFECT for RF_AFFECT;

/*==============================================================*/
/* Synonyme : RF_AFFSJCT                                        */
/*==============================================================*/
create or replace synonym RF_AFFSJCT for RF_AFFSJCT;

/*==============================================================*/
/* Synonyme : RF_ANGE                                           */
/*==============================================================*/
create or replace synonym RF_ANGE for RF_ANGE;
...
/* Synonyme : RF_APE                                            */
/*==============================================================*/
create or replace synonym RF_APE for RF_APE;

/*==============================================================*/
/* Synonyme : RF_ARE                                            */
/*==============================================================*/
create or replace synonym RF_ARE for RF_ARE;

/*==============================================================*/
/* Synonyme : RF_ARME                                           */
/*==============================================================*/
create or replace synonym RF_ARME for RF_ARME;

/*==============================================================*/
/* Synonyme : RF_ARMEE                                          */
/*==============================================================*/
create or replace synonym RF_ARMEE for RF_ARMEE;

/*==============================================================*/
/* Synonyme : RF_AVANC                                          */
/*==============================================================*/
create or replace synonym RF_AVANC for RF_AVANC;
...
/* Synonyme : RF_BASE                                           */
/*==============================================================*/
create or replace synonym RF_BASE for RF_BASE;
...
/* Synonyme : RF_BENAMO                                         */
/*==============================================================*/
create or replace synonym RF_BENAMO for RF_BENAMO;

/*==============================================================*/
/* Synonyme : RF_BOP                                            */
/*==============================================================*/
create or replace synonym RF_BOP for RF_BOP;
...
/* Synonyme : RF_CA                                             */
/*==============================================================*/
create or replace synonym RF_CA for RF_CA;

/*==============================================================*/
/* Synonyme : RF_CAL                                            */
/*==============================================================*/
create or replace synonym RF_CAL for RF_CAL;

/*==============================================================*/
/* Synonyme : RF_CATDEP                                         */
/*==============================================================*/
create or replace synonym RF_CATDEP for RF_CATDEP;

/*==============================================================*/
/* Synonyme : RF_CATORIDRO                                      */
/*==============================================================*/
create or replace synonym RF_CATORIDRO for RF_CATORIDRO;
...
/* Synonyme : RF_CDMB                                           */
/*==============================================================*/
create or replace synonym RF_CDMB for RF_CDMB;

/*==============================================================*/
/* Synonyme : RF_CDSTAT                                         */
/*==============================================================*/
create or replace synonym RF_CDSTAT for RF_CDSTAT;
...
/* Synonyme : RF_CLAUTIL                                        */
/*==============================================================*/
create or replace synonym RF_CLAUTIL for RF_CLAUTIL;

/*==============================================================*/
/* Synonyme : RF_CMD                                            */
/*==============================================================*/
create or replace synonym RF_CMD for RF_CMD;

/*==============================================================*/
/* Synonyme : RF_CNOP                                           */
/*==============================================================*/
create or replace synonym RF_CNOP for RF_CNOP;

/*==============================================================*/
/* Synonyme : RF_CODMIN                                         */
/*==============================================================*/
create or replace synonym RF_CODMIN for RF_CODMIN;

/*==============================================================*/
/* Synonyme : RF_CODNIV                                         */
/*==============================================================*/
create or replace synonym RF_CODNIV for RF_CODNIV;

/*==============================================================*/
/* Synonyme : RF_COEFFENT                                       */
/*==============================================================*/
create or replace synonym RF_COEFFENT for RF_COEFFENT;

/*==============================================================*/
/* Synonyme : RF_COMIMP                                         */
/*==============================================================*/
create or replace synonym RF_COMIMP for RF_COMIMP;

/*==============================================================*/
/* Synonyme : RF_COMM                                           */
/*==============================================================*/
create or replace synonym RF_COMM for RF_COMM;

/*==============================================================*/
/* Synonyme : RF_COMMCP                                         */
/*==============================================================*/
create or replace synonym RF_COMMCP for RF_COMMCP;

/*==============================================================*/
/* Synonyme : RF_CONTRAT_TYP                                    */
/*==============================================================*/
create or replace synonym RF_CONTRAT_TYP for RF_CONTRAT_TYP;

/*==============================================================*/
/* Synonyme : RF_CORCTORD                                       */
/*==============================================================*/
create or replace synonym RF_CORCTORD for RF_CORCTORD;

/*==============================================================*/
/* Synonyme : RF_CORCTORDSTAT                                   */
/*==============================================================*/
create or replace synonym RF_CORCTORDSTAT for RF_CORCTORDSTAT;

/*==============================================================*/
/* Synonyme : RF_CORGRD                                         */
/*==============================================================*/
create or replace synonym RF_CORGRD for RF_CORGRD;

/*==============================================================*/
/* Synonyme : RF_CORPS                                          */
/*==============================================================*/
create or replace synonym RF_CORPS for RF_CORPS;

/*==============================================================*/
/* Synonyme : RF_CP                                             */
/*==============================================================*/
create or replace synonym RF_CP for RF_CP;

/*==============================================================*/
/* Synonyme : RF_CPCE                                           */
/*==============================================================*/
create or replace synonym RF_CPCE for RF_CPCE;
...
/* Synonyme : RF_CPT                                            */
/*==============================================================*/
create or replace synonym RF_CPT for RF_CPT;

/*==============================================================*/
/* Synonyme : RF_CPTCLAUTIL                                     */
/*==============================================================*/
create or replace synonym RF_CPTCLAUTIL for RF_CPTCLAUTIL;

/*==============================================================*/
/* Synonyme : RF_CPTCOM                                         */
/*==============================================================*/
create or replace synonym RF_CPTCOM for RF_CPTCOM;

/*==============================================================*/
/* Synonyme : RF_CPTIND                                         */
/*==============================================================*/
create or replace synonym RF_CPTIND for RF_CPTIND;

/*==============================================================*/
/* Synonyme : RF_CPYR                                           */
/*==============================================================*/
create or replace synonym RF_CPYR for RF_CPYR;

/*==============================================================*/
/* Synonyme : RF_CTACHAT                                        */
/*==============================================================*/
create or replace synonym RF_CTACHAT for RF_CTACHAT;

/*==============================================================*/
/* Synonyme : RF_CTBOP                                          */
/*==============================================================*/
create or replace synonym RF_CTBOP for RF_CTBOP;

/*==============================================================*/
/* Synonyme : RF_CTENG                                          */
/*==============================================================*/
create or replace synonym RF_CTENG for RF_CTENG;

/*==============================================================*/
/* Synonyme : RF_CTGRD                                          */
/*==============================================================*/
create or replace synonym RF_CTGRD for RF_CTGRD;

/*==============================================================*/
/* Synonyme : RF_CTLOP                                          */
/*==============================================================*/
create or replace synonym RF_CTLOP for RF_CTLOP;

/*==============================================================*/
/* Synonyme : RF_CTOB                                           */
/*==============================================================*/
create or replace synonym RF_CTOB for RF_CTOB;

/*==============================================================*/
/* Synonyme : RF_CTORD                                          */
/*==============================================================*/
create or replace synonym RF_CTORD for RF_CTORD;

/*==============================================================*/
/* Synonyme : RF_CTPED                                          */
/*==============================================================*/
create or replace synonym RF_CTPED for RF_CTPED;

/*==============================================================*/
/* Synonyme : RF_CTSTAT                                         */
/*==============================================================*/
create or replace synonym RF_CTSTAT for RF_CTSTAT;

/*==============================================================*/
/* Synonyme : RF_CTSTORCOR                                      */
/*==============================================================*/
create or replace synonym RF_CTSTORCOR for RF_CTSTORCOR;

/*==============================================================*/
/* Synonyme : RF_CTUTIL                                         */
/*==============================================================*/
create or replace synonym RF_CTUTIL for RF_CTUTIL;
...
/* Synonyme : RF_DEPT                                           */
/*==============================================================*/
create or replace synonym RF_DEPT for RF_DEPT;

/*==============================================================*/
/* Synonyme : RF_DEVI                                           */
/*==============================================================*/
create or replace synonym RF_DEVI for RF_DEVI;

/*==============================================================*/
/* Synonyme : RF_DEVI_NG                                        */
/*==============================================================*/
create or replace synonym RF_DEVI_NG for RF_DEVI_NG;

/*==============================================================*/
/* Synonyme : RF_DEVPAY                                         */
/*==============================================================*/
create or replace synonym RF_DEVPAY for RF_DEVPAY;
...
/* Synonyme : RF_DIPHDEF                                        */
/*==============================================================*/
create or replace synonym RF_DIPHDEF for RF_DIPHDEF;

/*==============================================================*/
/* Synonyme : RF_DIPTTA                                         */
/*==============================================================*/
create or replace synonym RF_DIPTTA for RF_DIPTTA;

/*==============================================================*/
/* Synonyme : RF_DOM                                            */
/*==============================================================*/
create or replace synonym RF_DOM for RF_DOM;

/*==============================================================*/
/* Synonyme : RF_DOMFONC                                        */
/*==============================================================*/
create or replace synonym RF_DOMFONC for RF_DOMFONC;

/*==============================================================*/
/* Synonyme : RF_DOMTTA                                         */
/*==============================================================*/
create or replace synonym RF_DOMTTA for RF_DOMTTA;

/*==============================================================*/
/* Synonyme : RF_DPSA                                           */
/*==============================================================*/
create or replace synonym RF_DPSA for RF_DPSA;

/*==============================================================*/
/* Synonyme : RF_ECHELON                                        */
/*==============================================================*/
create or replace synonym RF_ECHELON for RF_ECHELON;

/*==============================================================*/
/* Synonyme : RF_ENGCENGJ                                       */
/*==============================================================*/
create or replace synonym RF_ENGCENGJ for RF_ENGCENGJ;
...
/* Synonyme : RF_ETAN                                           */
/*==============================================================*/
create or replace synonym RF_ETAN for RF_ETAN;

/*==============================================================*/
/* Synonyme : RF_ETATENT                                        */
/*==============================================================*/
create or replace synonym RF_ETATENT for RF_ETATENT;

/*==============================================================*/
/* Synonyme : RF_ETATOPE                                        */
/*==============================================================*/
create or replace synonym RF_ETATOPE for RF_ETATOPE;

/*==============================================================*/
/* Synonyme : RF_FCTCPT                                         */
/*==============================================================*/
create or replace synonym RF_FCTCPT for RF_FCTCPT;

/*==============================================================*/
/* Synonyme : RF_FCTN                                           */
/*==============================================================*/
create or replace synonym RF_FCTN for RF_FCTN;

/*==============================================================*/
/* Synonyme : RF_FCTRPR                                         */
/*==============================================================*/
create or replace synonym RF_FCTRPR for RF_FCTRPR;

/*==============================================================*/
/* Synonyme : RF_FCTSITE                                        */
/*==============================================================*/
create or replace synonym RF_FCTSITE for RF_FCTSITE;

/*==============================================================*/
/* Synonyme : RF_FCTTTA                                         */
/*==============================================================*/
create or replace synonym RF_FCTTTA for RF_FCTTTA;
...
/* Synonyme : RF_FJE                                            */
/*==============================================================*/
create or replace synonym RF_FJE for RF_FJE;
...
/* Synonyme : RF_FORM                                           */
/*==============================================================*/
create or replace synonym RF_FORM for RF_FORM;

/*==============================================================*/
/* Synonyme : RF_FORMPRI                                        */
/*==============================================================*/
create or replace synonym RF_FORMPRI for RF_FORMPRI;
...
/* Synonyme : RF_GCC_NG                                         */
/*==============================================================*/
create or replace synonym RF_GCC_NG for RF_GCC_NG;
...
/* Synonyme : RF_GES                                            */
/*==============================================================*/
create or replace synonym RF_GES for RF_GES;
...
/* Synonyme : RF_GRD                                            */
/*==============================================================*/
create or replace synonym RF_GRD for RF_GRD;

/*==============================================================*/
/* Synonyme : RF_GRDCMP                                         */
/*==============================================================*/
create or replace synonym RF_GRDCMP for RF_GRDCMP;

/*==============================================================*/
/* Synonyme : RF_GRDECH                                         */
/*==============================================================*/
create or replace synonym RF_GRDECH for RF_GRDECH;
...
/*==============================================================*/
create or replace synonym RF_HOMOLDIP for RF_HOMOLDIP;

/*==============================================================*/
/* Synonyme : RF_IMM                                            */
/*==============================================================*/
create or replace synonym RF_IMM for RF_IMM;

/*==============================================================*/
/* Synonyme : RF_IMMCLAUTIL                                     */
/*==============================================================*/
create or replace synonym RF_IMMCLAUTIL for RF_IMMCLAUTIL;

/*==============================================================*/
/* Synonyme : RF_IMMEUBLE                                       */
/*==============================================================*/
create or replace synonym RF_IMMEUBLE for RF_IMMEUBLE;

/*==============================================================*/
/* Synonyme : RF_IMMIND                                         */
/*==============================================================*/
create or replace synonym RF_IMMIND for RF_IMMIND;
...
/* Synonyme : RF_IMPE_NG                                        */
/*==============================================================*/
create or replace synonym RF_IMPE_NG for RF_IMPE_NG;
...
/* Synonyme : RF_IMPG_NG                                        */
/*==============================================================*/
create or replace synonym RF_IMPG_NG for RF_IMPG_NG;

/*==============================================================*/
/* Synonyme : RF_INDM                                           */
/*==============================================================*/
create or replace synonym RF_INDM for RF_INDM;

/*==============================================================*/
/* Synonyme : RF_LCLCATUTIL                                     */
/*==============================================================*/
create or replace synonym RF_LCLCATUTIL for RF_LCLCATUTIL;

/*==============================================================*/
/* Synonyme : RF_LCLCLAUTIL                                     */
/*==============================================================*/
create or replace synonym RF_LCLCLAUTIL for RF_LCLCLAUTIL;

/*==============================================================*/
/* Synonyme : RF_LIGMER                                         */
/*==============================================================*/
create or replace synonym RF_LIGMER for RF_LIGMER;
...
/* Synonyme : RF_MACCES                                         */
/*==============================================================*/
create or replace synonym RF_MACCES for RF_MACCES;

/*==============================================================*/
/* Synonyme : RF_MACCOR                                         */
/*==============================================================*/
create or replace synonym RF_MACCOR for RF_MACCOR;

/*==============================================================*/
/* Synonyme : RF_MACGRD                                         */
/*==============================================================*/
create or replace synonym RF_MACGRD for RF_MACGRD;

/*==============================================================*/
/* Synonyme : RF_MAJ                                            */
/*==============================================================*/
create or replace synonym RF_MAJ for RF_MAJ;

/*==============================================================*/
/* Synonyme : RF_MDRG                                           */
/*==============================================================*/
create or replace synonym RF_MDRG for RF_MDRG;

/*==============================================================*/
/* Synonyme : RF_MDVI                                           */
/*==============================================================*/
create or replace synonym RF_MDVI for RF_MDVI;

/*==============================================================*/
/* Synonyme : RF_MINAFF                                         */
/*==============================================================*/
create or replace synonym RF_MINAFF for RF_MINAFF;

/*==============================================================*/
/* Synonyme : RF_MOA                                            */
/*==============================================================*/
create or replace synonym RF_MOA for RF_MOA;
...
/* Synonyme : RF_MSORT                                          */
/*==============================================================*/
create or replace synonym RF_MSORT for RF_MSORT;

/*==============================================================*/
/* Synonyme : RF_MVTMVT                                         */
/*==============================================================*/
create or replace synonym RF_MVTMVT for RF_MVTMVT;

/*==============================================================*/
/* Synonyme : RF_NAT                                            */
/*==============================================================*/
create or replace synonym RF_NAT for RF_NAT;
...
/*==============================================================*/
create or replace synonym RF_NATDECPRO for RF_NATDECPRO;

/*==============================================================*/
/* Synonyme : RF_NATDEP                                         */
/*==============================================================*/
create or replace synonym RF_NATDEP for RF_NATDEP;

/*==============================================================*/
/* Synonyme : RF_NATDRO                                         */
/*==============================================================*/
create or replace synonym RF_NATDRO for RF_NATDRO;

/*==============================================================*/
/* Synonyme : RF_NATIMM                                         */
/*==============================================================*/
create or replace synonym RF_NATIMM for RF_NATIMM;

/*==============================================================*/
/* Synonyme : RF_NATTXT                                         */
/*==============================================================*/
create or replace synonym RF_NATTXT for RF_NATTXT;

/*==============================================================*/
/* Synonyme : RF_NATVOI                                         */
/*==============================================================*/
create or replace synonym RF_NATVOI for RF_NATVOI;

/*==============================================================*/
/* Synonyme : RF_NBI                                            */
/*==============================================================*/
create or replace synonym RF_NBI for RF_NBI;

/*==============================================================*/
/* Synonyme : RF_NIVRESP                                        */
/*==============================================================*/
create or replace synonym RF_NIVRESP for RF_NIVRESP;

/*==============================================================*/
/* Synonyme : RF_NIVSUPP                                        */
/*==============================================================*/
create or replace synonym RF_NIVSUPP for RF_NIVSUPP;

/*==============================================================*/
/* Synonyme : RF_NOMENCPROD                                     */
/*==============================================================*/
create or replace synonym RF_NOMENCPROD for RF_NOMENCPROD;

/*==============================================================*/
/* Synonyme : RF_NRCTGRD                                        */
/*==============================================================*/
create or replace synonym RF_NRCTGRD for RF_NRCTGRD;

/*==============================================================*/
/* Synonyme : RF_NTTR                                           */
/*==============================================================*/
create or replace synonym RF_NTTR for RF_NTTR;

/*==============================================================*/
/* Synonyme : RF_NTTR_STGPE                                     */
/*==============================================================*/
create or replace synonym RF_NTTR_STGPE for RF_NTTR_STGPE;
...
/* Synonyme : RF_OBI                                            */
/*==============================================================*/
create or replace synonym RF_OBI for RF_OBI;

/*==============================================================*/
/* Synonyme : RF_OBI_NG                                         */
/*==============================================================*/
create or replace synonym RF_OBI_NG for RF_OBI_NG;

/*==============================================================*/
/* Synonyme : RF_OBJTXT                                         */
/*==============================================================*/
create or replace synonym RF_OBJTXT for RF_OBJTXT;

/*==============================================================*/
/* Synonyme : RF_OCC                                            */
/*==============================================================*/
create or replace synonym RF_OCC for RF_OCC;

/*==============================================================*/
/* Synonyme : RF_ORDRE                                          */
/*==============================================================*/
create or replace synonym RF_ORDRE for RF_ORDRE;

/*==============================================================*/
/* Synonyme : RF_ORDS                                           */
/*==============================================================*/
create or replace synonym RF_ORDS for RF_ORDS;

/*==============================================================*/
/* Synonyme : RF_ORDS_NG                                        */
/*==============================================================*/
create or replace synonym RF_ORDS_NG for RF_ORDS_NG;

/*==============================================================*/
/* Synonyme : RF_ORGANISME                                      */
/*==============================================================*/
create or replace synonym RF_ORGANISME for RF_ORGANISME;

/*==============================================================*/
/* Synonyme : RF_ORGANISMEARMEE                                 */
/*==============================================================*/
create or replace synonym RF_ORGANISMEARMEE for RF_ORGANISMEARMEE;

/*==============================================================*/
/* Synonyme : RF_ORGEN                                          */
/*==============================================================*/
create or replace synonym RF_ORGEN for RF_ORGEN;

/*==============================================================*/
/* Synonyme : RF_ORGRAT                                         */
/*==============================================================*/
create or replace synonym RF_ORGRAT for RF_ORGRAT;

/*==============================================================*/
/* Synonyme : RF_ORIDRO                                         */
/*==============================================================*/
create or replace synonym RF_ORIDRO for RF_ORIDRO;

/*==============================================================*/
/* Synonyme : RF_ORIGINE                                        */
/*==============================================================*/
create or replace synonym RF_ORIGINE for RF_ORIGINE;

/*==============================================================*/
/* Synonyme : RF_ORISNUP                                        */
/*==============================================================*/
create or replace synonym RF_ORISNUP for RF_ORISNUP;

/*==============================================================*/
/* Synonyme : RF_PARAG                                          */
/*==============================================================*/
create or replace synonym RF_PARAG for RF_PARAG;

/*==============================================================*/
/* Synonyme : RF_PAYS                                           */
/*==============================================================*/
create or replace synonym RF_PAYS for RF_PAYS;
...
/* Synonyme : RF_PHASE                                          */
/*==============================================================*/
create or replace synonym RF_PHASE for RF_PHASE;

/*==============================================================*/
/* Synonyme : RF_POSSTAT                                        */
/*==============================================================*/
create or replace synonym RF_POSSTAT for RF_POSSTAT;

/*==============================================================*/
/* Synonyme : RF_POSTPS                                         */
/*==============================================================*/
create or replace synonym RF_POSTPS for RF_POSTPS;

/*==============================================================*/
/* Synonyme : RF_PROD                                           */
/*==============================================================*/
create or replace synonym RF_PROD for RF_PROD;

/*==============================================================*/
/* Synonyme : RF_PROG                                           */
/*==============================================================*/
create or replace synonym RF_PROG for RF_PROG;
...
/*==============================================================*/
create or replace synonym RF_PROPRICPT for RF_PROPRICPT;

/*==============================================================*/
/* Synonyme : RF_RATFIS                                         */
/*==============================================================*/
create or replace synonym RF_RATFIS for RF_RATFIS;

/*==============================================================*/
/* Synonyme : RF_REG                                            */
/*==============================================================*/
create or replace synonym RF_REG for RF_REG;

/*==============================================================*/
/* Synonyme : RF_REGDPT                                         */
/*==============================================================*/
create or replace synonym RF_REGDPT for RF_REGDPT;

/*==============================================================*/
/* Synonyme : RF_REGECO                                         */
/*==============================================================*/
create or replace synonym RF_REGECO for RF_REGECO;

/*==============================================================*/
/* Synonyme : RF_REGION                                         */
/*==============================================================*/
create or replace synonym RF_REGION for RF_REGION;

/*==============================================================*/
/* Synonyme : RF_REGSTAT                                        */
/*==============================================================*/
create or replace synonym RF_REGSTAT for RF_REGSTAT;

/*==============================================================*/
/* Synonyme : RF_RTORG2                                         */
/*==============================================================*/
create or replace synonym RF_RTORG2 for RF_RTORG2;

/*==============================================================*/
/* Synonyme : RF_SB                                             */
/*==============================================================*/
create or replace synonym RF_SB for RF_SB;

/*==============================================================*/
/* Synonyme : RF_SCTPAIE                                        */
/*==============================================================*/
create or replace synonym RF_SCTPAIE for RF_SCTPAIE;

/*==============================================================*/
/* Synonyme : RF_SCTUTIL                                        */
/*==============================================================*/
create or replace synonym RF_SCTUTIL for RF_SCTUTIL;

/*==============================================================*/
/* Synonyme : RF_SE                                             */
/*==============================================================*/
create or replace synonym RF_SE for RF_SE;
...
/* Synonyme : RF_SEGPAT                                         */
/*==============================================================*/
create or replace synonym RF_SEGPAT for RF_SEGPAT;

/*==============================================================*/
/* Synonyme : RF_SFCT                                           */
/*==============================================================*/
create or replace synonym RF_SFCT for RF_SFCT;

/*==============================================================*/
/* Synonyme : RF_SFCTCLAUTIL                                    */
/*==============================================================*/
create or replace synonym RF_SFCTCLAUTIL for RF_SFCTCLAUTIL;

/*==============================================================*/
/* Synonyme : RF_SFCTCPT                                        */
/*==============================================================*/
create or replace synonym RF_SFCTCPT for RF_SFCTCPT;

/*==============================================================*/
/* Synonyme : RF_SGC                                            */
/*==============================================================*/
create or replace synonym RF_SGC for RF_SGC;

/*==============================================================*/
/* Synonyme : RF_SITMAR                                         */
/*==============================================================*/
create or replace synonym RF_SITMAR for RF_SITMAR;

/*==============================================================*/
/* Synonyme : RF_SOBI                                           */
/*==============================================================*/
create or replace synonym RF_SOBI for RF_SOBI;

/*==============================================================*/
/* Synonyme : RF_STATRA                                         */
/*==============================================================*/
create or replace synonym RF_STATRA for RF_STATRA;

/*==============================================================*/
/* Synonyme : RF_STATUA                                         */
/*==============================================================*/
create or replace synonym RF_STATUA for RF_STATUA;

/*==============================================================*/
/* Synonyme : RF_STATUT                                         */
/*==============================================================*/
create or replace synonym RF_STATUT for RF_STATUT;
...
/*==============================================================*/
create or replace synonym RF_STE_CHORUS2 for RF_STE_CHORUS;

/*==============================================================*/
/* Synonyme : RF_STRC                                           */
/*==============================================================*/
create or replace synonym RF_STRC for RF_STRC;

/*==============================================================*/
/* Synonyme : RF_TACCES                                         */
/*==============================================================*/
create or replace synonym RF_TACCES for RF_TACCES;

/*==============================================================*/
/* Synonyme : RF_TACHAT                                         */
/*==============================================================*/
create or replace synonym RF_TACHAT for RF_TACHAT;

/*==============================================================*/
/* Synonyme : RF_TACHEFCT                                       */
/*==============================================================*/
create or replace synonym RF_TACHEFCT for RF_TACHEFCT;

/*==============================================================*/
/* Synonyme : RF_TACHENAT                                       */
/*==============================================================*/
create or replace synonym RF_TACHENAT for RF_TACHENAT;

/*==============================================================*/
/* Synonyme : RF_TAFF                                           */
/*==============================================================*/
create or replace synonym RF_TAFF for RF_TAFF;

/*==============================================================*/
/* Synonyme : RF_TAMO                                           */
/*==============================================================*/
create or replace synonym RF_TAMO for RF_TAMO;

/*==============================================================*/
/* Synonyme : RF_TBENECH                                        */
/*==============================================================*/
create or replace synonym RF_TBENECH for RF_TBENECH;

/*==============================================================*/
/* Synonyme : RF_TCOMPO                                         */
/*==============================================================*/
create or replace synonym RF_TCOMPO for RF_TCOMPO;

/*==============================================================*/
/* Synonyme : RF_TCONS                                          */
/*==============================================================*/
create or replace synonym RF_TCONS for RF_TCONS;

/*==============================================================*/
/* Synonyme : RF_TCPT                                           */
/*==============================================================*/
create or replace synonym RF_TCPT for RF_TCPT;

/*==============================================================*/
/* Synonyme : RF_TDEL                                           */
/*==============================================================*/
create or replace synonym RF_TDEL for RF_TDEL;

/*==============================================================*/
/* Synonyme : RF_TDOC                                           */
/*==============================================================*/
create or replace synonym RF_TDOC for RF_TDOC;

/*==============================================================*/
/* Synonyme : RF_TDOCTOPEDOM                                    */
/*==============================================================*/
create or replace synonym RF_TDOCTOPEDOM for RF_TDOCTOPEDOM;

/*==============================================================*/
/* Synonyme : RF_TDOM                                           */
/*==============================================================*/
create or replace synonym RF_TDOM for RF_TDOM;

/*==============================================================*/
/* Synonyme : RF_TDUREE                                         */
/*==============================================================*/
create or replace synonym RF_TDUREE for RF_TDUREE;

/*==============================================================*/
/* Synonyme : RF_TENGC                                          */
/*==============================================================*/
create or replace synonym RF_TENGC for RF_TENGC;

/*==============================================================*/
/* Synonyme : RF_TETAD                                          */
/*==============================================================*/
create or replace synonym RF_TETAD for RF_TETAD;

/*==============================================================*/
/* Synonyme : RF_TETAO                                          */
/*==============================================================*/
create or replace synonym RF_TETAO for RF_TETAO;

/*==============================================================*/
/* Synonyme : RF_TF                                             */
/*==============================================================*/
create or replace synonym RF_TF for RF_TF;

/*==============================================================*/
/* Synonyme : RF_TFICHIER                                       */
/*==============================================================*/
create or replace synonym RF_TFICHIER for RF_TFICHIER;
...
/* Synonyme : RF_TIMPN                                          */
/*==============================================================*/
create or replace synonym RF_TIMPN for RF_TIMPN;

/*==============================================================*/
/* Synonyme : RF_TINDIC                                         */
/*==============================================================*/
create or replace synonym RF_TINDIC for RF_TINDIC;

/*==============================================================*/
/* Synonyme : RF_TINDMAJ                                        */
/*==============================================================*/
create or replace synonym RF_TINDMAJ for RF_TINDMAJ;

/*==============================================================*/
/* Synonyme : RF_TINTF                                          */
/*==============================================================*/
create or replace synonym RF_TINTF for RF_TINTF;

/*==============================================================*/
/* Synonyme : RF_TINTV                                          */
/*==============================================================*/
create or replace synonym RF_TINTV for RF_TINTV;

/*==============================================================*/
/* Synonyme : RF_TITR                                           */
/*==============================================================*/
create or replace synonym RF_TITR for RF_TITR;

/*==============================================================*/
/* Synonyme : RF_TLIG                                           */
/*==============================================================*/
create or replace synonym RF_TLIG for RF_TLIG;

/*==============================================================*/
/* Synonyme : RF_TLOC                                           */
/*==============================================================*/
create or replace synonym RF_TLOC for RF_TLOC;

/*==============================================================*/
/* Synonyme : RF_TMAJOPE                                        */
/*==============================================================*/
create or replace synonym RF_TMAJOPE for RF_TMAJOPE;

/*==============================================================*/
/* Synonyme : RF_TMAN                                           */
/*==============================================================*/
create or replace synonym RF_TMAN for RF_TMAN;

/*==============================================================*/
/* Synonyme : RF_TMAR                                           */
/*==============================================================*/
create or replace synonym RF_TMAR for RF_TMAR;

/*==============================================================*/
/* Synonyme : RF_TMEMO                                          */
/*==============================================================*/
create or replace synonym RF_TMEMO for RF_TMEMO;

/*==============================================================*/
/* Synonyme : RF_TMNT                                           */
/*==============================================================*/
create or replace synonym RF_TMNT for RF_TMNT;

/*==============================================================*/
/* Synonyme : RF_TMVT                                           */
/*==============================================================*/
create or replace synonym RF_TMVT for RF_TMVT;

/*==============================================================*/
/* Synonyme : RF_TNIV                                           */
/*==============================================================*/
create or replace synonym RF_TNIV for RF_TNIV;
...
/* Synonyme : RF_TOPEDOM                                        */
/*==============================================================*/
create or replace synonym RF_TOPEDOM for RF_TOPEDOM;

/*==============================================================*/
/* Synonyme : RF_TOPLIQ                                         */
/*==============================================================*/
create or replace synonym RF_TOPLIQ for RF_TOPLIQ;

/*==============================================================*/
/* Synonyme : RF_TOPV                                           */
/*==============================================================*/
create or replace synonym RF_TOPV for RF_TOPV;

/*==============================================================*/
/* Synonyme : RF_TORG                                           */
/*==============================================================*/
create or replace synonym RF_TORG for RF_TORG;

/*==============================================================*/
/* Synonyme : RF_TOUV                                           */
/*==============================================================*/
create or replace synonym RF_TOUV for RF_TOUV;

/*==============================================================*/
/* Synonyme : RF_TPAIDIR                                        */
/*==============================================================*/
create or replace synonym RF_TPAIDIR for RF_TPAIDIR;

/*==============================================================*/
/* Synonyme : RF_TPERS                                          */
/*==============================================================*/
create or replace synonym RF_TPERS for RF_TPERS;
...
/* Synonyme : RF_TPOP                                           */
/*==============================================================*/
create or replace synonym RF_TPOP for RF_TPOP;

/*==============================================================*/
/* Synonyme : RF_TPOS                                           */
/*==============================================================*/
create or replace synonym RF_TPOS for RF_TPOS;

/*==============================================================*/
/* Synonyme : RF_TPRE                                           */
/*==============================================================*/
create or replace synonym RF_TPRE for RF_TPRE;

/*==============================================================*/
/* Synonyme : RF_TPRO                                           */
/*==============================================================*/
create or replace synonym RF_TPRO for RF_TPRO;

/*==============================================================*/
/* Synonyme : RF_TPROTECT                                       */
/*==============================================================*/
create or replace synonym RF_TPROTECT for RF_TPROTECT;

/*==============================================================*/
/* Synonyme : RF_TPSHIS                                         */
/*==============================================================*/
create or replace synonym RF_TPSHIS for RF_TPSHIS;

/*==============================================================*/
/* Synonyme : RF_TPSTRAV                                        */
/*==============================================================*/
create or replace synonym RF_TPSTRAV for RF_TPSTRAV;

/*==============================================================*/
/* Synonyme : RF_TPYR                                           */
/*==============================================================*/
create or replace synonym RF_TPYR for RF_TPYR;

/*==============================================================*/
/* Synonyme : RF_TRAN                                           */
/*==============================================================*/
create or replace synonym RF_TRAN for RF_TRAN;

/*==============================================================*/
/* Synonyme : RF_TREG                                           */
/*==============================================================*/
create or replace synonym RF_TREG for RF_TREG;

/*==============================================================*/
/* Synonyme : RF_TSAUP                                          */
/*==============================================================*/
create or replace synonym RF_TSAUP for RF_TSAUP;

/*==============================================================*/
/* Synonyme : RF_TSAUPP                                         */
/*==============================================================*/
create or replace synonym RF_TSAUPP for RF_TSAUPP;

/*==============================================================*/
/* Synonyme : RF_TSNUP                                          */
/*==============================================================*/
create or replace synonym RF_TSNUP for RF_TSNUP;

/*==============================================================*/
/* Synonyme : RF_TSOULTE                                        */
/*==============================================================*/
create or replace synonym RF_TSOULTE for RF_TSOULTE;

/*==============================================================*/
/* Synonyme : RF_TSTAT                                          */
/*==============================================================*/
create or replace synonym RF_TSTAT for RF_TSTAT;

/*==============================================================*/
/* Synonyme : RF_TSUB                                           */
/*==============================================================*/
create or replace synonym RF_TSUB for RF_TSUB;

/*==============================================================*/
/* Synonyme : RF_TSUP                                           */
/*==============================================================*/
create or replace synonym RF_TSUP for RF_TSUP;

/*==============================================================*/
/* Synonyme : RF_TTACHE                                         */
/*==============================================================*/
create or replace synonym RF_TTACHE for RF_TTACHE;

/*==============================================================*/
/* Synonyme : RF_TTF                                            */
/*==============================================================*/
create or replace synonym RF_TTF for RF_TTF;
...
/* Synonyme : RF_TTRAN                                          */
/*==============================================================*/
create or replace synonym RF_TTRAN for RF_TTRAN;

/*==============================================================*/
/* Synonyme : RF_TVA                                            */
/*==============================================================*/
create or replace synonym RF_TVA for RF_TVA;
...
/* Synonyme : RF_UTILCL                                         */
/*==============================================================*/
create or replace synonym RF_UTILCL for RF_UTILCL;
...
/* Synonyme : RF_ZFCT                                           */
/*==============================================================*/
create or replace synonym RF_ZFCT for RF_ZFCT;

/*==============================================================*/
/* Synonyme : RF_ZONE                                           */
/*==============================================================*/
create or replace synonym RF_ZONE for RF_ZONE;

/*==============================================================*/
/* Synonyme : RF_ZONGRD                                         */
/*==============================================================*/
create or replace synonym RF_ZONGRD for RF_ZONGRD;

/*==============================================================*/
/* Synonyme : RF_ZONSIT                                         */
/*==============================================================*/
create or replace synonym RF_ZONSIT for RF_ZONSIT;
