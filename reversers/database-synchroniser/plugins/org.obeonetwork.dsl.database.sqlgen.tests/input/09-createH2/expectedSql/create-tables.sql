...
CREATE TABLE PUBLIC.AW_ADRESSE(
    ADRESSE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PUBLIC.AW_COMPETENCE(
    COMPETENCE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PUBLIC.AW_COMPETENCE_ID(
    PERSONNE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
    COMPETENCE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT
);
...
CREATE TABLE PUBLIC.AW_COMPETENCE_PERSO(
    COMPETENCE_PERSO_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PUBLIC.AW_MAIL(
    MAIL_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PUBLIC.AW_PERMISSION(
    PERMISSION_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PUBLIC.AW_ROLE(
    ROLE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PUBLIC.AW_ROLE_UTILISATEUR(
    UTILISATEUR_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
    ROLE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT
);
...
CREATE TABLE PUBLIC.AW_TELEPHONE(
    TELEPHONE_ID DECIMAL(19, 0) NOT NULL AUTO_INCREMENT,
    PRO DECIMAL(1, 0) NOT NULL,
