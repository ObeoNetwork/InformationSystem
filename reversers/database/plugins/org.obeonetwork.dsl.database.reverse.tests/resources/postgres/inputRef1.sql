...
(
    ...
    PRENOM VARCHAR(100),
    CIVIL BOOLEAN not null,
    DATE_NAISSANCE TIMESTAMP,
    SALAIRE NUMERIC(14,2),
    VERSION TIMESTAMP not null,
    GRADE_ID BIGINT,
    XDMAJ TIMESTAMP,
    XTOPSUP BOOLEAN not null,
...
(
    COMPETENCE_PERSO_ID BIGINT not null,
    LIBELLE VARCHAR(100),
    XDMAJ TIMESTAMP,
    XTOPSUP BOOLEAN not null,
...
(
    PERSONNE_N_COMPETENCE_PERSO_ID BIGINT not null,
    COMPETENCEPERSO_ID BIGINT not null,
    PERSONNE_ID BIGINT not null,
    XDMAJ TIMESTAMP,
    XTOPSUP BOOLEAN not null,
