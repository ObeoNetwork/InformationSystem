...
public class AsyncEventStatePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, AsyncEventStatePropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.AsyncEventState.Properties.name);
	...
	public void initActions(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.AsyncEventState.Properties.actions);
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.AsyncEventState.Properties.description);
