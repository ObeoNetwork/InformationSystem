...
public class ViewElementPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ViewElementPropertiesEditionPart {
	...
	public void createControls(Composite view) { 
		...
		propertiesStep.addStep(ViewViewsRepository.ViewElement.Properties.dataBindings);
		...
		composer = new PartComposer(viewElementStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ViewViewsRepository.ViewElement.Properties.dataBindings) {
					return createDataBindingsAdvancedTableComposition(parent);
				}
	 ...
	 * 
	 */
	protected Composite createDataBindingsAdvancedTableComposition(Composite parent) {
		this.dataBindings = new ReferencesTable(getDescription(ViewViewsRepository.ViewElement.Properties.dataBindings, ViewMessages.ViewElementPropertiesEditionPart_DataBindingsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ViewElementPropertiesEditionPartImpl.this, ViewViewsRepository.ViewElement.Properties.dataBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				dataBindings.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ViewElementPropertiesEditionPartImpl.this, ViewViewsRepository.ViewElement.Properties.dataBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				dataBindings.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ViewElementPropertiesEditionPartImpl.this, ViewViewsRepository.ViewElement.Properties.dataBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				dataBindings.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ViewElementPropertiesEditionPartImpl.this, ViewViewsRepository.ViewElement.Properties.dataBindings, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				dataBindings.refresh();
			}
		...
		this.dataBindings.setHelpText(propertiesEditionComponent.getHelpContent(ViewViewsRepository.ViewElement.Properties.dataBindings, ViewViewsRepository.SWT_KIND));
		this.dataBindings.createControls(parent);
		this.dataBindings.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ViewElementPropertiesEditionPartImpl.this, ViewViewsRepository.ViewElement.Properties.dataBindings, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		dataBindings.setID(ViewViewsRepository.ViewElement.Properties.dataBindings);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.cinematic.view.parts.ViewElementPropertiesEditionPart#initDataBindings(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.cinematic.view.parts.ViewElementPropertiesEditionPart#updateDataBindings()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.cinematic.view.parts.ViewElementPropertiesEditionPart#addFilterDataBindings(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.cinematic.view.parts.ViewElementPropertiesEditionPart#addBusinessFilterDataBindings(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.cinematic.view.parts.ViewElementPropertiesEditionPart#isContainedInDataBindingsTable(EObject element)
	 * 
	 */
