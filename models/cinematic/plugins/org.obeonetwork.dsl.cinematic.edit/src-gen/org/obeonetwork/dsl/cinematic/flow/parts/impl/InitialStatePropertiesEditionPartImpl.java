...
public class InitialStatePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, InitialStatePropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.InitialState.Properties.name);
	...
	public void initActions(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.InitialState.Properties.actions);
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.InitialState.Properties.description);
