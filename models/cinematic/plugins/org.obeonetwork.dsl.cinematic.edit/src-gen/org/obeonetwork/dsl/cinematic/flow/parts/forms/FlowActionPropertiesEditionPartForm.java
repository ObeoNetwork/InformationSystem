...
public class FlowActionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FlowActionPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowAction.Properties.name);
	...
	public void initCalls(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowAction.Properties.calls);
		if (readOnly && calls.getTable().isEnabled()) {
			calls.setEnabled(false);
			calls.setToolTipText(FlowMessages.FlowAction_ReadOnly);
		} else if (!readOnly && !calls.getTable().isEnabled()) {
	...
	public void initOperations(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowAction.Properties.operations);
		if (readOnly && operations.getTable().isEnabled()) {
			operations.setEnabled(false);
			operations.setToolTipText(FlowMessages.FlowAction_ReadOnly);
		} else if (!readOnly && !operations.getTable().isEnabled()) {
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowAction.Properties.description);
