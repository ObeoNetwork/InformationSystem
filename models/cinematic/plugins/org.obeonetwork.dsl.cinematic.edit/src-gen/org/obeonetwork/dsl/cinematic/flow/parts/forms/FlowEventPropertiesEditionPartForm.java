...
public class FlowEventPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FlowEventPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowEvent.Properties.name);
	...
	public void initBinds(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowEvent.Properties.binds);
		if (readOnly && binds.getTable().isEnabled()) {
			binds.setEnabled(false);
			binds.setToolTipText(FlowMessages.FlowEvent_ReadOnly);
		} else if (!readOnly && !binds.getTable().isEnabled()) {
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(FlowViewsRepository.FlowEvent.Properties.description);
