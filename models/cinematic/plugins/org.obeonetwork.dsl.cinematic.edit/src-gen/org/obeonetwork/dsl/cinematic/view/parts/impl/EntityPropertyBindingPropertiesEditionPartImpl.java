 ...
 * 
 */
public class EntityPropertyBindingPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EntityPropertyBindingPropertiesEditionPart {
	 ...
	 * 
	 */
	public EntityPropertyBindingPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ViewMessages.EntityPropertyBindingPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPropertyFlatComboViewer(Composite parent) {
		...
		property = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ViewViewsRepository.EntityPropertyBinding.Properties.property, ViewViewsRepository.SWT_KIND));
		...
		property.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntityPropertyBindingPropertiesEditionPartImpl.this, ViewViewsRepository.EntityPropertyBinding.Properties.property, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getProperty()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ViewViewsRepository.EntityPropertyBinding.Properties.property, ViewViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntityPropertyBindingPropertiesEditionPartImpl.this, ViewViewsRepository.EntityPropertyBinding.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ViewViewsRepository.EntityPropertyBinding.Properties.description, ViewViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
