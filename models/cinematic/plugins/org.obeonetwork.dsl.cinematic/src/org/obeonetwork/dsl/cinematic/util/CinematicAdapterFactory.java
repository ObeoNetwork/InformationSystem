 ...
 * @generated
 */
public class CinematicAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public CinematicAdapterFactory() {
	 ...
	 * @generated
	 */
	protected CinematicSwitch<Adapter> modelSwitch =
		new CinematicSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseAbstractPackage(AbstractPackage object) {
				return createAbstractPackageAdapter();
			}
			@Override
			public Adapter casePackage(org.obeonetwork.dsl.cinematic.Package object) {
				return createPackageAdapter();
			}
			@Override
			public Adapter caseCinematicRoot(CinematicRoot object) {
				return createCinematicRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.dsl.cinematic.AbstractPackage <em>Abstract Package</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAbstractPackageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.dsl.cinematic.CinematicRoot <em>Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.dsl.cinematic.Package <em>Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
