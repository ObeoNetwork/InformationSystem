...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.requirement.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementPackage.Literals.CATEGORY__ID,
				 true,
				 false,
				 false,
	...
	protected void addReferencedObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_referencedObject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_referencedObject_feature", "_UI_Category_type"),
				 RequirementPackage.Literals.CATEGORY__REFERENCED_OBJECT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementPackage.Literals.CATEGORY__REQUIREMENTS);
			childrenFeatures.add(RequirementPackage.Literals.CATEGORY__SUB_CATEGORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementPackage.Literals.CATEGORY__REQUIREMENTS,
				 RequirementFactory.eINSTANCE.createRequirement()));

		newChildDescriptors.add
			(createChildParameter
				(RequirementPackage.Literals.CATEGORY__SUB_CATEGORIES,
				 RequirementFactory.eINSTANCE.createCategory()));
	}
