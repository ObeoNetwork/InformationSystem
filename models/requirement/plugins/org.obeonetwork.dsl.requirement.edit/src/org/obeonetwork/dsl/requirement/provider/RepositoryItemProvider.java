...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.requirement.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repository_referencedObject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repository_referencedObject_feature", "_UI_Repository_type"),
				 RequirementPackage.Literals.REPOSITORY__REFERENCED_OBJECT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementPackage.Literals.REPOSITORY__MAIN_CATEGORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementPackage.Literals.REPOSITORY__MAIN_CATEGORIES,
