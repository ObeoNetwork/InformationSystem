...
L'édition ne doit pas se faire dans cet éditeur mais par le biais de la _Requirements table_ du point de vue _Requirements_.
...
Une fois le point de vue activé, il est possible de créer un tableau _Requirements table_ sur un _Repository_ d'exigences.
