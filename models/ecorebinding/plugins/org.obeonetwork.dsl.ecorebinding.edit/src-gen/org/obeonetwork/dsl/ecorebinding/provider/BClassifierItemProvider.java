...
public class BClassifierItemProvider
	 ...
	 * @generated
	 */
	public BClassifierItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BClassifier_bPackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BClassifier_bPackage_feature", "_UI_BClassifier_type"),
				 EcorebindingPackage.Literals.BCLASSIFIER__BPACKAGE,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcorebindingPackage.Literals.BCLASSIFIER__BTYPE_PARAMETERS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BClassifier"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BClassifier.class)) {
			case EcorebindingPackage.BCLASSIFIER__BTYPE_PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcorebindingPackage.Literals.BCLASSIFIER__BTYPE_PARAMETERS,
