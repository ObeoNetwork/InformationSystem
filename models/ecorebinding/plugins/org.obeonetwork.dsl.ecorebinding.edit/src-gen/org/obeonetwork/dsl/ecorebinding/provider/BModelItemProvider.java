...
public class BModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcorebindingPackage.Literals.BMODEL__BPACKAGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BModel.class)) {
			case EcorebindingPackage.BMODEL__BPACKAGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcorebindingPackage.Literals.BMODEL__BPACKAGES,
