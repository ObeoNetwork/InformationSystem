...
public class BEnumLiteralItemProvider
	 ...
	 * @generated
	 */
	public BEnumLiteralItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BEnumLiteral_ecoreEnumLiteral_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BEnumLiteral_ecoreEnumLiteral_feature", "_UI_BEnumLiteral_type"),
				 EcorebindingPackage.Literals.BENUM_LITERAL__ECORE_ENUM_LITERAL,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BEnumLiteral"));
	}
