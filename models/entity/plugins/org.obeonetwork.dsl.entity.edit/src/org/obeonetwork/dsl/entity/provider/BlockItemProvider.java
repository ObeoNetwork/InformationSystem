...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.entity.Block} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntityPackage.Literals.BLOCK__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityPackage.Literals.BLOCK__ENTITIES,
				 EntityFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add
			(createChildParameter
				(EntityPackage.Literals.BLOCK__SUBBLOCKS,
