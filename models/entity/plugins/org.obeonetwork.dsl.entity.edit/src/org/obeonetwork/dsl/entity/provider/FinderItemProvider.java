	...
	protected void addCustomizedNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Finder_customizedName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Finder_customizedName_feature", "_UI_Finder_type"),
				 EntityPackage.Literals.FINDER__CUSTOMIZED_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMultiplicityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Finder_multiplicity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Finder_multiplicity_feature", "_UI_Finder_type"),
				 EntityPackage.Literals.FINDER__MULTIPLICITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityPackage.Literals.FINDER__CRITERIONS,
