...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.entity.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_isComposite_feature", "_UI_Reference_type"),
				 EntityPackage.Literals.REFERENCE__IS_COMPOSITE,
				 true,
				 false,
				 false,
	...
	protected void addOppositeOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor 
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_oppositeOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_oppositeOf_feature", "_UI_Reference_type"),
				 EntityPackage.Literals.REFERENCE__OPPOSITE_OF,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntityPackage.Literals.REFERENCE__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_navigable_feature", "_UI_Reference_type"),
				 EntityPackage.Literals.REFERENCE__NAVIGABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
