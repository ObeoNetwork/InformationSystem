...
public class ForeignKeyItemProvider extends NamedElementItemProvider {
     ...
     * @generated
     */
    public static final String copyright = "Copyright (c) 2011, 2017, 2017 Obeo.\r\nAll rights reserved. This program and the accompanying materials\r\nare made available under the terms of the Eclipse Public License v1.0\r\nwhich accompanies this distribution, and is available at\r\nhttp://www.eclipse.org/legal/epl-v10.html\r\n\r\nContributors:\r\n    Obeo - initial API and implementation";
    ...
    protected void addTargetPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ForeignKey_target_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_target_feature",
                                "_UI_ForeignKey_type"),
                        DatabasePackage.Literals.FOREIGN_KEY__TARGET, true, false, true, null, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DatabasePackage.Literals.FOREIGN_KEY__ELEMENTS,
