...
public class ViewItemProvider
	...
	protected void addColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_columns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_columns_feature", "_UI_View_type"),
				 DatabasePackage.Literals.VIEW__COLUMNS,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DatabasePackage.Literals.VIEW__TABLES,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatabasePackage.Literals.VIEW__COLUMNS);
			childrenFeatures.add(DatabasePackage.Literals.VIEW__TABLES);
		}
