 ...
 * 
 */
public class ForeignKeyPropertiesEditionProvider extends CustomPropertiesEditingProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ForeignKey) 
					&& (DatabasePackage.Literals.FOREIGN_KEY == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && DatabasePackage.Literals.FOREIGN_KEY == eObj.eClass();
		}
