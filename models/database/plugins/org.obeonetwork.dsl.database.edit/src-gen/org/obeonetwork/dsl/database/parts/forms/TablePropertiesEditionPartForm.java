...
public class TablePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, TablePropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.Table.Properties.name);
	...
	public void initColumns(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.Table.Properties.columns);
		if (readOnly && columns.isEnabled()) {
			columns.setEnabled(false);
			columns.setToolTipText(DatabaseMessages.Table_ReadOnly);
		} else if (!readOnly && !columns.isEnabled()) {
	...
	public void setComments(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.Table.Properties.comments);
