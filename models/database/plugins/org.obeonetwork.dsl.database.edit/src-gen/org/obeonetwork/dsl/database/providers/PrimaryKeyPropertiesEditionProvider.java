 ...
 * 
 */
public class PrimaryKeyPropertiesEditionProvider extends CustomPropertiesEditingProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof PrimaryKey) 
					&& (DatabasePackage.Literals.PRIMARY_KEY == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && DatabasePackage.Literals.PRIMARY_KEY == eObj.eClass();
		}
