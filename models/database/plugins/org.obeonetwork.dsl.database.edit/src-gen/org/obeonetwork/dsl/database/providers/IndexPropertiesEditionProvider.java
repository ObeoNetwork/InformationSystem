 ...
 * 
 */
public class IndexPropertiesEditionProvider extends CustomPropertiesEditingProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Index) 
					&& (DatabasePackage.Literals.INDEX == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && DatabasePackage.Literals.INDEX == eObj.eClass();
		}
