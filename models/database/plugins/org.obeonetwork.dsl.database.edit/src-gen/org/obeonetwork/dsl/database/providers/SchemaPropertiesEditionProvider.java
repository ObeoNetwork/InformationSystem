 ...
 * 
 */
public class SchemaPropertiesEditionProvider extends CustomPropertiesEditingProvider {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Schema) 
					&& (DatabasePackage.Literals.SCHEMA == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && DatabasePackage.Literals.SCHEMA == eObj.eClass();
		}
