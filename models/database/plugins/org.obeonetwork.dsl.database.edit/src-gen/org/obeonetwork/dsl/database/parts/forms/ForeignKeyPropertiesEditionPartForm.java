...
public class ForeignKeyPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ForeignKeyPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(DatabaseMessages.ForeignKey_ReadOnly);
	...
	public void initTarget(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.target);
	...
	public void initElements(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.elements);
	...
	public void setComments(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.comments);
		if (eefElementEditorReadOnlyState && comments.isEnabled()) {
			...
			comments.setToolTipText(DatabaseMessages.ForeignKey_ReadOnly);
