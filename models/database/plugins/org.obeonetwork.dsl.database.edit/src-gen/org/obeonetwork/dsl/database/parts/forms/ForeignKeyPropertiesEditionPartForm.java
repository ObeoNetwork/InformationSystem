...
public class ForeignKeyPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ForeignKeyPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.name);
	...
	public void initTarget(EObjectFlatComboSettings settings) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.target);
	...
	public void initElements(ReferencesTableSettings settings) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.elements);
	...
	public void setComments(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.ForeignKey.Properties.comments);
