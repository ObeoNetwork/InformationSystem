...
public class ConstraintPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ConstraintPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.Constraint.Properties.name);
	...
	public void setExpression(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.Constraint.Properties.expression);
		if (readOnly && expression.isEnabled()) {
		...
		} else if (!readOnly && !expression.isEnabled()) {
	...
	public void setComments(String newValue) {
		...
		boolean readOnly = isReadOnly(DatabaseViewsRepository.Constraint.Properties.comments);
