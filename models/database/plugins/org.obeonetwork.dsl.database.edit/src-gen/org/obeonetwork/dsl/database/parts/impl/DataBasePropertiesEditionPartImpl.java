...
public class DataBasePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DataBasePropertiesEditionPart {
	...
	protected Composite createUsedLibrariesFlatReferencesTable(Composite parent) {
		...
		// Start of user code for createUsedLibrariesFlatReferencesTable
	...
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.DataBase_.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(DatabaseMessages.DataBase_ReadOnly);
	...
	public void setUrl(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.DataBase_.Properties.url);
		if (eefElementEditorReadOnlyState && url.isEnabled()) {
			url.setEnabled(false);
			url.setToolTipText(DatabaseMessages.DataBase_ReadOnly);
	...
	public void initUsedLibraries(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.DataBase_.Properties.usedLibraries);
		if (eefElementEditorReadOnlyState && usedLibraries.isEnabled()) {
			usedLibraries.setEnabled(false);
			usedLibraries.setToolTipText(DatabaseMessages.DataBase_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !usedLibraries.isEnabled()) {
			usedLibraries.setEnabled(true);
		}	
	...
	public void setComments(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(DatabaseViewsRepository.DataBase_.Properties.comments);
		if (eefElementEditorReadOnlyState && comments.isEnabled()) {
			...
			comments.setToolTipText(DatabaseMessages.DataBase_ReadOnly);
