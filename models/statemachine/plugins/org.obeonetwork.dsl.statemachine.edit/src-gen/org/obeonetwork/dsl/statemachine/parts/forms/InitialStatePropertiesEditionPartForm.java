...
public class InitialStatePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, InitialStatePropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		CompositionStep propertiesStep = initialStateStep.addStep(StatemachineViewsRepository.InitialState.Properties.class);
		propertiesStep.addStep(StatemachineViewsRepository.InitialState.Properties.incomingTransitions);
		propertiesStep.addStep(StatemachineViewsRepository.InitialState.Properties.outcomingTransitions);
		propertiesStep.addStep(StatemachineViewsRepository.InitialState.Properties.keywords);
		propertiesStep.addStep(StatemachineViewsRepository.InitialState.Properties.description);
		...
		composer = new PartComposer(initialStateStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				if (key == StatemachineViewsRepository.InitialState.Properties.class) {
					return createPropertiesGroup(widgetFactory, parent);
				}
				if (key == StatemachineViewsRepository.InitialState.Properties.incomingTransitions) {
					return createIncomingTransitionsReferencesTable(widgetFactory, parent);
				}
				if (key == StatemachineViewsRepository.InitialState.Properties.outcomingTransitions) {
					return createOutcomingTransitionsReferencesTable(widgetFactory, parent);
				}
				if (key == StatemachineViewsRepository.InitialState.Properties.keywords) {
					return createKeywordsMultiValuedEditor(widgetFactory, parent);
				}
				if (key == StatemachineViewsRepository.InitialState.Properties.description) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(StatemachineMessages.InitialStatePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIncomingTransitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incomingTransitions = new ReferencesTable(getDescription(StatemachineViewsRepository.InitialState.Properties.incomingTransitions, StatemachineMessages.InitialStatePropertiesEditionPart_IncomingTransitionsLabel), new ReferencesTableListener	() {
		...
		this.incomingTransitions.setHelpText(propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.InitialState.Properties.incomingTransitions, StatemachineViewsRepository.FORM_KIND));
		...
		this.incomingTransitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialStatePropertiesEditionPartForm.this, StatemachineViewsRepository.InitialState.Properties.incomingTransitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"incomingTransitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialStatePropertiesEditionPartForm.this, StatemachineViewsRepository.InitialState.Properties.incomingTransitions,
	...
	protected void removeFromIncomingTransitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialStatePropertiesEditionPartForm.this, StatemachineViewsRepository.InitialState.Properties.incomingTransitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingTransitions.refresh();
	}
	...
	protected Composite createOutcomingTransitionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outcomingTransitions = new ReferencesTable(getDescription(StatemachineViewsRepository.InitialState.Properties.outcomingTransitions, StatemachineMessages.InitialStatePropertiesEditionPart_OutcomingTransitionsLabel), new ReferencesTableListener	() {
		...
		this.outcomingTransitions.setHelpText(propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.InitialState.Properties.outcomingTransitions, StatemachineViewsRepository.FORM_KIND));
		...
		this.outcomingTransitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialStatePropertiesEditionPartForm.this, StatemachineViewsRepository.InitialState.Properties.outcomingTransitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		outcomingTransitions.setID(StatemachineViewsRepository.InitialState.Properties.outcomingTransitions);
	...
	protected void addOutcomingTransitions() {
		...
		"outcomingTransitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialStatePropertiesEditionPartForm.this, StatemachineViewsRepository.InitialState.Properties.outcomingTransitions,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutcomingTransitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialStatePropertiesEditionPartForm.this, StatemachineViewsRepository.InitialState.Properties.outcomingTransitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outcomingTransitions.refresh();
	}
		...
		editKeywords.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(
						keywords.getShell(), "InitialState", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							StatemachineViewsRepository.InitialState.Properties.description,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(StatemachineViewsRepository.InitialState.Properties.description, StatemachineViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#initIncomingTransitions(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initIncomingTransitions(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.InitialState.Properties.incomingTransitions);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#updateIncomingTransitions()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#addFilterIncomingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#addBusinessFilterIncomingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#isContainedInIncomingTransitionsTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#initOutcomingTransitions(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initOutcomingTransitions(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.InitialState.Properties.outcomingTransitions);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#updateOutcomingTransitions()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#addFilterOutcomingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#addBusinessFilterOutcomingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#isContainedInOutcomingTransitionsTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#getKeywords()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#setKeywords(EList newValue)
	 * 
	 */
	public void setKeywords(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.InitialState.Properties.keywords);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#getDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.dsl.statemachine.parts.InitialStatePropertiesEditionPart#setDescription(String newValue)
	 * 
	 */
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(StatemachineViewsRepository.InitialState.Properties.description);
	...
	public String getTitle() {
		return StatemachineMessages.InitialState_Part_Title;
	}
