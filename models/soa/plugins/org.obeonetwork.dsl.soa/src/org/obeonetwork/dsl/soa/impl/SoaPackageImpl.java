...
public class SoaPackageImpl extends EPackageImpl implements SoaPackage {
	...
	public void createPackageContents() {
		...
		createEReference(componentEClass, COMPONENT__SERVERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getComponent_Servers(), this.getServer(), null, "servers", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSecurityScheme_Format(), ecorePackage.getEString(), "format", null, 0, 1, SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInformation_ApiVersion(), ecorePackage.getEString(), "apiVersion", "0.0.1", 0, 1, Information.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
