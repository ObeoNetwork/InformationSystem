...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.soa.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SoaPackage.Literals.INTERFACE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoaPackage.Literals.INTERFACE__OWNED_OPERATIONS);
		}
	...
	public Object getImage(Object object) {
		...
		images.add(getResourceLocator().getImage("full/obj16/Interface"));
		
		Interface interfaceObject = (Interface) object;
		if(interfaceObject.eContainer() instanceof Service) {
			Service containingService = (Service) interfaceObject.eContainer();
			if(!containingService.getSecuritySchemes().isEmpty()) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SoaPackage.Literals.INTERFACE__OWNED_OPERATIONS,
				 SoaFactory.eINSTANCE.createOperation()));
	}
