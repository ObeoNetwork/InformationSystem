...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.soa.ImplementationComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ImplementationComponent_implement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ImplementationComponent_implement_feature", "_UI_ImplementationComponent_type"),
				 SoaPackage.Literals.IMPLEMENTATION_COMPONENT__IMPLEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEntitiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ImplementationComponent_entities_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ImplementationComponent_entities_feature", "_UI_ImplementationComponent_type"),
				 SoaPackage.Literals.IMPLEMENTATION_COMPONENT__ENTITIES,
				 true,
				 false,
				 true,
				 null,
