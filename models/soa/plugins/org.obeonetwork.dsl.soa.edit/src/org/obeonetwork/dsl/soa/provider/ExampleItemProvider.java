...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.soa.Example} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExampleItemProvider extends ObeoDSMObjectItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Example_summary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Example_summary_feature", "_UI_Example_type"),
				 SoaPackage.Literals.EXAMPLE__SUMMARY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SoaPackage.Literals.EXAMPLE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
