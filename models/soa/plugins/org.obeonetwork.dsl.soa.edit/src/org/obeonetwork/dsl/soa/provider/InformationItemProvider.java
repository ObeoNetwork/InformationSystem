...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.soa.Information} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addTermsOfServicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Information_termsOfService_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Information_termsOfService_feature", "_UI_Information_type"),
				 SoaPackage.Literals.INFORMATION__TERMS_OF_SERVICE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
