...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.soa.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SoaPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoaPackage.Literals.CATEGORY__OWNED_CATEGORIES);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(EnvironmentPackage.Literals.TYPES_DEFINITION__TYPES,
				 SoaFactory.eINSTANCE.createServiceDTO()));

		newChildDescriptors.add
			(createChildParameter
				(SoaPackage.Literals.CATEGORY__OWNED_CATEGORIES,
