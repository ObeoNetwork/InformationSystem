...
public class ServicePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ServicePropertiesEditionPart {
	...
	public void initSynchronization(Object input, Enumerator current) {
		...
		boolean readOnly = isReadOnly(SoaViewsRepository.Service.Properties.synchronization);
		if (readOnly && synchronization.isEnabled()) {
			synchronization.setEnabled(false);
			synchronization.setToolTipText(SoaMessages.Service_ReadOnly);
		} else if (!readOnly && !synchronization.isEnabled()) {
	...
	public void initKind(Object input, Enumerator current) {
		...
		boolean readOnly = isReadOnly(SoaViewsRepository.Service.Properties.kind);
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(SoaViewsRepository.Service.Properties.name);
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(SoaViewsRepository.Service.Properties.description);
