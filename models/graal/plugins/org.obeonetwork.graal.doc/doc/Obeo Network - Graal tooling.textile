...
Le graphe de tâches d'un _System_ est normalement créé automatiquement à la création d'une session.
...
* Depuis une tâche, un double-clic ou le menu _Navigate_ permettent de naviguer vers le plan d'action (_Actions Plan_) de la tâche. Si ce plan d'action n'existe pas, il est créé.
* Depuis un groupe de tâches, un double-clic ou le menu _Navigate_ permettent de naviguer vers le graphe de tâches (_Tasks Graph_) du groupe. Si ce graphe de tâches n'existe pas, il est créé.
* Depuis un système, un double-clic ou le menu _Navigate_ permettent de naviguer vers le graphe de tâches (_Tasks Graph_) du système. Si ce graphe de tâches n'existe pas, il est créé.
...
Il est possible de naviguer depuis ce diagramme vers d'autres diagrammes :
* Depuis un noeud pointant vers une tâche, un double-clic ou le menu _Navigate_ permettent de naviguer vers le plan d'action (_Actions Plan_) de la tâche. Si ce plan d'action n'existe pas, il est créé.
...
Le graphe des acteurs d'un _System_ est normalement créé automatiquement à la création d'une session.
...
Il est possible de naviguer depuis ce diagramme vers d'autres diagrammes :
* Depuis un use case, un double-clic ou le menu _Navigate_ permettent de naviguer vers le diagramme de use case (_Use Case Diagram_) du use case concerné.
...
Il est possible de naviguer depuis ce diagramme vers d'autres diagrammes :
* Depuis une tâche, un double-clic ou le menu _Navigate_ permettent de naviguer vers le plan d'action (_Actions Plan_) de cette tâche.
...
Il estpossible d'attacher de la documentation aux éléments d'un modèle Graal. Le mécanisme utilisé est le mécanisme transverse de gestion de la documentation fourni par l'outillage.
