__Copyright (c) Obeo 2011, 2017 -  All rights reserved. This program and the accompanying materials are made available under the terms of the Eclipse Public License v1.0__
...
La création de nouveaux éléments se fait dans l'arbre par le menu contextuel _New Child_  du conteneur où l'on souhaite créer l'élément. Ainsi pour créer une nouvelle tâche dans un système, il faut invoquer, depuis le système voulu, le menu :
...
!pics/requirements/New task traceability.png!
...
!pics/requirements/Task traceability matrix.png!
...
!pics/requirements/Use case traceability matrix.png!
