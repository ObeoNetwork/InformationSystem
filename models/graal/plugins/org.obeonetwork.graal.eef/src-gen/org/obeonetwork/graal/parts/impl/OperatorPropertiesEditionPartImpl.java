 ...
 * 
 */
public class OperatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OperatorPropertiesEditionPart {
	 ...
	 * 
	 */
	public OperatorPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(Composite view) { 
		CompositionSequence operatorStep = new BindingCompositionSequence(propertiesEditionComponent);
		CompositionStep propertiesStep = operatorStep.addStep(GraalViewsRepository.Operator.Properties.class);
		propertiesStep.addStep(GraalViewsRepository.Operator.Properties.kind);
		propertiesStep.addStep(GraalViewsRepository.Operator.Properties.description);
		propertiesStep.addStep(GraalViewsRepository.Operator.Properties.outgoingTransitions);
		propertiesStep.addStep(GraalViewsRepository.Operator.Properties.incomingTransitions);
		
		
		composer = new PartComposer(operatorStep) {

			@Override
			public Composite addToPart(Composite parent, Object key) {
				if (key == GraalViewsRepository.Operator.Properties.class) {
					return createPropertiesGroup(parent);
				}
				if (key == GraalViewsRepository.Operator.Properties.kind) {
					return createKindEMFComboViewer(parent);
				}
				if (key == GraalViewsRepository.Operator.Properties.description) {
					return createDescriptionTextarea(parent);
				}
				if (key == GraalViewsRepository.Operator.Properties.outgoingTransitions) {
					return createOutgoingTransitionsAdvancedReferencesTable(parent);
				}
				if (key == GraalViewsRepository.Operator.Properties.incomingTransitions) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(GraalMessages.OperatorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(GraalViewsRepository.Operator.Properties.kind, GraalViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionTextarea(Composite parent) {
		Label descriptionLabel = createDescription(parent, GraalViewsRepository.Operator.Properties.description, GraalMessages.OperatorPropertiesEditionPart_DescriptionLabel);
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}

		});
		EditingUtils.setID(description, GraalViewsRepository.Operator.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Textarea"); //$NON-NLS-1$
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(GraalViewsRepository.Operator.Properties.description, GraalViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOutgoingTransitionsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(GraalViewsRepository.Operator.Properties.outgoingTransitions, GraalMessages.OperatorPropertiesEditionPart_OutgoingTransitionsLabel);		 
		...
		this.outgoingTransitions.setHelpText(propertiesEditionComponent.getHelpContent(GraalViewsRepository.Operator.Properties.outgoingTransitions, GraalViewsRepository.SWT_KIND));
		...
		this.outgoingTransitions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.outgoingTransitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"outgoingTransitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.outgoingTransitions,
	...
	protected void moveOutgoingTransitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.outgoingTransitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outgoingTransitions.refresh();
	}
	...
	protected void removeFromOutgoingTransitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.outgoingTransitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outgoingTransitions.refresh();
	}
	...
	protected Composite createIncomingTransitionsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(GraalViewsRepository.Operator.Properties.incomingTransitions, GraalMessages.OperatorPropertiesEditionPart_IncomingTransitionsLabel);		 
		...
		this.incomingTransitions.setHelpText(propertiesEditionComponent.getHelpContent(GraalViewsRepository.Operator.Properties.incomingTransitions, GraalViewsRepository.SWT_KIND));
		this.incomingTransitions.createControls(parent);
		this.incomingTransitions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.incomingTransitions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		incomingTransitions.setID(GraalViewsRepository.Operator.Properties.incomingTransitions);
	...
	protected void addIncomingTransitions() {
		...
		"incomingTransitions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.incomingTransitions,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIncomingTransitions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.incomingTransitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incomingTransitions.refresh();
	}
	...
	protected void removeFromIncomingTransitions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OperatorPropertiesEditionPartImpl.this, GraalViewsRepository.Operator.Properties.incomingTransitions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingTransitions.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#getKind()
	 * 
	 */
	...
	public void initKind(Object input, Enumerator current) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.Operator.Properties.kind);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#setKind(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#getDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#setDescription(String newValue)
	 * 
	 */
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.Operator.Properties.description);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#initOutgoingTransitions(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initOutgoingTransitions(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.Operator.Properties.outgoingTransitions);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#updateOutgoingTransitions()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#addFilterOutgoingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#addBusinessFilterOutgoingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#isContainedInOutgoingTransitionsTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#initIncomingTransitions(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initIncomingTransitions(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.Operator.Properties.incomingTransitions);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#updateIncomingTransitions()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#addFilterIncomingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#addBusinessFilterIncomingTransitions(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.obeonetwork.graal.parts.OperatorPropertiesEditionPart#isContainedInIncomingTransitionsTable(EObject element)
	 * 
	 */
