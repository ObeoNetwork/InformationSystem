...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.graal.TaskReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskReferenceItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskReference"));
	}
	...
	public String getText(Object object) {
		String label = null;
		TaskReference taskRef = (TaskReference)object;
		if (taskRef.getTask() != null) {
			label = ((Task)taskRef.getTask()).getName();
		} else {
			label = crop(((TaskReference)object).getDescription());
		}
		return label == null || label.length() == 0 ?
			getString("_UI_TaskReference_type") :
			getString("_UI_TaskReference_type") + " " + label;
	}
