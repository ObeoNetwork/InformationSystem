...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.graal.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraalPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractTask_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractTask_id_feature", "_UI_AbstractTask_type"),
				 GraalPackage.Literals.ABSTRACT_TASK__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_uses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_uses_feature", "_UI_Task_type"),
				 GraalPackage.Literals.TASK__USES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPreconditionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_preconditions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_preconditions_feature", "_UI_Task_type"),
				 GraalPackage.Literals.TASK__PRECONDITIONS,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPostconditionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_postconditions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_postconditions_feature", "_UI_Task_type"),
				 GraalPackage.Literals.TASK__POSTCONDITIONS,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addActorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_actors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_actors_feature", "_UI_Task_type"),
				 GraalPackage.Literals.TASK__ACTORS,
				 true,
				 false,
				 true,
				 null,
