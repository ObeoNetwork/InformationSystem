...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.graal.DomainClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainClassItemProvider extends StructuredTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainClass_estimatedVolumetry_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainClass_estimatedVolumetry_feature", "_UI_DomainClass_type"),
				 GraalPackage.Literals.DOMAIN_CLASS__ESTIMATED_VOLUMETRY,
				 true,
				 false,
				 false,
	...
	protected void addHistorizedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainClass_historized_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainClass_historized_feature", "_UI_DomainClass_type"),
				 GraalPackage.Literals.DOMAIN_CLASS__HISTORIZED,
				 true,
				 false,
				 false,
