 ...
 * 
 */
public class TasksGroupPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TasksGroupPropertiesEditionPart {
	 ...
	 * 
	 */
	public TasksGroupPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(GraalMessages.TasksGroupPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TasksGroupPropertiesEditionPartImpl.this, GraalViewsRepository.TasksGroup.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(GraalViewsRepository.TasksGroup.Properties.id, GraalViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TasksGroupPropertiesEditionPartImpl.this, GraalViewsRepository.TasksGroup.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(GraalViewsRepository.TasksGroup.Properties.name, GraalViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionTextarea(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TasksGroupPropertiesEditionPartImpl.this, GraalViewsRepository.TasksGroup.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}

		});
		EditingUtils.setID(description, GraalViewsRepository.TasksGroup.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Textarea"); //$NON-NLS-1$
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(GraalViewsRepository.TasksGroup.Properties.description, GraalViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	public void setId(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.TasksGroup.Properties.id);
	...
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.TasksGroup.Properties.name);
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GraalViewsRepository.TasksGroup.Properties.description);
