...
public class UserViewUserViewPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (userView.getDescription() != null && isAccessible(GraalViewsRepository.UserView.Properties.description))
				userViewPart.setDescription(EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, userView.getDescription()));
			if (userView.getName() != null && isAccessible(GraalViewsRepository.UserView.Properties.name))
			...
			userViewPart.addFilterToOutgoingTransitions(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!userViewPart.isContainedInOutgoingTransitionsTable((EObject)element));
			...
			userViewPart.addFilterToIncomingTransitions(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!userViewPart.isContainedInIncomingTransitionsTable((EObject)element));
					return element instanceof Resource;
				}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (EnvironmentPackage.eINSTANCE.getObeoDSMObject_Description().equals(msg.getFeature()) && userViewPart != null && isAccessible(GraalViewsRepository.UserView.Properties.description)){
			...
			if (GraalPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && userViewPart != null && isAccessible(GraalViewsRepository.UserView.Properties.name)) {
				if (msg.getNewValue() != null) {
