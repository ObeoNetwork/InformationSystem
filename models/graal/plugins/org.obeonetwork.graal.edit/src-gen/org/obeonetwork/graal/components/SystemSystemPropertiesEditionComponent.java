...
public class SystemSystemPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (system.getDescription() != null && isAccessible(GraalViewsRepository.System.Properties.description))
				systemPart.setDescription(EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, system.getDescription()));
			if (system.getName() != null && isAccessible(GraalViewsRepository.System.Properties.name))
			...
			systemPart.addFilterToDtoCategories(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!systemPart.isContainedInDtoCategoriesTable((EObject)element));
			...
			systemPart.addFilterToDtos(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!systemPart.isContainedInDtosTable((EObject)element));
					return element instanceof Resource;
				}
			...
			systemPart.addFilterToEntityBlocks(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!systemPart.isContainedInEntityBlocksTable((EObject)element));
					return element instanceof Resource;
				}
			...
			systemPart.addFilterToEntities(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!systemPart.isContainedInEntitiesTable((EObject)element));
					return element instanceof Resource;
				}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (EnvironmentPackage.eINSTANCE.getObeoDSMObject_Description().equals(msg.getFeature()) && systemPart != null && isAccessible(GraalViewsRepository.System.Properties.description)){
