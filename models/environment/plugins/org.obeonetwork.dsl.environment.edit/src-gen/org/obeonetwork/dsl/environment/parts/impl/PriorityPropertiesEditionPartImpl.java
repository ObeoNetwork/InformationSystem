...
public class PriorityPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PriorityPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(EnvironmentViewsRepository.Priority.Properties.name);
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(EnvironmentViewsRepository.Priority.Properties.description);
