...
public class TypesDefinitionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, TypesDefinitionPropertiesEditionPart {
	...
	protected Composite createDescriptionTextarea(FormToolkit widgetFactory, Composite parent) {
		Label descriptionLabel = createDescription(parent, EnvironmentViewsRepository.TypesDefinition.Properties.description, EnvironmentMessages.TypesDefinitionPropertiesEditionPart_DescriptionLabel);
