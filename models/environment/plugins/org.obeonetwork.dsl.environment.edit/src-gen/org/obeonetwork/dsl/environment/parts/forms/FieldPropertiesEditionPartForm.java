...
public class FieldPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FieldPropertiesEditionPart {
	...
	public void setName(String newValue) {
		...
		boolean readOnly = isReadOnly(EnvironmentViewsRepository.Field.Properties.name);
	...
	public void setDescription(String newValue) {
		...
		boolean readOnly = isReadOnly(EnvironmentViewsRepository.Field.Properties.description);
