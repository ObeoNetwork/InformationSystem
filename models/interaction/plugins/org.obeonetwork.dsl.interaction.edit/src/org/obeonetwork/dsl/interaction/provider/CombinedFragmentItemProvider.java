...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.interaction.CombinedFragment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CombinedFragmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CombinedFragment_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CombinedFragment_operator_feature", "_UI_CombinedFragment_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InteractionPackage.Literals.COMBINED_FRAGMENT__COVERED_PARTICIPANTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InteractionPackage.Literals.COMBINED_FRAGMENT__OWNED_OPERANDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InteractionPackage.Literals.COMBINED_FRAGMENT__OWNED_OPERANDS,
