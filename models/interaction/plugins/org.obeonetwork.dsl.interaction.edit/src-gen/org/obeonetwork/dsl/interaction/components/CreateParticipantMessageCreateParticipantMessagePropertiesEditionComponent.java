...
public class CreateParticipantMessageCreateParticipantMessagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (createParticipantMessage.getName() != null && isAccessible(InteractionViewsRepository.CreateParticipantMessage.Properties.name))
			...
			if (createParticipantMessage.getDescription() != null && isAccessible(InteractionViewsRepository.CreateParticipantMessage.Properties.description))
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (InteractionPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && createParticipantMessagePart != null && isAccessible(InteractionViewsRepository.CreateParticipantMessage.Properties.name)) {
			...
			if (EnvironmentPackage.eINSTANCE.getObeoDSMObject_Description().equals(msg.getFeature()) && createParticipantMessagePart != null && isAccessible(InteractionViewsRepository.CreateParticipantMessage.Properties.description)) {
				if (msg.getNewValue() != null) {
