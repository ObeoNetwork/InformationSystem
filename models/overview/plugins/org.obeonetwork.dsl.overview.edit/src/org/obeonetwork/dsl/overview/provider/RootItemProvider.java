 ...
 *******************************************************************************/
package org.obeonetwork.dsl.overview.provider;
...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.overview.Root} object.
...
public class RootItemProvider extends ObeoDSMObjectItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OverviewPackage.Literals.ROOT__OWNED_ELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Root.class)) {
			case OverviewPackage.ROOT__OWNED_ELEMENTS:
	...
	protected void collectNewChildDescriptors(
		...
		if (object instanceof Root) {
			...
			Collection<OverviewModelDef> overviewModelDefs = OverviewModelDefRegistry
			...
			if (overviewModelDefs != null) {
				for (OverviewModelDef overviewModelDef : overviewModelDefs) {
					if(overviewModelDef.isApplicable(root)){
						Collection<?> childDescriptors = overviewModelDef
								.getNewChildDescriptors(root);
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify =
			...
			childFeature == OverviewPackage.Literals.ROOT__OWNED_ELEMENTS;
