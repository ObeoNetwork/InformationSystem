...
import org.obeonetwork.dsl.overview.editor.actions.ImportResourceAction;
 ...
 * @generated
 */
public class OverviewActionBarContributor extends
		EditingDomainActionBarContributor implements ISelectionChangedListener {

	/**
	 * This is the action used to import a resource.
	 */
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(OverviewEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(OverviewEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		...
		if (importResourceAction != null) {
			menuManager.insertBefore("additions-end",
					new ActionContributionItem(importResourceAction));
