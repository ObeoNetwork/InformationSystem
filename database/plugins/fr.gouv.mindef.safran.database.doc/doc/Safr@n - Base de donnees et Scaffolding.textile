...
h1. Safr@n - Base de données et Scaffolding
...
Il est possible de générer les scripts SQL pour générer complètement une base de données. Pour cela il suffit d'utiliser le menu clic droit sur le modèle et sélectionner _Safr@n > Generate SQL Scripts_ 
