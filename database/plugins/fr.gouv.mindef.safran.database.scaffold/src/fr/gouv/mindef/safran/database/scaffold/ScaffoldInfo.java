 ...
 * <ul>
 *   <li>{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getLeftObject <em>Left Object</em>}</li>
 *   <li>{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getRightObject <em>Right Object</em>}</li>
 *   <li>{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getLeftToRightAdditionalObjects <em>Left To Right Additional Objects</em>}</li>
 *   <li>{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getRightToLeftAdditionalObjects <em>Right To Left Additional Objects</em>}</li>
 *   <li>{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getTraceabilityInfos <em>Traceability Infos</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.gouv.mindef.safran.database.scaffold.ScaffoldPackage#getScaffoldInfo()
 * @model
 * @extends CDOObject
 * @generated
 */
public interface ScaffoldInfo extends CDOObject {
	 ...
	 * @generated
	 */
	String copyright = "Copyright (c) 2012, 2017 Obeo.\r\nAll rights reserved. This program and the accompanying materials\r\nare made available under the terms of the Eclipse Public License v1.0\r\nwhich accompanies this distribution, and is available at\r\nhttp://www.eclipse.org/legal/epl-v10.html\r\n\r\nContributors:\r\n    Obeo - initial API and implementation";
	 ...
	 * @see fr.gouv.mindef.safran.database.scaffold.ScaffoldPackage#getScaffoldInfo_LeftObject()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getLeftObject <em>Left Object</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.gouv.mindef.safran.database.scaffold.ScaffoldPackage#getScaffoldInfo_RightObject()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fr.gouv.mindef.safran.database.scaffold.ScaffoldInfo#getRightObject <em>Right Object</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.gouv.mindef.safran.database.scaffold.ScaffoldPackage#getScaffoldInfo_LeftToRightAdditionalObjects()
	 * @model
	 * @generated
	 */
	 ...
	 * @see fr.gouv.mindef.safran.database.scaffold.ScaffoldPackage#getScaffoldInfo_RightToLeftAdditionalObjects()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.gouv.mindef.safran.database.scaffold.TraceabilityInfo}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.gouv.mindef.safran.database.scaffold.ScaffoldPackage#getScaffoldInfo_TraceabilityInfos()
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model mapType="fr.gouv.mindef.safran.database.scaffold.EObjectToEObjectMap<org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EObject>" scaffoldTypeRequired="true"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model scaffoldTypeRequired="true" infosMapType="fr.gouv.mindef.safran.database.scaffold.EObjectToEObjectMap<org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EObject>"
	 * @generated
	 */
