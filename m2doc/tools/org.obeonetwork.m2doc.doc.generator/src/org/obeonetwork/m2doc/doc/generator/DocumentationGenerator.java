...
public class DocumentationGenerator {
	...
	private static List<Configuration> initializeConfigurations() {
		...
		res.add(new Configuration(gitRepoRootPath + "m2doc/entity/plugins/",      "org.obeonetwork.dsl.entity.m2doc.services",      "Entity",      new String[] { "org.obeonetwork.dsl.entity.m2doc.services" },      new String[] { "org.obeonetwork.dsl.entity" },      new String[] { gitRepoRootPath + "designs/entity/plugins/org.obeonetwork.dsl.entity.design/description/entity.odesign", gitRepoRootPath + "addons/structuredtypes/plugins/org.obeonetwork.is.design/description/safran-is.odesign" }));
		res.add(new Configuration(gitRepoRootPath + "m2doc/soa/plugins/",         "org.obeonetwork.dsl.soa.m2doc.services",         "SOA",         new String[] { "org.obeonetwork.dsl.soa.m2doc.services" },         new String[] { "org.obeonetwork.dsl.soa" },         new String[] { gitRepoRootPath + "designs/soa/plugins/org.obeonetwork.dsl.soa.design/description/soa.odesign", gitRepoRootPath + "addons/structuredtypes/plugins/org.obeonetwork.is.design/description/safran-is.odesign" }));
		res.add(new Configuration(gitRepoRootPath + "m2doc/graal/plugins/",       "org.obeonetwork.dsl.graal.m2doc.services",       "Graal",       new String[] { "org.obeonetwork.dsl.graal.m2doc.services" },       new String[] { "org.obeonetwork.graal" },           new String[] { gitRepoRootPath + "designs/graal/plugins/org.obeonetwork.graal.design/description/graal.odesign", gitRepoRootPath + "designs/graal/plugins/org.obeonetwork.graal.design/description/requirements.odesign", gitRepoRootPath + "addons/structuredtypes/plugins/org.obeonetwork.is.design/description/safran-is.odesign"}));
