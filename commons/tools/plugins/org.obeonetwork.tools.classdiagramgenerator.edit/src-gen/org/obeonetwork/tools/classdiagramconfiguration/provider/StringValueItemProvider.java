...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.tools.classdiagramconfiguration.StringValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramConfigurationPackage.Literals.STRING_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		String label = stringValue.getFullQualifiedId();
		label += " = ";
		label += stringValue.getValue();
		return label;
	}
