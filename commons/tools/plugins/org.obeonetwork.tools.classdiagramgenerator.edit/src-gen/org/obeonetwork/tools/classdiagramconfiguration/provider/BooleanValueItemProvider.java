...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.tools.classdiagramconfiguration.BooleanValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanValueItemProvider
	extends ConfigurationValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramConfigurationPackage.Literals.BOOLEAN_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		String label = booleanValue.getFullQualifiedId();
		label += " = ";
		label += booleanValue.isValue();
		return  label;
	}
