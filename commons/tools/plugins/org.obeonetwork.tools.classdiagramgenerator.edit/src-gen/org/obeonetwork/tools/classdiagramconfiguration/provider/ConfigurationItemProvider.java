...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.tools.classdiagramconfiguration.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addJavaExtensionsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramConfigurationPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramConfigurationPackage.Literals.CONFIGURATION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addViewpointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_viewpoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_viewpoint_feature", "_UI_Configuration_type"),
				 ClassDiagramConfigurationPackage.Literals.CONFIGURATION__VIEWPOINT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Java Extensions feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addJavaExtensionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_javaExtensions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_javaExtensions_feature", "_UI_Configuration_type"),
				 ClassDiagramConfigurationPackage.Literals.CONFIGURATION__JAVA_EXTENSIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ClassDiagramConfigurationPackage.Literals.CONFIGURATION__DIAGRAMS);
			childrenFeatures.add(ClassDiagramConfigurationPackage.Literals.CONFIGURATION__COLORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ClassDiagramConfigurationPackage.Literals.CONFIGURATION__DIAGRAMS,
				 ClassDiagramConfigurationFactory.eINSTANCE.createDiagramConf()));

		newChildDescriptors.add
			(createChildParameter
				(ClassDiagramConfigurationPackage.Literals.CONFIGURATION__COLORS,
				 ClassDiagramConfigurationFactory.eINSTANCE.createColorInfo()));
	}
