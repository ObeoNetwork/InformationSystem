...
public class ManifestAdapterFactory extends AdapterFactoryImpl {
	...
	protected ManifestSwitch<Adapter> modelSwitch =
		new ManifestSwitch<Adapter>() {
			@Override
			public Adapter caseMManifest(MManifest object) {
				return createMManifestAdapter();
			}
			@Override
			public Adapter caseMImportExportData(MImportExportData object) {
				return createMImportExportDataAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.dsl.manifest.MManifest <em>MManifest</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMManifestAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.dsl.manifest.MImportExportData <em>MImport Export Data</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMImportExportDataAdapter() {
		return null;
	}
