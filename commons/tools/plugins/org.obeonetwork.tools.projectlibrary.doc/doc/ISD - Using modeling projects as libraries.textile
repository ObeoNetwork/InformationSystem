...
* *MAR filename* Le nom de fichier de la bibliothèque (se terminant par l'extension de fichier .mar). Cette valeur est recalculée lorsque l'ID du projet ou la version est modifiée, mais elle peut être remplacée si nécessaire.
