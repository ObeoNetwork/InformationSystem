...
public class SessionUtils {
	...
	/**
	 * Returns the main analysis for a session for a local project this is the root analysis for a remote
	 * project this is the first remote analysis referenced by the local root analysis
	 * 
	 * @param session
	 * @return
	 */
