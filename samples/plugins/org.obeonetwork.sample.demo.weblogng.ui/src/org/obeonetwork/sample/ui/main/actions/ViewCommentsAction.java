...
import org.obeonetwork.sample.ui.main.forms.ViewCommentsForm;


import org.obeonetwork.sample.weblog.IWebLogService;

// End of user code for import


/**
 * Implementation of <strong>ViewComments Action</strong>
 * Scenario : ViewComments
 *
 */
public class ViewCommentsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ViewCommentsAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ViewCommentsForm viewCommentsForm = (ViewCommentsForm)form;
