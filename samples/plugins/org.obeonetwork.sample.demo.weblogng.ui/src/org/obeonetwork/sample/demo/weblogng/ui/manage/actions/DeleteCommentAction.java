...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.DeleteCommentForm;
...
/**
 * Implementation of <strong>DeleteComment Action</strong>
 * Scenario : Manage
 *
 */
public class DeleteCommentAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(DeleteCommentAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		DeleteCommentForm deleteCommentForm = (DeleteCommentForm)form;
