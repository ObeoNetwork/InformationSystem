...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.DeleteTagForm;
...
/**
 * Implementation of <strong>DeleteTag Action</strong>
 * Scenario : Manage
 *
 */
public class DeleteTagAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(DeleteTagAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		DeleteTagForm deleteTagForm = (DeleteTagForm)form;
