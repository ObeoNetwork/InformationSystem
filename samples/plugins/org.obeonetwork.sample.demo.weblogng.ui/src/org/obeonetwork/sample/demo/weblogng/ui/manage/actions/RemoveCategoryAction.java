...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.RemoveCategoryForm;
...
/**
 * Implementation of <strong>RemoveCategory Action</strong>
 * Scenario : Manage
 *
 */
public class RemoveCategoryAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(RemoveCategoryAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RemoveCategoryForm removeCategoryForm = (RemoveCategoryForm)form;
