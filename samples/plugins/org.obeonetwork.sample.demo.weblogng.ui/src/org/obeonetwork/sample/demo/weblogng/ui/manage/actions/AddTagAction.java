...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.AddTagForm;
...
/**
 * Implementation of <strong>AddTag Action</strong>
 * Scenario : Manage
 *
 */
public class AddTagAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(AddTagAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		AddTagForm addTagForm = (AddTagForm)form;
