...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.CreateTagForm;
...
/**
 * Implementation of <strong>CreateTag Action</strong>
 * Scenario : Manage
 *
 */
public class CreateTagAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(CreateTagAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CreateTagForm createTagForm = (CreateTagForm)form;
