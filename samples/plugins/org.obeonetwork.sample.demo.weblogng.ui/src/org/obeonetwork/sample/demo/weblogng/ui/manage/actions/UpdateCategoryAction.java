...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.UpdateCategoryForm;
...
/**
 * Implementation of <strong>UpdateCategory Action</strong>
 * Scenario : Manage
 *
 */
public class UpdateCategoryAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(UpdateCategoryAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		UpdateCategoryForm updateCategoryForm = (UpdateCategoryForm)form;
