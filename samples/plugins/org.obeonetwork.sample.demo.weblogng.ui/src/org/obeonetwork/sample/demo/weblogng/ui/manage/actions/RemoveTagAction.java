...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.RemoveTagForm;
...
/**
 * Implementation of <strong>RemoveTag Action</strong>
 * Scenario : Manage
 *
 */
public class RemoveTagAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(RemoveTagAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RemoveTagForm removeTagForm = (RemoveTagForm)form;
