package org.obeonetwork.sample.demo.weblogng.ui.manage.actions;
...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.CreateCategoryForm;
...
/**
 * Implementation of <strong>CreateCategory Action</strong>
 * Scenario : Manage
 *
 */
public class CreateCategoryAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(CreateCategoryAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CreateCategoryForm createCategoryForm = (CreateCategoryForm)form;
