...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.ManageTagsForm;
...
/**
 * Implementation of <strong>ManageTags Action</strong>
 * Scenario : Manage
 *
 */
public class ManageTagsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ManageTagsAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ManageTagsForm manageTagsForm = (ManageTagsForm)form;
