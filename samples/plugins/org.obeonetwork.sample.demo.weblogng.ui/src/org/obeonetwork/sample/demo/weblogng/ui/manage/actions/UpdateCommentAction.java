...
import org.obeonetwork.sample.demo.weblogng.ui.manage.forms.UpdateCommentForm;
...
/**
 * Implementation of <strong>UpdateComment Action</strong>
 * Scenario : Manage
 *
 */
public class UpdateCommentAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(UpdateCommentAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		UpdateCommentForm updateCommentForm = (UpdateCommentForm)form;
