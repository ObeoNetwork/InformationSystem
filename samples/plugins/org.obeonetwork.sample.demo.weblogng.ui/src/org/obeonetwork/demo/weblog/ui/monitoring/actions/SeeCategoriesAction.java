package org.obeonetwork.demo.weblog.ui.monitoring.actions;
...
import org.obeonetwork.demo.weblog.ui.monitoring.forms.SeeCategoriesForm;
...
/**
 * Implementation of <strong>SeeCategories Action</strong>
 * Scenario : Monitoring
 *
 */
public class SeeCategoriesAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(SeeCategoriesAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SeeCategoriesForm seeCategoriesForm = (SeeCategoriesForm)form;
