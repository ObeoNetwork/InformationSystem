...
import org.obeonetwork.demo.weblog.ui.users.forms.EditAccountForm;
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		User userInSession = (User)request.getSession().getAttribute(UiConstants.CURRENT_USER);
		// Recuperation DAO sur table Users

		User user = userService.getUser(userInSession.getId());
		
		editAccountForm.setFirstName(user.getFirstName());
		editAccountForm.setLastName(user.getLastName());
		editAccountForm.setEmail(user.getEmail());
		editAccountForm.setLogin(user.getLogin());
		editAccountForm.setPassword(user.getPassword());
		//End of user code 
