...
import org.obeonetwork.demo.weblog.ui.monitoring.forms.SeeTagsForm;
...
/**
 * Implementation of <strong>SeeTags Action</strong>
 * Scenario : Monitoring
 *
 */
public class SeeTagsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(SeeTagsAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SeeTagsForm seeTagsForm = (SeeTagsForm)form;
