...
import org.obeonetwork.demo.weblog.ui.monitoring.forms.SeeUsersForm;
...
/**
 * Implementation of <strong>SeeUsers Action</strong>
 * Scenario : Monitoring
 *
 */
public class SeeUsersAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(SeeUsersAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SeeUsersForm seeUsersForm = (SeeUsersForm)form;
