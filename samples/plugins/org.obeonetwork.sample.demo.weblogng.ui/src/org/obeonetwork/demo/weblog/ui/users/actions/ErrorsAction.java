...
import org.obeonetwork.demo.weblog.ui.users.forms.ErrorsForm;
...
/**
 * Implementation of <strong>Errors Action</strong>
 * Scenario : Errors
 *
 */
public class ErrorsAction extends org.apache.struts.actions.DispatchAction {
    /**
     * Commons Logging instance.
     */
     private final static Log LOG = LogFactory.getLog(ErrorsAction.class);
...
//End of user code
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ErrorsForm errorsForm = (ErrorsForm)form;

		//Start of user code method init
		errorsForm.setMessage((String)request.getAttribute(UiConstants.MESSAGE));
		//End of user code 
