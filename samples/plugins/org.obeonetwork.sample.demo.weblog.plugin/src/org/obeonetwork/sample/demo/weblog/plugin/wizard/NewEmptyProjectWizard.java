...
public class NewEmptyProjectWizard
	...
	protected Collection getProjectDescriptors() {
		...
		projects.add(new ProjectDescriptor("org.obeonetwork.sample.demo.weblog.plugin", "zips/org.obeonetwork.newproject.zip", "org.obeonetwork.newproject"));  //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$
		return projects;
	}
