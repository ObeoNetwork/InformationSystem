...
public class BlogEntry implements Serializable {
	 ...
	 * @param authorUser. 
	 */
	public BlogEntry(Collection<Category> categories, String title, Collection<Tag> tags, Date creationDate, Collection<Comment> comments, String content, User authorUser) {
		this();
