...
/** End of user code */
	...
	var HomeMenuLeft = {},
		_Class = Em.View.extend({ templateName : "home-menu-left" });

	
	
	/*
	 */
	HomeMenuLeft.create = function() {
		ViewUtil.loadWidgetTemplate("./asset/template/widget/other/home-menu-left");
	...
	HomeMenuLeft.getClass = function() { return _Class; };
