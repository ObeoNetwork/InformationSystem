...
/** End of user code */
	...
	/*
	 * create a UserStats widget
	 * @return the UserStats widget instance
	 */
	UserStats.create = function() {
		...
		var view = _Class.create({
			...
			didInsertElement : function() {App.commonCtrl.loadUserStatsInWidget(this);},
