...
/** End of user code */
	...
	/*
	 * create a ChocoStats widget
	 * @return the ChocoStats widget instance
	 */
	ChocoStats.create = function() {
		...
		var view = _Class.create({
			...
			didInsertElement : function() {App.commonCtrl.loadChocoStatsInWidget(this);},
