...
public class BlogEntry implements Serializable {
	 ...
	 * @param comments. 
	 */
	public BlogEntry(String title, String content, User authorUser, Date creationDate, Collection<Category> categories, Collection<Tag> tags, Collection<Comment> comments) {
		this();
		this.title = title;
