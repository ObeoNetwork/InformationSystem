 ...
 * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICommentDao
 */
public class HibernateCommentDao extends AbstractHibernateDAO<Comment> implements ICommentDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICommentDao.createComment
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICommentDao.updateComment
     */
	 ...
	 * @param comment Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICommentDao.deleteComment
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICommentDao.findAllComments
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICommentDao.findCommentById
     */
