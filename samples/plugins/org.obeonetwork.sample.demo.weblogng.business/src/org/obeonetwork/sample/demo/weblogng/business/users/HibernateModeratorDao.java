 ...
 * @see org.obeonetwork.sample.demo.weblogng.business.users.IModeratorDao
 */
public class HibernateModeratorDao extends AbstractHibernateDAO<Moderator> implements IModeratorDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IModeratorDao.createModerator
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IModeratorDao.updateModerator
     */
	 ...
	 * @param moderator Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IModeratorDao.deleteModerator
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IModeratorDao.findAllModerators
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IModeratorDao.findModeratorById
     */
