 ...
 * @see org.obeonetwork.sample.demo.weblogng.users.IAdminDao
 */
public class HibernateAdminDao extends AbstractHibernateDAO<Admin> implements IAdminDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.users.IAdminDao.createAdmin
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.users.IAdminDao.updateAdmin
     */
	 ...
	 * @param admin Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.users.IAdminDao.deleteAdmin
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.users.IAdminDao.findAllAdmins
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.users.IAdminDao.findAdminById
     */
