 ...
 * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICategoryDao
 */
public class HibernateCategoryDao extends AbstractHibernateDAO<Category> implements ICategoryDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICategoryDao.createCategory
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICategoryDao.updateCategory
     */
	 ...
	 * @param category Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICategoryDao.deleteCategory
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICategoryDao.findAllCategorys
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ICategoryDao.findCategoryById
     */
