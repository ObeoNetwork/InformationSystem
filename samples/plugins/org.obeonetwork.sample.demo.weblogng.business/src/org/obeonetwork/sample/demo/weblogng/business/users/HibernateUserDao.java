 ...
 * @see org.obeonetwork.sample.demo.weblogng.business.users.IUserDao
 */
public class HibernateUserDao extends AbstractHibernateDAO<User> implements IUserDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IUserDao.createUser
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IUserDao.updateUser
     */
	 ...
	 * @param user Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IUserDao.deleteUser
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IUserDao.findAllUsers
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.users.IUserDao.findUserById
     */
