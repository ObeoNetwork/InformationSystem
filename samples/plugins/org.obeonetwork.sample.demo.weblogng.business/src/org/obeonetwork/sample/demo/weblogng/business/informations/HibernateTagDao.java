 ...
 * @see org.obeonetwork.sample.demo.weblogng.business.informations.ITagDao
 */
public class HibernateTagDao extends AbstractHibernateDAO<Tag> implements ITagDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ITagDao.createTag
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ITagDao.updateTag
     */
	 ...
	 * @param tag Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ITagDao.deleteTag
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ITagDao.findAllTags
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.business.informations.ITagDao.findTagById
     */
