 ...
 * @see org.obeonetwork.sample.demo.weblogng.blog.IBlogEntryDao
 */
public class HibernateBlogEntryDao extends AbstractHibernateDAO<BlogEntry> implements IBlogEntryDao {
     ...
     * @see org.obeonetwork.sample.demo.weblogng.blog.IBlogEntryDao.createBlogEntry
     */
     ...
     *            Element to update. If the element has an id,it may use it. 
     	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.blog.IBlogEntryDao.updateBlogEntry
     */
	 ...
	 * @param blogEntry Element which will be deleted. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.blog.IBlogEntryDao.deleteBlogEntry
   	 */
	 ...
	 * @return A list with all elements, without any filter. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.blog.IBlogEntryDao.findAllBlogEntrys
     */
	 ...
	 * @return The entity found. 
	 	 * @throws DaoException If an HibernateException occurs.
     * @see org.obeonetwork.sample.demo.weblogng.blog.IBlogEntryDao.findBlogEntryById
     */
