...
!pics/SOA Views Viewpoint Selection.png!
...
!pics/SOA representations on Components.png!
...
| !pics/soa/Create component.png! | Création d'un composant métier. |
| !pics/soa/Create provided.png! | Création d'un service métier fourni par un composant. |
| !pics/soa/Create required.png! | Création d'un service métier requis par un composant. |
| !pics/soa/Create wire.png! | Création d'un lien depuis un service requis vers un service fourni. Permet d'indiquer quel composant fournit les services nécessaires au fonctionnement d'un autre composant. |
| !pics/soa/Create external.png! | Ajout d'un composant externe sur le diagramme. Cet outil permet de faire apparaitre un composant défini dans un autre modèle SOA pour créer des relations avec les composants affichés. Cet outil est activable via le calque _External Components |
...
!pics/contract/Component contract diagram.png!
...
| !pics/contract/Create provided.png! | Création d'un service métier fourni par un composant. |
| !pics/contract/Create required.png! | Création d'un service métier requis par un composant. |
| !pics/contract/Create operation.png! | Création d'une opération dans un service. |
| !pics/contract/Create input.png! | Création d'un paramètre d'entrée. |
| !pics/contract/Create output.png! | Création d'un paramètre de sortie. |
| !pics/contract/Create fault.png! | Création d'un cas d'erreur. |
...
| !pics/dto/Create namespace.png! | Création d'un sous-package. |
| !pics/dto/Create dto.png! | Création d'une entité. |
| !pics/dto/Create dto from entity.png! | Création de DTOs à partir d'entités. |
| !pics/dto/Create attribute.png! | Création d'un attribut de DTO. |
| !pics/dto/Create enumeration.png! | Création d'une énumération. |
| !pics/dto/Create literal.png! | Création d'une valeur d'énumération. |
| !pics/dto/Create relation.png! | Création d'une relation simple. |
| !pics/dto/Create composition.png! | Création d'une relation de composition. |
| !pics/dto/Create inheritance.png! | Création d'un lien d'héritage. |
| !pics/dto/Create bidi relation.png! | Création d'une relation simple bidirectionnelle. |
| !pics/dto/Create bidi composition.png! | Création d'une relation de contenance bidirectionnelle. |
| !pics/dto/Create external.png! | Ajout d'un DTO externe. Cet outil permet de faire apparaitre un DTO défini dans un autre package pour créer des relations avec les DTOs du package courant. Cet outil est activable via le calque _External DTOs |
...
!pics/dto/Dlg dto from entity.png!
