...
Lorsqu'il existe au moins une définition de _SecurityScheme_ dans le _Component_, alors une section _Security_ apparaît dans l'onglet _Exposition_ de la vue des propriétés d'une _Operation_ ou d'un _Service_ :
...
Quand au moins un Security Scheme est appliqué à une Operation (soit directement, soit indirectement via son Service parent), son icone dans la vue _Model Explorer_ est elle aussi décorée avec l'icone !pics/exposition/Icon_SecurityScheme.gif! :
