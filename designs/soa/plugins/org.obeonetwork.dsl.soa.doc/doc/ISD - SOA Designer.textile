...
- *Open ID:*
!{width:51.5%}pics/securityschemes/Dialog_SecurityScheme_Edition_OpenID.png!

- *OAuth2:*
!pics/securityschemes/Dialog_SecurityScheme_Edition_OAuth2.png!

Les _Security Scheme_ de type OAuth2 requièrent la spécification de _Flows_, ainsi que leurs _Scopes_ respectifs:
...
Un double-clic sur un _Security Scheme_ de type _OAUTH2_  dans l'onglet _Security_ ouvre une boîte de dialogue permettant de sélectionner les scopes à appliquer :
