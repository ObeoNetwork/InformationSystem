...
Le champ "Example" est un champ texte, destiné à reçevoir une sérialisation textuelle d'un exemple.

Le champ "Identifier" est un champ libre, le bouton "..." est une aide à la saisie qui permet de choisir parmis les types de média les plus courants :
