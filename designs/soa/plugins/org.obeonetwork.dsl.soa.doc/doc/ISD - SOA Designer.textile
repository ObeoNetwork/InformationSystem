...
Les attributs d'un DTO sont pourvus de champs _minimum_, _maximum_ et/ou _pattern_.
La nature de ces champs dépend de la nature du type du paramètre d'entrée : texte (essentiellement _String_) ou valeur numérique (_Long_, _Float_, etc.).
...
Ces champs sont utilisés lors de la génération d'une spécification OpenAPI.
