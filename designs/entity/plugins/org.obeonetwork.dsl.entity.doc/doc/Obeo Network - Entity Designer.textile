...
Ce diagramme permet de créer, modifier ou supprimer des packages ainsi que d'accéder facilement au diagramme de gestion des entitiés d'un package.
...
L'outil de création d'entités à partir de DTOs permet de sélectionner des DTOs (cf. documentation sur *SOA Designer*) et des références entre ses DTOs. Des entités et des relations sont créées pour chaque DTO et chaque référence sélectionné.
