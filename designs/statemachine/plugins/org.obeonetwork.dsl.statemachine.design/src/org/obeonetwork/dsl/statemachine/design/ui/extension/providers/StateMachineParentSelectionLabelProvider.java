...
public class StateMachineParentSelectionLabelProvider extends AdapterFactoryLabelProvider {
	...
	public StateMachineParentSelectionLabelProvider(AdapterFactory adapterFactory) {
