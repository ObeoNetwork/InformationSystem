...
public class GraalfeatureextensionsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected GraalfeatureextensionsSwitch<Adapter> modelSwitch =
		new GraalfeatureextensionsSwitch<Adapter>() {
			@Override
			public Adapter caseUIConfiguration(UIConfiguration object) {
				return createUIConfigurationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.graal.design.graalfeatureextensions.UIConfiguration <em>UI Configuration</em>}'.
	 * <!-- begin-user-doc -->
